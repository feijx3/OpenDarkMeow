...
extends MessageToMessageDecoder<ByteBuf> {
    ...
    public void exceptionCaught(ChannelHandlerContext ctx, Throwable cause) throws Exception {
        ...
        if (PipelineUtil.containsCause(cause, InformativeException.class) && this.user.getProtocolInfo().getServerState() != State.HANDSHAKE || Via.getManager().debugHandler().enabled()) {
