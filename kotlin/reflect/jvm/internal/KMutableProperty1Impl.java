...
import kotlin.reflect.jvm.internal.KMutableProperty1Impl$$Lambda$0;
...
implements KMutableProperty1<T, V> {
    ...
    public KMutableProperty1Impl(@NotNull KDeclarationContainerImpl container, @NotNull String name, @NotNull String signature, @Nullable Object boundReceiver) {
        ...
        KMutableProperty1Impl kMutableProperty1Impl = this;
        this._setter = LazyKt.lazy(LazyThreadSafetyMode.PUBLICATION, new KMutableProperty1Impl$$Lambda$0(kMutableProperty1Impl));
    }
    ...
    public void set(T receiver, V value) {
        Object[] objectArray = new Object[]{receiver, value};
        ((KCallableImpl)((Object)this.getSetter())).call(objectArray);
    }

    private static final Setter _setter$lambda$0(KMutableProperty1Impl this$0) {
        return new Setter(this$0);
    }

    static /* synthetic */ Setter accessor$KMutableProperty1Impl$lambda0(KMutableProperty1Impl kMutableProperty1Impl) {
        return KMutableProperty1Impl._setter$lambda$0(kMutableProperty1Impl);
    }

    @Metadata(mv={2, 2, 0}, k=1, xi=48, d1={"\u0000\"\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0010\u0002\n\u0002\b\u0004\u0018\u0000*\u0004\b\u0002\u0010\u0001*\u0004\b\u0003\u0010\u00022\b\u0012\u0004\u0012\u0002H\u00020\u00032\u000e\u0012\u0004\u0012\u0002H\u0001\u0012\u0004\u0012\u0002H\u00020\u0004B\u001b\u0012\u0012\u0010\u0005\u001a\u000e\u0012\u0004\u0012\u00028\u0002\u0012\u0004\u0012\u00028\u00030\u0006\u00a2\u0006\u0004\b\u0007\u0010\bJ\u001e\u0010\u000b\u001a\u00020\f2\u0006\u0010\r\u001a\u00028\u00022\u0006\u0010\u000e\u001a\u00028\u0003H\u0096\u0002\u00a2\u0006\u0002\u0010\u000fR \u0010\u0005\u001a\u000e\u0012\u0004\u0012\u00028\u0002\u0012\u0004\u0012\u00028\u00030\u0006X\u0096\u0004\u00a2\u0006\b\n\u0000\u001a\u0004\b\t\u0010\n\u00a8\u0006\u0010"}, d2={"Lkotlin/reflect/jvm/internal/KMutableProperty1Impl$Setter;", "T", "V", "Lkotlin/reflect/jvm/internal/KPropertyImpl$Setter;", "Lkotlin/reflect/KMutableProperty1$Setter;", "property", "Lkotlin/reflect/jvm/internal/KMutableProperty1Impl;", "<init>", "(Lkotlin/reflect/jvm/internal/KMutableProperty1Impl;)V", "getProperty", "()Lkotlin/reflect/jvm/internal/KMutableProperty1Impl;", "invoke", "", "receiver", "value", "(Ljava/lang/Object;Ljava/lang/Object;)V", "kotlin-reflection"})
