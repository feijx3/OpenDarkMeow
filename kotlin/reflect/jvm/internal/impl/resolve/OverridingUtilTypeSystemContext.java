...
implements ClassicTypeSystemContext {
    ...
    private final boolean areEqualTypeConstructorsByAxioms(TypeConstructor a2, TypeConstructor b2) {
        if (this.equalityAxioms.equals(a2, b2)) {
            return true;
        }
        if (this.matchingTypeConstructors == null) {
            return false;
        }
        TypeConstructor img1 = this.matchingTypeConstructors.get(a2);
        TypeConstructor img2 = this.matchingTypeConstructors.get(b2);
        return img1 != null && Intrinsics.areEqual(img1, b2) || img2 != null && Intrinsics.areEqual(img2, a2);
    }
