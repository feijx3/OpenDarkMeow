...
public class Flags {
    ...
    public static int getAccessorFlags(boolean hasAnnotations, @NotNull ProtoBuf.Visibility visibility2, @NotNull ProtoBuf.Modality modality2, boolean isNotDefault, boolean isExternal, boolean isInlineAccessor) {
        if (visibility2 == null) {
        ...
        return HAS_ANNOTATIONS.toFlags(hasAnnotations) | MODALITY.toFlags(modality2) | VISIBILITY.toFlags(visibility2) | IS_NOT_DEFAULT.toFlags(isNotDefault) | IS_EXTERNAL_ACCESSOR.toFlags(isExternal) | IS_INLINE_ACCESSOR.toFlags(isInlineAccessor);
    }
    ...
    extends FlagField<E> {
        ...
        public EnumLiteFlagField(int offset, E[] values) {
            super(offset, EnumLiteFlagField.bitWidth(values));
            this.values = values;
        }
        ...
        public E get(int flags) {
            ...
            for (E e2 : this.values) {
                if (e2.getNumber() != value) continue;
                return e2;
            }
            return null;
        }
    ...
    extends FlagField<Boolean> {
        ...
        public Boolean get(int flags) {
            Boolean bl2 = (flags & 1 << this.offset) != 0;
            if (bl2 == null) {
