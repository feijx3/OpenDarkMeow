...
public final class JvmProtoBuf {
    ...
    implements JvmProtoBuf$JvmPropertySignatureOrBuilder {
            ...
            try {
                ...
                block23: while (!done) {
                    ...
                    if ((this.bitField0_ & 0x10) == 16) {
                        subBuilder = this.delegateMethod_.toBuilder();
                    }
                    this.delegateMethod_ = input.readMessage(JvmMethodSignature.PARSER, extensionRegistry);
                    if (subBuilder != null) {
                        ((JvmMethodSignature.Builder)subBuilder).mergeFrom(this.delegateMethod_);
                        this.delegateMethod_ = ((JvmMethodSignature.Builder)subBuilder).buildPartial();
                    }
        ...
        public int getSerializedSize() {
            ...
            if ((this.bitField0_ & 0x10) == 16) {
                size += CodedOutputStream.computeMessageSize(5, this.delegateMethod_);
            }
        ...
        implements JvmProtoBuf$JvmPropertySignatureOrBuilder {
            ...
            public JvmPropertySignature build() {
                JvmPropertySignature result = this.buildPartial();
            ...
            public Builder mergeFrom(JvmPropertySignature other) {
                ...
                if (other.hasDelegateMethod()) {
                    this.mergeDelegateMethod(other.getDelegateMethod());
                }
            ...
            public Builder mergeFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
                ...
                try {
                    ...
                    parsedMessage = (JvmPropertySignature)e2.getUnfinishedMessage();
                    throw e2;
                }
                finally {
            ...
            public Builder mergeDelegateMethod(JvmMethodSignature value) {
                this.delegateMethod_ = (this.bitField0_ & 0x10) == 16 && this.delegateMethod_ != JvmMethodSignature.getDefaultInstance() ? JvmMethodSignature.newBuilder(this.delegateMethod_).mergeFrom(value).buildPartial() : value;
                this.bitField0_ |= 0x10;
                return this;
            }
        }
    ...
    implements JvmProtoBuf$JvmFieldSignatureOrBuilder {
        ...
        implements JvmProtoBuf$JvmFieldSignatureOrBuilder {
            ...
            public JvmFieldSignature build() {
                JvmFieldSignature result = this.buildPartial();
                if (!result.isInitialized()) {
                    throw Builder.newUninitializedMessageException(result);
                }
                return result;
            ...
            public Builder mergeFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
                ...
                try {
                    ...
                    parsedMessage = (JvmFieldSignature)e2.getUnfinishedMessage();
                    throw e2;
                }
                finally {
                    if (parsedMessage != null) {
    ...
    implements JvmProtoBuf$JvmMethodSignatureOrBuilder {
        ...
        implements JvmProtoBuf$JvmMethodSignatureOrBuilder {
            ...
            public JvmMethodSignature build() {
                JvmMethodSignature result = this.buildPartial();
                if (!result.isInitialized()) {
                    throw Builder.newUninitializedMessageException(result);
                }
                return result;
            ...
            public Builder mergeFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
                ...
                try {
                    ...
                    parsedMessage = (JvmMethodSignature)e2.getUnfinishedMessage();
                    throw e2;
                }
                finally {
                    if (parsedMessage != null) {
    ...
    implements JvmProtoBuf$StringTableTypesOrBuilder {
        ...
        public void writeTo(CodedOutputStream output) throws IOException {
            ...
            for (i2 = 0; i2 < this.record_.size(); ++i2) {
                output.writeMessage(1, this.record_.get(i2));
            }
            if (this.getLocalNameList().size() > 0) {
                output.writeRawVarint32(42);
                output.writeRawVarint32(this.localNameMemoizedSerializedSize);
            }
            for (i2 = 0; i2 < this.localName_.size(); ++i2) {
                output.writeInt32NoTag(this.localName_.get(i2));
            }
            output.writeRawBytes(this.unknownFields);
        }
        ...
        public int getSerializedSize() {
            ...
            for (int i2 = 0; i2 < this.record_.size(); ++i2) {
                size += CodedOutputStream.computeMessageSize(1, this.record_.get(i2));
            }
            int dataSize = 0;
            for (int i3 = 0; i3 < this.localName_.size(); ++i3) {
                dataSize += CodedOutputStream.computeInt32SizeNoTag(this.localName_.get(i3));
            }
            size += dataSize;
        ...
        implements JvmProtoBuf$StringTableTypesOrBuilder {
            ...
            public StringTableTypes build() {
                StringTableTypes result = this.buildPartial();
                if (!result.isInitialized()) {
                    throw Builder.newUninitializedMessageException(result);
                }
                return result;
            ...
            public Builder mergeFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
                ...
                try {
                    ...
                    parsedMessage = (StringTableTypes)e2.getUnfinishedMessage();
                    throw e2;
                }
                finally {
                    if (parsedMessage != null) {
        ...
        implements JvmProtoBuf$StringTableTypes$RecordOrBuilder {
            ...
            public void writeTo(CodedOutputStream output) throws IOException {
                ...
                for (i2 = 0; i2 < this.substringIndex_.size(); ++i2) {
                    output.writeInt32NoTag(this.substringIndex_.get(i2));
                }
                if (this.getReplaceCharList().size() > 0) {
                    output.writeRawVarint32(42);
                    output.writeRawVarint32(this.replaceCharMemoizedSerializedSize);
                }
                for (i2 = 0; i2 < this.replaceChar_.size(); ++i2) {
                    output.writeInt32NoTag(this.replaceChar_.get(i2));
                }
                if ((this.bitField0_ & 4) == 4) {
            ...
            public int getSerializedSize() {
                ...
                int dataSize = 0;
                for (i2 = 0; i2 < this.substringIndex_.size(); ++i2) {
                    dataSize += CodedOutputStream.computeInt32SizeNoTag(this.substringIndex_.get(i2));
                }
                size += dataSize;
                ...
                dataSize = 0;
                for (i2 = 0; i2 < this.replaceChar_.size(); ++i2) {
                    dataSize += CodedOutputStream.computeInt32SizeNoTag(this.replaceChar_.get(i2));
                }
                size += dataSize;
            ...
            implements JvmProtoBuf$StringTableTypes$RecordOrBuilder {
                ...
                @Override
                public Record build() {
                    Record result = this.buildPartial();
                    if (!result.isInitialized()) {
                        throw Builder.newUninitializedMessageException(result);
                    }
                    return result;
                ...
                public Builder mergeFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
                    ...
                    try {
                        ...
                        parsedMessage = (Record)e2.getUnfinishedMessage();
                        throw e2;
                    }
                    finally {
                        if (parsedMessage != null) {
