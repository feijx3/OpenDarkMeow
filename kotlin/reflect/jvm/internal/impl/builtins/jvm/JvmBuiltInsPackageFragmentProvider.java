...
extends AbstractDeserializedPackageFragmentProvider {
    ...
    public JvmBuiltInsPackageFragmentProvider(@NotNull StorageManager storageManager, @NotNull KotlinClassFinder finder, @NotNull ModuleDescriptor moduleDescriptor, @NotNull NotFoundClasses notFoundClasses, @NotNull AdditionalClassPartsProvider additionalClassPartsProvider, @NotNull PlatformDependentDeclarationFilter platformDependentDeclarationFilter, @NotNull DeserializationConfiguration deserializationConfiguration, @NotNull NewKotlinTypeChecker kotlinTypeChecker, @NotNull SamConversionResolver samConversionResolver) {
        ...
        ClassDataFinder classDataFinder = new DeserializedClassDataFinder(this);
        ...
        ClassDescriptorFactory[] classDescriptorFactoryArray = new ClassDescriptorFactory[]{new BuiltInFictitiousFunctionClassFactory(storageManager, moduleDescriptor), new JvmBuiltInClassDescriptorFactory(storageManager, moduleDescriptor, null, 4, null)};
        this.setComponents(new DeserializationComponents(storageManager, moduleDescriptor, deserializationConfiguration, classDataFinder, annotationAndConstantLoader, packageFragmentProvider, localClassifierTypeSettings, errorReporter, LookupTracker.DO_NOTHING.INSTANCE, FlexibleTypeDeserializer.ThrowException.INSTANCE, CollectionsKt.listOf(classDescriptorFactoryArray), notFoundClasses, ContractDeserializer.Companion.getDEFAULT(), additionalClassPartsProvider, platformDependentDeclarationFilter, BuiltInSerializerProtocol.INSTANCE.getExtensionRegistry(), kotlinTypeChecker, samConversionResolver, null, JvmEnumEntriesDeserializationSupport.INSTANCE, 262144, null));
    }
    ...
    protected DeserializedPackageFragment findPackage(@NotNull FqName fqName) {
        ...
        InputStream inputStream = this.getFinder().findBuiltInsData(fqName);
        if (inputStream != null) {
            InputStream inputStream2 = inputStream;
            boolean bl2 = false;
            builtInsPackageFragmentImpl = BuiltInsPackageFragmentImpl.Companion.create(fqName, this.getStorageManager(), this.getModuleDescriptor(), inputStream2, false);
        } else {
