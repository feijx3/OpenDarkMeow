...
final class FieldSet<FieldDescriptorType extends FieldDescriptorLite<FieldDescriptorType>> {
    ...
    public Object getField(FieldDescriptorType descriptor2) {
        Object o2 = this.fields.get(descriptor2);
    ...
    private static void verifyType(WireFormat.FieldType type, Object value) {
        ...
        switch (type.getJavaType()) {
            ...
            case MESSAGE: {
                boolean bl2 = isValid = value instanceof MessageLite || value instanceof LazyField;
            }
        }
        if (!isValid) {
            throw new IllegalArgumentException("Wrong object type used with protocol message reflection.");
    ...
    public static void writeField(FieldDescriptorLite<?> descriptor2, Object value, CodedOutputStream output) throws IOException {
        WireFormat.FieldType type = descriptor2.getLiteType();
