...
implements Serializable {
    ...
    static Method getMethodOrDie(Class clazz, String name, Class ... params) {
        try {
            ...
            throw new RuntimeException(new StringBuilder(45 + string.length() + string2.length()).append("Generated message class \"").append(string).append("\" missing method \"").append(string2).append("\".").toString(), e2);
        }
    }
