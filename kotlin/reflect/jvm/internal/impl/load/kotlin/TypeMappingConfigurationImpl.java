...
implements TypeMappingConfiguration<JvmType> {
    ...
    public KotlinType commonSupertype(@NotNull Collection<? extends KotlinType> types) {
        ...
        throw new AssertionError((Object)("There should be no intersection type in existing descriptors, but found: " + CollectionsKt.joinToString$default(types, null, null, null, 0, null, null, 63, null)));
    }
