...
public interface KotlinJvmBinaryClass {
    ...
    public static interface AnnotationArgumentVisitor {
        ...
        public void visitClassLiteral(@Nullable Name var1, @NotNull ClassLiteralValue var2);

        public void visitEnum(@Nullable Name var1, @NotNull ClassId var2, @NotNull Name var3);

        @Nullable
        public AnnotationArgumentVisitor visitAnnotation(@Nullable Name var1, @NotNull ClassId var2);

        @Nullable
        public AnnotationArrayArgumentVisitor visitArray(@Nullable Name var1);
    ...
    public static interface AnnotationArrayArgumentVisitor {
        ...
        @Nullable
        public AnnotationArgumentVisitor visitAnnotation(@NotNull ClassId var1);
