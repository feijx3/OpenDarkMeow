...
implements JavaCallableMemberDescriptor {
    ...
    protected JavaPropertyDescriptor(@NotNull DeclarationDescriptor containingDeclaration, @NotNull Annotations annotations, @NotNull Modality modality2, @NotNull DescriptorVisibility visibility2, boolean isVar, @NotNull Name name, @NotNull SourceElement source, @Nullable PropertyDescriptor original, @NotNull CallableMemberDescriptor.Kind kind2, boolean isStaticFinal, @Nullable Pair<CallableDescriptor.UserDataKey<?>, ?> singleUserData) {
        ...
        super(containingDeclaration, original, annotations, modality2, visibility2, isVar, name, kind2, source, false, false, false, false, false, false);
        this.inType = null;
    ...
    @NotNull
    public static JavaPropertyDescriptor create(@NotNull DeclarationDescriptor containingDeclaration, @NotNull Annotations annotations, @NotNull Modality modality2, @NotNull DescriptorVisibility visibility2, boolean isVar, @NotNull Name name, @NotNull SourceElement source, boolean isStaticFinal) {
        if (containingDeclaration == null) {
        ...
        return new JavaPropertyDescriptor(containingDeclaration, annotations, modality2, visibility2, isVar, name, source, null, CallableMemberDescriptor.Kind.DECLARATION, isStaticFinal, null);
    }
    ...
    protected PropertyDescriptorImpl createSubstitutedCopy(@NotNull DeclarationDescriptor newOwner, @NotNull Modality newModality, @NotNull DescriptorVisibility newVisibility, @Nullable PropertyDescriptor original, @NotNull CallableMemberDescriptor.Kind kind2, @NotNull Name newName, @NotNull SourceElement source) {
        ...
        return new JavaPropertyDescriptor(newOwner, this.getAnnotations(), newModality, newVisibility, this.isVar(), newName, source, original, kind2, this.isStaticFinal, this.singleUserData);
    }
    ...
    @Override
    @NotNull
    public JavaCallableMemberDescriptor enhance(@Nullable KotlinType enhancedReceiverType, @NotNull List<KotlinType> enhancedValueParameterTypes, @NotNull KotlinType enhancedReturnType, @Nullable Pair<CallableDescriptor.UserDataKey<?>, ?> additionalUserData) {
        ...
        enhanced.setType(enhancedReturnType, this.getTypeParameters(), this.getDispatchReceiverParameter(), enhancedReceiver, CollectionsKt.<ReceiverParameterDescriptor>emptyList());
