...
public interface JavaResolverCache {
    public static final JavaResolverCache EMPTY = new JavaResolverCache(){
        ...
        @Override
        public void recordMethod(@NotNull JavaMember member, @NotNull SimpleFunctionDescriptor descriptor2) {
            if (member == null) {
                1.$$$reportNull$$$0(1);
            }
            if (descriptor2 == null) {
    ...
    public void recordMethod(@NotNull JavaMember var1, @NotNull SimpleFunctionDescriptor var2);
