...
extends DeclarationDescriptor {
    ...
    @Nullable
    public <T> T getCapability(@NotNull ModuleCapability<T> var1);
    ...
    public static final class DefaultImpls {
        ...
        @Nullable
        public static <R, D> R accept(@NotNull ModuleDescriptor $this, @NotNull DeclarationDescriptorVisitor<R, D> visitor2, D data) {
            Intrinsics.checkNotNullParameter(visitor2, "visitor");
            return visitor2.visitModuleDeclaration($this, data);
        }
    }
}
