...
implements ErrorReporter {
    ...
    public void reportIncompleteHierarchy(@NotNull ClassDescriptor descriptor2, @NotNull List<String> unresolvedSuperClasses) {
        ...
        throw new IllegalStateException("Incomplete hierarchy for class " + descriptor2.getName() + ", unresolved classes " + unresolvedSuperClasses);
    }

    @Override
    public void reportCannotInferVisibility(@NotNull CallableMemberDescriptor descriptor2) {
        Intrinsics.checkNotNullParameter(descriptor2, "descriptor");
        throw new IllegalStateException("Cannot infer visibility for " + descriptor2);
    }
}
