...
implements PropertyGetterDescriptor {
    ...
    public PropertyGetterDescriptorImpl(@NotNull PropertyDescriptor correspondingProperty, @NotNull Annotations annotations, @NotNull Modality modality2, @NotNull DescriptorVisibility visibility2, boolean isDefault, boolean isExternal, boolean isInline, @NotNull CallableMemberDescriptor.Kind kind2, @Nullable PropertyGetterDescriptor original, @NotNull SourceElement source) {
        ...
        super(modality2, visibility2, correspondingProperty, annotations, Name.special("<get-" + correspondingProperty.getName() + ">"), isDefault, isExternal, isInline, kind2, source);
    ...
    public <R, D> R accept(DeclarationDescriptorVisitor<R, D> visitor2, D data) {
        return visitor2.visitPropertyGetterDescriptor(this, data);
    }
