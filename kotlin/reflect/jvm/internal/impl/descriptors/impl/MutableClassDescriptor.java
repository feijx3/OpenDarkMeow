...
extends ClassDescriptorBase {
    ...
    public MutableClassDescriptor(@NotNull DeclarationDescriptor containingDeclaration, @NotNull ClassKind kind2, boolean isInner, boolean isExternal, @NotNull Name name, @NotNull SourceElement source, @NotNull StorageManager storageManager) {
        ...
        assert (kind2 != ClassKind.OBJECT) : "Fix isCompanionObject()";
        this.kind = kind2;
