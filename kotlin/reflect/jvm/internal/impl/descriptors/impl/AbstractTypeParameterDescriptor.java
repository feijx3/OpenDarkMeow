...
implements TypeParameterDescriptor {
    ...
    protected AbstractTypeParameterDescriptor(final @NotNull StorageManager storageManager, @NotNull DeclarationDescriptor containingDeclaration, @NotNull Annotations annotations, final @NotNull Name name, @NotNull Variance variance, boolean isReified2, int index, @NotNull SourceElement source, final @NotNull SupertypeLoopChecker supertypeLoopChecker) {
    ...
    extends AbstractTypeConstructor {
        ...
        protected List<KotlinType> processSupertypesWithoutCycles(@NotNull List<KotlinType> supertypes) {
            ...
            List<KotlinType> list = AbstractTypeParameterDescriptor.this.processBoundsWithoutCycles(supertypes);
            if (list == null) {
        ...
        protected boolean isSameClassifier(@NotNull ClassifierDescriptor classifier) {
            ...
            return classifier instanceof TypeParameterDescriptor && DescriptorEquivalenceForOverrides.INSTANCE.areTypeParametersEquivalent(AbstractTypeParameterDescriptor.this, (TypeParameterDescriptor)classifier, true);
        }
