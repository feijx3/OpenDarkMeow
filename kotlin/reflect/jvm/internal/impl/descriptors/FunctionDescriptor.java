...
extends CallableMemberDescriptor {
    ...
    public static interface CopyBuilder<D extends FunctionDescriptor> {
        ...
        @NotNull
        public CopyBuilder<D> setVisibility(@NotNull DescriptorVisibility var1);
        ...
        @NotNull
        public <V> CopyBuilder<D> putUserData(@NotNull CallableDescriptor.UserDataKey<V> var1, V var2);
