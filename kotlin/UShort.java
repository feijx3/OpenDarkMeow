...
implements Comparable<UShort> {
    ...
    private static final float toFloat-impl(short arg0) {
        return (float)UnsignedKt.uintToDouble(arg0 & 0xFFFF);
    }

    @InlineOnly
    private static final double toDouble-impl(short arg0) {
        return UnsignedKt.uintToDouble(arg0 & 0xFFFF);
    }
    ...
    public static boolean equals-impl(short arg0, Object other) {
        ...
        short s2 = ((UShort)other).unbox-impl();
        return arg0 == s2;
    }
    ...
    public static final /* synthetic */ UShort box-impl(short v2) {
        return new UShort(v2);
    }
