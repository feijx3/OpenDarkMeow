...
extends FilesKt__FileTreeWalkKt {
    ...
    private static final String toRelativeStringOrNull$FilesKt__UtilsKt(File $this$toRelativeStringOrNull, File base) {
        ...
        File $this$toRelativeStringOrNull_u24lambda_u241 = $this$toRelativeStringOrNull;
        boolean bl2 = false;
    ...
    public static /* synthetic */ File copyTo$default(File file, File file2, boolean bl2, int n2, int n3, Object object) {
        if ((n3 & 2) != 0) {
            bl2 = false;
        }
        if ((n3 & 4) != 0) {
        ...
        return FilesKt.copyTo(file, file2, bl2, n2);
    }
        ...
        try {
            ...
            while (iterator2.hasNext()) {
                ...
                if (!(!dstFile.exists() || src.isDirectory() && dstFile.isDirectory())) {
                    boolean stillExists;
                    boolean bl2 = !overwrite ? true : (dstFile.isDirectory() ? !FilesKt.deleteRecursively(dstFile) : (stillExists = !dstFile.delete()));
                    if (stillExists) {
    ...
    public static /* synthetic */ boolean copyRecursively$default(File file, File file2, boolean bl2, Function2 function2, int n2, Object object) {
        if ((n2 & 2) != 0) {
            bl2 = false;
        }
        if ((n2 & 4) != 0) {
        ...
        return FilesKt.copyRecursively(file, file2, bl2, function2);
    }
    ...
    public static final File normalize(@NotNull File $this$normalize) {
        ...
        Iterable iterable = FilesKt__UtilsKt.normalize$FilesKt__UtilsKt($this$normalize_u24lambda_u246.getSegments());
        String string = File.separator;
        Intrinsics.checkNotNullExpressionValue(string, "separator");
        ...
        for (File file : $this$normalize) {
            ...
            if (Intrinsics.areEqual(string, "..")) {
                if (!list.isEmpty() && !Intrinsics.areEqual(((File)CollectionsKt.last(list)).getName(), "..")) {
                    object = (Comparable)list.remove(list.size() - 1);
                    continue;
                }
                object = list.add(file);
                continue;
            }
            object = list.add(file);
        }
    ...
    private static final Unit copyRecursively$lambda$4$FilesKt__UtilsKt(Function2 $onError, File f2, IOException e2) {
