...
public final class ByteStreamsKt {
    ...
    public static final ByteIterator iterator(@NotNull BufferedInputStream $this$iterator) {
        ...
        return new ByteIterator($this$iterator){
            ...
            public final void setNextPrepared(boolean bl2) {
                this.nextPrepared = bl2;
            }
            ...
            public final void setFinished(boolean bl2) {
                this.finished = bl2;
            }
    ...
    static /* synthetic */ ByteArrayInputStream byteInputStream$default(String $this$byteInputStream_u24default, Charset charset, int n2, Object object) {
        if ((n2 & 1) != 0) {
    ...
    static /* synthetic */ BufferedInputStream buffered$default(InputStream $this$buffered_u24default, int bufferSize, int n2, Object object) {
        if ((n2 & 1) != 0) {
            bufferSize = 8192;
        }
    ...
    static /* synthetic */ InputStreamReader reader$default(InputStream $this$reader_u24default, Charset charset, int n2, Object object) {
        if ((n2 & 1) != 0) {
            charset = Charsets.UTF_8;
        }
    ...
    static /* synthetic */ BufferedReader bufferedReader$default(InputStream $this$bufferedReader_u24default, Charset charset, int n2, Object object) {
        if ((n2 & 1) != 0) {
            charset = Charsets.UTF_8;
        }
        ...
        int n3 = 8192;
        return reader instanceof BufferedReader ? (BufferedReader)reader : new BufferedReader(reader, n3);
    }
    ...
    static /* synthetic */ BufferedOutputStream buffered$default(OutputStream $this$buffered_u24default, int bufferSize, int n2, Object object) {
        if ((n2 & 1) != 0) {
            bufferSize = 8192;
        }
        Intrinsics.checkNotNullParameter($this$buffered_u24default, "<this>");
    ...
    static /* synthetic */ OutputStreamWriter writer$default(OutputStream $this$writer_u24default, Charset charset, int n2, Object object) {
        if ((n2 & 1) != 0) {
            charset = Charsets.UTF_8;
        }
    ...
    static /* synthetic */ BufferedWriter bufferedWriter$default(OutputStream $this$bufferedWriter_u24default, Charset charset, int n2, Object object) {
        if ((n2 & 1) != 0) {
            charset = Charsets.UTF_8;
        }
        ...
        int n3 = 8192;
        return writer instanceof BufferedWriter ? (BufferedWriter)writer : new BufferedWriter(writer, n3);
    }
