...
extends StringsKt__RegexExtensionsKt {
    ...
    private static final StringBuilder append(StringBuilder $this$append, byte value) {
        ...
        StringBuilder stringBuilder = $this$append.append(value);
    ...
    private static final StringBuilder insert(StringBuilder $this$insert, int index, byte value) {
        ...
        StringBuilder stringBuilder = $this$insert.insert(index, value);
    ...
    static /* synthetic */ void toCharArray$default(StringBuilder $this$toCharArray_u24default, char[] destination, int destinationOffset, int startIndex, int endIndex, int n2, Object object) {
        if ((n2 & 2) != 0) {
            destinationOffset = 0;
        }
        if ((n2 & 4) != 0) {
