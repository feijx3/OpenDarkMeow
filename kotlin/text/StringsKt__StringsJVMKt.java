...
extends StringsKt__StringNumberConversionsKt {
    ...
    public static /* synthetic */ boolean equals$default(String string, String string2, boolean bl2, int n2, Object object) {
        if ((n2 & 2) != 0) {
            bl2 = false;
        }
        return StringsKt.equals(string, string2, bl2);
    }
    ...
    public static final String replace(@NotNull String $this$replace, char oldChar, char newChar, boolean ignoreCase) {
        ...
        int n2 = $this$replace.length();
        StringBuilder $this$replace_u24lambda_u241 = stringBuilder = new StringBuilder(n2);
        boolean bl2 = false;
        CharSequence $this$forEach$iv = $this$replace;
        boolean $i$f$forEach = false;
        for (int i2 = 0; i2 < $this$forEach$iv.length(); ++i2) {
            char element$iv;
    ...
    public static /* synthetic */ String replace$default(String string, char c2, char c3, boolean bl2, int n2, Object object) {
        if ((n2 & 4) != 0) {
            bl2 = false;
        }
        return StringsKt.replace(string, c2, c3, bl2);
    }
    ...
    public static final String replace(@NotNull String $this$replace, @NotNull String oldValue, @NotNull String newValue, boolean ignoreCase) {
        ...
        int i2 = 0;
        do {
            stringBuilder.append($this$replace_u24lambda_u242, i2, occurrenceIndex).append(newValue);
            i2 = occurrenceIndex + oldValueLength;
        ...
        String string = stringBuilder.append($this$replace_u24lambda_u242, i2, $this$replace_u24lambda_u242.length()).toString();
        Intrinsics.checkNotNullExpressionValue(string, "toString(...)");
        return string;
    }

    public static /* synthetic */ String replace$default(String string, String string2, String string3, boolean bl2, int n2, Object object) {
        if ((n2 & 4) != 0) {
            bl2 = false;
        }
        return StringsKt.replace(string, string2, string3, bl2);
    }
    ...
    public static final String replaceFirst(@NotNull String $this$replaceFirst, char oldChar, char newChar, boolean ignoreCase) {
        ...
        if (index < 0) {
            ...
            string = ((Object)StringsKt.replaceRange((CharSequence)string2, index, n2, charSequence)).toString();
        }
        return string;
    }

    public static /* synthetic */ String replaceFirst$default(String string, char c2, char c3, boolean bl2, int n2, Object object) {
        if ((n2 & 4) != 0) {
            bl2 = false;
        }
        return StringsKt.replaceFirst(string, c2, c3, bl2);
    }
    ...
    public static final String replaceFirst(@NotNull String $this$replaceFirst, @NotNull String oldValue, @NotNull String newValue, boolean ignoreCase) {
        ...
        if (index < 0) {
            ...
            String string2 = $this$replaceFirst;
            int n2 = index + oldValue.length();
            string = ((Object)StringsKt.replaceRange((CharSequence)string2, index, n2, (CharSequence)newValue)).toString();
        }
        return string;
    }

    public static /* synthetic */ String replaceFirst$default(String string, String string2, String string3, boolean bl2, int n2, Object object) {
        if ((n2 & 4) != 0) {
            bl2 = false;
        }
        return StringsKt.replaceFirst(string, string2, string3, bl2);
    }
    ...
    public static final char[] toCharArray(@NotNull String $this$toCharArray, int startIndex, int endIndex) {
        ...
        int n2 = 0;
        string.getChars(startIndex, endIndex, cArray, n2);
        return cArray;
    }
    ...
    public static /* synthetic */ String decodeToString$default(byte[] byArray, int n2, int n3, boolean bl2, int n4, Object object) {
        if ((n4 & 1) != 0) {
            n2 = 0;
        }
        if ((n4 & 2) != 0) {
        ...
        return StringsKt.decodeToString(byArray, n2, n3, bl2);
    }
    ...
    public static /* synthetic */ byte[] encodeToByteArray$default(String string, int n2, int n3, boolean bl2, int n4, Object object) {
        if ((n4 & 1) != 0) {
            n2 = 0;
        }
        if ((n4 & 2) != 0) {
        ...
        return StringsKt.encodeToByteArray(string, n2, n3, bl2);
    }
    ...
    static /* synthetic */ char[] toCharArray$default(String $this$toCharArray_u24default, char[] destination, int destinationOffset, int startIndex, int endIndex, int n2, Object object) {
        if ((n2 & 2) != 0) {
            destinationOffset = 0;
        }
        if ((n2 & 4) != 0) {
    ...
    private static final String format(String $this$format, Object ... args) {
        ...
        String string = String.format($this$format, Arrays.copyOf(args, args.length));
    ...
    private static final String format(String $this$format, Locale locale, Object ... args) {
        Intrinsics.checkNotNullParameter($this$format, "<this>");
        Intrinsics.checkNotNullParameter(args, "args");
        String string = String.format(locale, $this$format, Arrays.copyOf(args, args.length));
        Intrinsics.checkNotNullExpressionValue(string, "format(...)");
        return string;
    }
    ...
    public static /* synthetic */ boolean startsWith$default(String string, String string2, boolean bl2, int n2, Object object) {
        if ((n2 & 2) != 0) {
            bl2 = false;
        }
        return StringsKt.startsWith(string, string2, bl2);
    }
    ...
    public static /* synthetic */ boolean startsWith$default(String string, String string2, int n2, boolean bl2, int n3, Object object) {
        if ((n3 & 4) != 0) {
            bl2 = false;
        }
        return StringsKt.startsWith(string, string2, n2, bl2);
    }
    ...
    public static /* synthetic */ boolean endsWith$default(String string, String string2, boolean bl2, int n2, Object object) {
        if ((n2 & 2) != 0) {
            bl2 = false;
        }
        return StringsKt.endsWith(string, string2, bl2);
    }
    ...
    public static /* synthetic */ int compareTo$default(String string, String string2, boolean bl2, int n2, Object object) {
        if ((n2 & 2) != 0) {
            bl2 = false;
        }
        return StringsKt.compareTo(string, string2, bl2);
    }
    ...
    public static /* synthetic */ boolean regionMatches$default(CharSequence charSequence, int n2, CharSequence charSequence2, int n3, int n4, boolean bl2, int n5, Object object) {
        if ((n5 & 0x10) != 0) {
            bl2 = false;
        }
        return StringsKt.regionMatches(charSequence, n2, charSequence2, n3, n4, bl2);
    }
    ...
    public static /* synthetic */ boolean regionMatches$default(String string, int n2, String string2, int n3, int n4, boolean bl2, int n5, Object object) {
        if ((n5 & 0x10) != 0) {
            bl2 = false;
        }
        return StringsKt.regionMatches(string, n2, string2, n3, n4, bl2);
    }
    ...
    static /* synthetic */ byte[] toByteArray$default(String $this$toByteArray_u24default, Charset charset, int n2, Object object) {
        if ((n2 & 1) != 0) {
    ...
    static /* synthetic */ Pattern toPattern$default(String $this$toPattern_u24default, int flags, int n2, Object object) {
        if ((n2 & 1) != 0) {
            flags = 0;
        }
    ...
    public static final String capitalize(@NotNull String $this$capitalize, @NotNull Locale locale) {
        ...
        if (((CharSequence)$this$capitalize).length() > 0 && Character.isLowerCase(firstChar = $this$capitalize.charAt(0))) {
            ...
            StringBuilder $this$capitalize_u24lambda_u244 = stringBuilder2 = new StringBuilder();
            boolean bl2 = false;
            char titleChar = Character.toTitleCase(firstChar);
            if (titleChar != Character.toUpperCase(firstChar)) {
                stringBuilder = $this$capitalize_u24lambda_u244.append(titleChar);
            } else {
                ...
                stringBuilder = $this$capitalize_u24lambda_u244.append(string3);
            }
            string = $this$capitalize;
            n2 = 1;
            String string4 = string.substring(n2);
            Intrinsics.checkNotNullExpressionValue(string4, "substring(...)");
            $this$capitalize_u24lambda_u244.append(string4);
    ...
    public static final String decapitalize(@NotNull String $this$decapitalize) {
        ...
        if (((CharSequence)$this$decapitalize).length() > 0 && !Character.isLowerCase($this$decapitalize.charAt(0))) {
            ...
            int n4 = 1;
            String string5 = string2.substring(n4);
    ...
    @NotNull
    public static final String repeat(@NotNull CharSequence $this$repeat, int n2) {
        String string;
        ...
        block0 : switch (n2) {
            ...
            default: {
                ...
                StringBuilder sb = new StringBuilder(n2 * $this$repeat.length());
                int i2 = 1;
                if (i2 <= n2) {
                    while (true) {
