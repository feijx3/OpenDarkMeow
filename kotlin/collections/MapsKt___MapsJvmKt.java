    ...
    private static final /* synthetic */ <K, V, R extends Comparable<? super R>> Map.Entry<K, V> maxBy(Map<? extends K, ? extends V> $this$maxBy, Function1<? super Map.Entry<? extends K, ? extends V>, ? extends R> selector) {
        ...
        if (!iterator2.hasNext()) {
            ...
            if (!iterator2.hasNext()) {
                ...
                Comparable comparable = (Comparable)selector.invoke((Map.Entry<K, V>)t2);
                do {
                    Object t3;
                    Comparable comparable2;
                    if (comparable.compareTo(comparable2 = (Comparable)selector.invoke((Map.Entry<K, V>)(t3 = iterator2.next()))) >= 0) continue;
                    t2 = t3;
                    comparable = comparable2;
