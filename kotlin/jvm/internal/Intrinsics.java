...
public class Intrinsics {
    ...
    private static String createParameterIsNullExceptionMessage(String paramName) {
        ...
        int i2 = 0;
        while (!stackTraceElements[i2].getClassName().equals(thisClassName)) {
            ++i2;
        }
        while (stackTraceElements[i2].getClassName().equals(thisClassName)) {
            ++i2;
        }
        StackTraceElement caller = stackTraceElements[i2];
    ...
    public static void checkHasClass(String internalName) throws ClassNotFoundException {
        ...
        try {
            ...
            throw Intrinsics.sanitizeStackTrace(new ClassNotFoundException("Class " + fqName + " is not found. Please update the Kotlin runtime to the latest version", e2));
        }
    }
    ...
    public static void checkHasClass(String internalName, String requiredVersion) throws ClassNotFoundException {
        ...
        try {
            ...
            throw Intrinsics.sanitizeStackTrace(new ClassNotFoundException("Class " + fqName + " is not found: this code requires the Kotlin runtime of version at least " + requiredVersion, e2));
        }
    }
    ...
    static <T extends Throwable> T sanitizeStackTrace(T throwable, String classNameToDrop) {
        ...
        for (int i2 = 0; i2 < size; ++i2) {
            if (!classNameToDrop.equals(stackTrace[i2].getClassName())) continue;
            lastIntrinsic = i2;
        }
