...
@Metadata(mv={2, 2, 0}, k=1, xi=48, d1={"\u00002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0011\n\u0002\u0010\u000e\n\u0002\b\u0002\n\u0002\u0010 \n\u0002\b\u0002\u0018\u00002\u00020\u0001B\u0007\u00a2\u0006\u0004\b\u0002\u0010\u0003J+\u0010\u0004\u001a\u00020\u00052\u0006\u0010\u0006\u001a\u00020\u00072\u0006\u0010\b\u001a\u00020\t2\f\u0010\n\u001a\b\u0012\u0004\u0012\u00020\f0\u000bH\u0016\u00a2\u0006\u0002\u0010\rJ1\u0010\u000e\u001a\b\u0012\u0004\u0012\u00020\f0\u000f2\u0006\u0010\u0006\u001a\u00020\u00072\u0006\u0010\b\u001a\u00020\t2\f\u0010\n\u001a\b\u0012\u0004\u0012\u00020\f0\u000bH\u0016\u00a2\u0006\u0002\u0010\u0010\u00a8\u0006\u0011"}, d2={"Lnet/darkmeow/darkmeow/commands/impl/client/CommandHide;", "Lnet/darkmeow/darkmeow/commands/Command;", "<init>", "()V", "execute", "", "system", "Lnet/ccbluex/liquidbounce/DarkMeow;", "mc", "Lnet/minecraft/client/Minecraft;", "args", "", "", "(Lnet/ccbluex/liquidbounce/DarkMeow;Lnet/minecraft/client/Minecraft;[Ljava/lang/String;)V", "complete", "", "(Lnet/ccbluex/liquidbounce/DarkMeow;Lnet/minecraft/client/Minecraft;[Ljava/lang/String;)Ljava/util/List;", "DarkMeow"})
@SourceDebugExtension(value={"SMAP\nCommandHide.kt\nKotlin\n*S Kotlin\n*F\n+ 1 CommandHide.kt\nnet/darkmeow/darkmeow/commands/impl/client/CommandHide\n+ 2 _Collections.kt\nkotlin/collections/CollectionsKt___CollectionsKt\n*L\n1#1,32:1\n1563#2:33\n1634#2,3:34\n774#2:37\n865#2,2:38\n*S KotlinDebug\n*F\n+ 1 CommandHide.kt\nnet/darkmeow/darkmeow/commands/impl/client/CommandHide\n*L\n26#1:33\n26#1:34,3\n27#1:37\n27#1:38,2\n*E\n"})
public final class CommandHide
extends Command {
    public CommandHide() {
        String[] stringArray = new String[]{"Hide"};
        super(stringArray);
    }
    ...
    public void execute(@NotNull DarkMeow system, @NotNull Minecraft mc, @NotNull String[] args) {
        ...
        if (!(args.length == 0)) {
            ...
            if (module != null) {
                ...
                boolean bl2 = false;
                DarkMeow.INSTANCE.getUpdateManager().addScheduledTask(() -> CommandHide.execute$lambda$1$lambda$0(module3, system, args));
            } else {
                CommandHide $this$execute_u24lambda_u242 = this;
                boolean bl3 = false;
                system.getMessageManager().display.displayWarn("\u6a21\u5757 " + args[0] + " \u4e0d\u5b58\u5728");
            }
            return;
        }
        system.getMessageManager().display.displayDarkCommandSyntax("hide <module>");
    }
    ...
    private static final void execute$lambda$1$lambda$0(Module $module, DarkMeow $system, String[] $args) {
        $module.getBaseConfig().setHide(!$module.getBaseConfig().getHide());
        $system.getMessageManager().display.displayInfo("\u6a21\u5757 " + $args[0] + " \u73b0\u5728\u5904\u4e8e" + ($module.getBaseConfig().getHide() ? "\u00a7c\u9690\u85cf" : "\u00a7a\u663e\u793a") + "\u00a77\u72b6\u6001");
    }
}
