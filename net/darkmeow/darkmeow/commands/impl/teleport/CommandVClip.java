...
@Metadata(mv={2, 2, 0}, k=1, xi=48, d1={"\u0000*\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0011\n\u0002\u0010\u000e\n\u0002\b\u0002\u0018\u00002\u00020\u0001B\u0007\u00a2\u0006\u0004\b\u0002\u0010\u0003J+\u0010\u0004\u001a\u00020\u00052\u0006\u0010\u0006\u001a\u00020\u00072\u0006\u0010\b\u001a\u00020\t2\f\u0010\n\u001a\b\u0012\u0004\u0012\u00020\f0\u000bH\u0016\u00a2\u0006\u0002\u0010\r\u00a8\u0006\u000e"}, d2={"Lnet/darkmeow/darkmeow/commands/impl/teleport/CommandVClip;", "Lnet/darkmeow/darkmeow/commands/Command;", "<init>", "()V", "execute", "", "system", "Lnet/ccbluex/liquidbounce/DarkMeow;", "mc", "Lnet/minecraft/client/Minecraft;", "args", "", "", "(Lnet/ccbluex/liquidbounce/DarkMeow;Lnet/minecraft/client/Minecraft;[Ljava/lang/String;)V", "DarkMeow"})
@SourceDebugExtension(value={"SMAP\nCommandVClip.kt\nKotlin\n*S Kotlin\n*F\n+ 1 CommandVClip.kt\nnet/darkmeow/darkmeow/commands/impl/teleport/CommandVClip\n+ 2 fake.kt\nkotlin/jvm/internal/FakeKt\n*L\n1#1,25:1\n1#2:26\n*E\n"})
public final class CommandVClip
extends Command {
    public CommandVClip() {
        String[] stringArray = new String[]{"VClip"};
        super(stringArray);
    }
    ...
    public void execute(@NotNull DarkMeow system, @NotNull Minecraft mc, @NotNull String[] args) {
        ...
        if (stringArray != null && (object2 = stringArray[0]) != null && (n2 = StringsKt.toIntOrNull((String)object2)) != null) {
            ...
            if (entityPlayerSP != null) {
                ...
                entity2.func_70107_b(entity2.field_70165_t, entity2.field_70163_u + (double)y2, entity2.field_70161_v);
                system.getMessageManager().display.displaySuccess("\u4f20\u9001\u6210\u529f");
            }
            object = ((Number)n3).intValue();
        } else {
            CommandVClip $this$execute_u24lambda_u242 = this;
            boolean bl4 = false;
            object = system.getMessageManager().display.displayDarkCommandSyntax("vclip <Number>");
        }
    }
}
