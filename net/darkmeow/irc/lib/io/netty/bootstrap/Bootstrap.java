...
import net.darkmeow.irc.lib.io.netty.bootstrap.BootstrapConfig;
...
import net.darkmeow.irc.lib.io.netty.resolver.DefaultAddressResolverGroup;
        ...
        if (!extensions.isEmpty()) {
            for (ChannelInitializerExtension extension : extensions) {
                try {
                    ...
                    logger.warn("Exception thrown from postInitializeClientChannel", e2);
                }
            }
        }
    }
