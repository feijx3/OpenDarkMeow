...
import net.darkmeow.irc.lib.io.netty.bootstrap.ChannelInitializerExtensions;
import net.darkmeow.irc.lib.io.netty.bootstrap.FailedChannel;
...
import net.darkmeow.irc.lib.io.netty.channel.ReflectiveChannelFactory;
...
implements Cloneable {
    ...
    public B channel(Class<? extends C> channelClass) {
        return this.channelFactory((net.darkmeow.irc.lib.io.netty.channel.ChannelFactory<? extends C>)new ReflectiveChannelFactory<C>(ObjectUtil.checkNotNull(channelClass, "channelClass")));
    }
    ...
    public B channelFactory(net.darkmeow.irc.lib.io.netty.channel.ChannelFactory<? extends C> channelFactory) {
    ...
    static void setAttributes(Channel channel, Map.Entry<AttributeKey<?>, Object>[] attrs) {
        for (Map.Entry<AttributeKey<?>, Object> e2 : attrs) {
    ...
    private static void setChannelOption(Channel channel, ChannelOption<?> option, Object value, InternalLogger logger) {
        try {
            ...
            logger.warn("Failed to set channel option '{}' with value '{}' for channel '{}'", option, value, channel, t2);
        }
    }
