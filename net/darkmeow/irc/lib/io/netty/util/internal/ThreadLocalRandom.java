...
extends Random {
    ...
    private static volatile long initialSeedUniquifier = SystemPropertyUtil.getLong("net.darkmeow.irc.lib.io.netty.initialSeedUniquifier", 0L);
