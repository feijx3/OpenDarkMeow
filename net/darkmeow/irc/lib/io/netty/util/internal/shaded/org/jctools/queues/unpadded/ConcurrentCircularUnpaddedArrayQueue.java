...
import net.darkmeow.irc.lib.io.netty.util.internal.shaded.org.jctools.queues.SupportsIterator;
import net.darkmeow.irc.lib.io.netty.util.internal.shaded.org.jctools.queues.unpadded.ConcurrentCircularUnpaddedArrayQueueL0Pad;
    ...
    implements Iterator<E> {
        ...
        private E getNext() {
            while (this.nextIndex < this.pIndex) {
                long offset;
                E e2;
                if ((e2 = UnsafeRefArrayAccess.lvRefElement(this.buffer, offset = UnsafeRefArrayAccess.calcCircularRefElementOffset(this.nextIndex++, this.mask))) == null) continue;
                return e2;
            }
            return null;
        }
