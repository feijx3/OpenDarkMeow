...
import net.darkmeow.irc.lib.io.netty.util.internal.shaded.org.jctools.queues.BaseMpscLinkedArrayQueue;
...
extends BaseMpscLinkedArrayQueue<E> {
    ...
    public int drain(MessagePassingQueue.Consumer<E> c2) {
        return this.drain((MessagePassingQueue.Consumer)c2, 4096);
    }
