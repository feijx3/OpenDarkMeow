...
public final class MacAddressUtil {
    ...
    public static byte[] bestAvailableMac() {
        ...
        for (NetworkInterface networkInterface : NetUtil.NETWORK_INTERFACES) {
            ...
            ifaces.put(networkInterface, a2);
        }
        for (Map.Entry entry : ifaces.entrySet()) {
            ...
            try {
                ...
                logger.debug("Failed to get the hardware address of a network interface: {}", (Object)iface, (Object)e2);
                continue;
            }
    ...
    public static byte[] parseMAC(String value) {
        ...
        while (i2 < end) {
            int sIndex = j2 + 2;
            machineId[i2] = StringUtil.decodeHexByte(value, j2);
        ...
        machineId[end] = StringUtil.decodeHexByte(value, j2);
        return machineId;
    }
