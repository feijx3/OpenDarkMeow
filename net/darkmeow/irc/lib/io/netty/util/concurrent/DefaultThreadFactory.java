...
import net.darkmeow.irc.lib.io.netty.util.concurrent.FastThreadLocalRunnable;
...
implements ThreadFactory {
    ...
    public Thread newThread(Runnable r2) {
        Thread t2 = this.newThread(FastThreadLocalRunnable.wrap(r2), this.prefix + this.nextId.incrementAndGet());
        try {
            if (t2.isDaemon() != this.daemon) {
