...
import net.darkmeow.irc.lib.io.netty.util.concurrent.BlockingOperationException;
import net.darkmeow.irc.lib.io.netty.util.concurrent.DefaultFutureListeners;
...
import net.darkmeow.irc.lib.io.netty.util.concurrent.GenericProgressiveFutureListener;
import net.darkmeow.irc.lib.io.netty.util.concurrent.ProgressiveFuture;
...
implements Promise<V> {
    public static final String PROPERTY_MAX_LISTENER_STACK_DEPTH = "net.darkmeow.irc.lib.io.netty.defaultPromise.maxListenerStackDepth";
    ...
    private static final int MAX_LISTENER_STACK_DEPTH = Math.min(8, SystemPropertyUtil.getInt("net.darkmeow.irc.lib.io.netty.defaultPromise.maxListenerStackDepth", 8));
    ...
    private Throwable cause0(Object result) {
        ...
        if (result == CANCELLATION_CAUSE_HOLDER) {
            LeanCancellationException ce2 = new LeanCancellationException();
            if (RESULT_UPDATER.compareAndSet(this, CANCELLATION_CAUSE_HOLDER, new CauseHolder(ce2))) {
                return ce2;
            }
            result = this.result;
        }
        ...
        if (listeners != null) {
            ...
            while (var8_13 < progressiveSize) {
                ...
                if (l3 instanceof GenericProgressiveFutureListener) {
                    copy[++var8_13] = (GenericProgressiveFutureListener)l3;
                }
                ++i2;
            }
            return copy;
