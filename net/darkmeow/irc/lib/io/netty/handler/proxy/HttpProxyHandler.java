...
import net.darkmeow.irc.lib.io.netty.handler.codec.base64.Base64;
import net.darkmeow.irc.lib.io.netty.handler.codec.http.DefaultFullHttpRequest;
import net.darkmeow.irc.lib.io.netty.handler.codec.http.DefaultHttpHeadersFactory;
import net.darkmeow.irc.lib.io.netty.handler.codec.http.HttpClientCodec;
...
extends ProxyHandler {
    ...
    protected void addCodec(ChannelHandlerContext ctx) throws Exception {
        ...
        p2.addBefore(name, null, this.codecWrapper);
    }
    ...
    protected Object newInitialMessage(ChannelHandlerContext ctx) throws Exception {
        ...
        DefaultFullHttpRequest req = new DefaultFullHttpRequest(HttpVersion.HTTP_1_1, HttpMethod.CONNECT, url, Unpooled.EMPTY_BUFFER, headersFactory, headersFactory);
