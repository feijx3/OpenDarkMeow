...
import net.darkmeow.irc.lib.io.netty.handler.codec.HeadersUtils;
...
implements Headers<K, V, T> {
    ...
    public T add(K name, Iterable<? extends V> values) {
        ...
        int i2 = this.index(h2);
        for (V v2 : values) {
            this.validateValue(this.valueValidator, name, v2);
    ...
    public T setObject(K name, Iterable<?> values) {
        ...
        for (Object v2 : values) {
            if (v2 == null) break;
            V converted = this.fromObject(name, v2);
            this.validateValue(this.valueValidator, name, converted);
            this.add0(h2, i2, name, converted);
        }
        return this.thisT();
    }
    ...
    public Boolean getBoolean(K name) {
        V v2 = this.get(name);
        try {
            return v2 != null ? Boolean.valueOf(this.toBoolean(name, v2)) : null;
        }
    ...
    public Byte getByte(K name) {
        V v2 = this.get(name);
        try {
            return v2 != null ? Byte.valueOf(this.toByte(name, v2)) : null;
        }
        catch (RuntimeException ignore) {
            return null;
        }
    ...
    public Character getChar(K name) {
        V v2 = this.get(name);
        try {
            return v2 != null ? Character.valueOf(this.toChar(name, v2)) : null;
        }
        catch (RuntimeException ignore) {
            return null;
        }
    ...
    public Short getShort(K name) {
        V v2 = this.get(name);
        try {
            return v2 != null ? Short.valueOf(this.toShort(name, v2)) : null;
        }
        catch (RuntimeException ignore) {
            return null;
        }
    ...
    public Integer getInt(K name) {
        V v2 = this.get(name);
        try {
            return v2 != null ? Integer.valueOf(this.toInt(name, v2)) : null;
        }
        catch (RuntimeException ignore) {
            return null;
        }
    ...
    public Long getLong(K name) {
        V v2 = this.get(name);
        try {
            return v2 != null ? Long.valueOf(this.toLong(name, v2)) : null;
        }
        catch (RuntimeException ignore) {
            return null;
        }
    ...
    public Float getFloat(K name) {
        V v2 = this.get(name);
        try {
            return v2 != null ? Float.valueOf(this.toFloat(name, v2)) : null;
        }
        catch (RuntimeException ignore) {
            return null;
        }
    ...
    public Double getDouble(K name) {
        V v2 = this.get(name);
        try {
            return v2 != null ? Double.valueOf(this.toDouble(name, v2)) : null;
        }
        catch (RuntimeException ignore) {
            return null;
        }
    ...
    public Long getTimeMillis(K name) {
        V v2 = this.get(name);
        try {
            return v2 != null ? Long.valueOf(this.toTimeMillis(name, v2)) : null;
        }
        catch (RuntimeException ignore) {
            return null;
        }
    ...
    protected void validateValue(ValueValidator<V> validator, K name, V value) {
        try {
            ...
            throw new IllegalArgumentException("Validation failed for header '" + name + "'", e2);
        }
    }
    ...
    private V fromBoolean(K name, boolean value) {
        try {
            ...
            throw new IllegalArgumentException("Failed to convert boolean value for header '" + name + '\'', e2);
        }
    }
    ...
    private V fromByte(K name, byte value) {
        try {
            ...
            throw new IllegalArgumentException("Failed to convert byte value for header '" + name + '\'', e2);
        }
    }
    ...
    private V fromChar(K name, char value) {
        try {
            ...
            throw new IllegalArgumentException("Failed to convert char value for header '" + name + '\'', e2);
        }
    }
    ...
    private V fromShort(K name, short value) {
        try {
            ...
            throw new IllegalArgumentException("Failed to convert short value for header '" + name + '\'', e2);
        }
    }
    ...
    private V fromInt(K name, int value) {
        try {
            ...
            throw new IllegalArgumentException("Failed to convert int value for header '" + name + '\'', e2);
        }
    }
    ...
    private V fromLong(K name, long value) {
        try {
            ...
            throw new IllegalArgumentException("Failed to convert long value for header '" + name + '\'', e2);
        }
    }
    ...
    private V fromFloat(K name, float value) {
        try {
            ...
            throw new IllegalArgumentException("Failed to convert float value for header '" + name + '\'', e2);
        }
    }
    ...
    private V fromDouble(K name, double value) {
        try {
            ...
            throw new IllegalArgumentException("Failed to convert double value for header '" + name + '\'', e2);
        }
    }
    ...
    private V fromTimeMillis(K name, long value) {
        try {
            ...
            throw new IllegalArgumentException("Failed to convert millsecond value for header '" + name + '\'', e2);
        }
    }
