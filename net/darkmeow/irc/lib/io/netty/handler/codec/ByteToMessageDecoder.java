                ...
                try {
                    if (this.cumulation != null && !this.cumulation.isReadable()) {
                        ...
                        try {
                            ...
                            throw new IllegalReferenceCountException(this.getClass().getSimpleName() + "#decode() might have released its input buffer, or passed it down the pipeline without a retain() call, which is not allowed.", e4);
                        }
                        this.cumulation = null;
