...
import net.darkmeow.irc.lib.io.netty.util.ResourceLeakDetectorFactory;
...
extends ByteBuf {
    ...
    private static final String LEGACY_PROP_CHECK_ACCESSIBLE = "net.darkmeow.irc.lib.io.netty.buffer.bytebuf.checkAccessible";
    private static final String PROP_CHECK_ACCESSIBLE = "net.darkmeow.irc.lib.io.netty.buffer.checkAccessible";
    static final boolean checkAccessible = SystemPropertyUtil.contains("net.darkmeow.irc.lib.io.netty.buffer.checkAccessible") ? SystemPropertyUtil.getBoolean("net.darkmeow.irc.lib.io.netty.buffer.checkAccessible", true) : SystemPropertyUtil.getBoolean("net.darkmeow.irc.lib.io.netty.buffer.bytebuf.checkAccessible", true);
    private static final String PROP_CHECK_BOUNDS = "net.darkmeow.irc.lib.io.netty.buffer.checkBounds";
    private static final boolean checkBounds = SystemPropertyUtil.getBoolean("net.darkmeow.irc.lib.io.netty.buffer.checkBounds", true);
    ...
    public boolean equals(Object o2) {
        return o2 instanceof ByteBuf && ByteBufUtil.equals(this, (ByteBuf)o2);
    }
