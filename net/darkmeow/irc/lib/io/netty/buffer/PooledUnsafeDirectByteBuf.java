...
import net.darkmeow.irc.lib.io.netty.buffer.UnsafeDirectSwappedByteBuf;
...
extends PooledByteBuf<ByteBuffer> {
    ...
    @Override
    void init(PoolChunk<ByteBuffer> chunk, ByteBuffer nioBuffer, long handle, int offset, int length, int maxLength, PoolThreadCache cache2) {
        super.init(chunk, nioBuffer, handle, offset, length, maxLength, cache2);
