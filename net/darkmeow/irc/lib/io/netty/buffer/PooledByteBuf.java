...
extends AbstractReferenceCountedByteBuf {
    ...
    void init(PoolChunk<T> chunk, ByteBuffer nioBuffer, long handle, int offset, int length, int maxLength, PoolThreadCache cache2) {
        this.init0(chunk, nioBuffer, handle, offset, length, maxLength, cache2);
    }
    ...
    private void init0(PoolChunk<T> chunk, ByteBuffer nioBuffer, long handle, int offset, int length, int maxLength, PoolThreadCache cache2) {
        assert (handle >= 0L);
        assert (chunk != null);
