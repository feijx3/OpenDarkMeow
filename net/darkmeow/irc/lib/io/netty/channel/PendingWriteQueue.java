...
import net.darkmeow.irc.lib.io.netty.channel.PendingBytesTracker;
...
public final class PendingWriteQueue {
    ...
    private static final int PENDING_WRITE_OVERHEAD = SystemPropertyUtil.getInt("net.darkmeow.irc.lib.io.netty.transport.pendingWriteSizeOverhead", 64);
