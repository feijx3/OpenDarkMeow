...
import net.darkmeow.irc.lib.io.netty.channel.SingleThreadEventLoop;
...
implements IoEventLoop {
    private static final long DEFAULT_MAX_TASK_PROCESSING_QUANTUM_NS = TimeUnit.MILLISECONDS.toNanos(Math.max(100, SystemPropertyUtil.getInt("net.darkmeow.irc.lib.io.netty.eventLoop.maxTaskProcessingQuantumMs", 1000)));
