...
import net.darkmeow.irc.lib.io.netty.channel.socket.ChannelInputShutdownEvent;
import net.darkmeow.irc.lib.io.netty.channel.socket.ChannelInputShutdownReadComplete;
            ...
            try {
                do {
                    ...
                    if (allocHandle.lastBytesRead() <= 0) {
                        byteBuf.release();
                        byteBuf = null;
                        boolean bl2 = close = allocHandle.lastBytesRead() < 0;
                        if (!close) break;
                        AbstractNioByteChannel.this.readPending = false;
                        break;
                    }
