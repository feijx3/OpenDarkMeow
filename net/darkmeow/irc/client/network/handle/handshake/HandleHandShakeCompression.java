...
public final class HandleHandShakeCompression
extends SimpleChannelInboundHandler<S2CPacketEnableCompression> {
    @NotNull
    ...
    protected void channelRead0(ChannelHandlerContext ctx, S2CPacketEnableCompression packet) throws Exception {
        this.connection.enableCompression(packet.getThreshold());
    }
}
