...
@SourceDebugExtension(value={"SMAP\nGuiDirectLogin.kt\nKotlin\n*S Kotlin\n*F\n+ 1 GuiDirectLogin.kt\nnet/ccbluex/liquidbounce/ui/client/altmanager/sub/GuiDirectLogin\n+ 2 fake.kt\nkotlin/jvm/internal/FakeKt\n*L\n1#1,83:1\n1#2:84\n*E\n"})
...
extends GuiScreen {
    ...
    public void func_73863_a(int mouseX, int mouseY, float partialTicks) {
        ...
        RendererExtensionKt.drawCenteredString(fontRenderer, "Direct Login", (float)this.field_146294_l / 2.0f, 34.0f, 0xFFFFFF);
        ...
        RendererExtensionKt.drawCenteredString(fontRenderer2, this.status, (float)this.field_146294_l / 2.0f, (float)this.field_146295_m / 4.0f + 60.0f, 0xFFFFFF);
        GuiTextField guiTextField = this.username;
        if (guiTextField == null) {
            Intrinsics.throwUninitializedPropertyAccessException("username");
            guiTextField = null;
    ...
    protected void func_146284_a(@NotNull GuiButton button) {
        ...
        switch (button.field_146127_k) {
            ...
            case 1: {
                ...
                new Thread(() -> GuiDirectLogin.actionPerformed$lambda$0(this)).start();
            }
        }
...
lbl18:
    ...
    private static final void actionPerformed$lambda$0(GuiDirectLogin this$0) {
        ...
        String string = guiTextField.func_146179_b();
        Intrinsics.checkNotNullExpressionValue(string, "getText(...)");
        String res = GuiAltManager.Companion.login(AccountSerializer.INSTANCE.accountInstance(string, ""));
