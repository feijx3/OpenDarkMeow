...
extends AnimationModeLegacySwordBlockMode {
    ...
    public void apply(@NotNull AbstractClientPlayer player, float partialTicks) {
        ...
        boolean bl2 = false;
        GlStateManager.func_179109_b((float)0.0f, (float)(AnimationModeLegacySwordBlockPrevSwingExtend.INSTANCE.getCurrentSwingProgress(player, partialTicks) * -0.6f), (float)0.0f);
