...
extends ProjectilesMode {
    ...
    public boolean canHandleProjectiles(@NotNull Item item) {
        ...
        return item instanceof ItemPotion && Intrinsics.areEqual(item, Items.field_185155_bH);
    }

    @Override
    @NotNull
    public ProjectilesInfo doHandleProjectiles() {
        return new ProjectilesInfo(false, 0.5f, 0.0f, 0.05f, 0.25f, 5, null);
    }
}
