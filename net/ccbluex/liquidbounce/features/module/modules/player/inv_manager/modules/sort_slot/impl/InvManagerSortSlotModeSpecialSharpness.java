...
extends InvManagerSortSlotMode {
    ...
    public InvManagerSortSlotResult searchSlot(@NotNull InvManagerSortSlotPlayerInventory inventory) {
        ...
        boolean bl2 = false;
        inventory.forEach((arg_0, arg_1) -> InvManagerSortSlotModeSpecialSharpness.searchSlot$lambda$2$lambda$1((arg_0, arg_1) -> InvManagerSortSlotModeSpecialSharpness.searchSlot$lambda$2$lambda$0(it, this, arg_0, arg_1), arg_0, arg_1));
    ...
    private final int getSpecialKnockBackWeight(ItemStack stack) {
        ...
        block1: {
            ...
            for (Object element$iv : $this$firstOrNull$iv) {
                ...
                boolean bl2 = false;
                if (!Intrinsics.areEqual(it.getEnchant(), Enchantments.field_185302_k)) continue;
                v0 = element$iv;
                break block1;
            }
            v0 = null;
    ...
    private static final Unit searchSlot$lambda$2$lambda$0(InvManagerSortSlotResult $it, InvManagerSortSlotModeSpecialSharpness this$0, Integer index, ItemStack stack) {
