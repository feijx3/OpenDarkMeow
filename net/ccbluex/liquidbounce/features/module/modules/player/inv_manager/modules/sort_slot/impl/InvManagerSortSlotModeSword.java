...
@Metadata(mv={2, 2, 0}, k=1, xi=48, d1={"\u0000,\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\b\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0018\u0002\n\u0000\u0018\u00002\u00020\u0001B\u0007\u00a2\u0006\u0004\b\u0002\u0010\u0003J\u0010\u0010\r\u001a\u00020\u000e2\u0006\u0010\u000f\u001a\u00020\u0010H\u0016J\u0010\u0010\u0011\u001a\u00020\u00122\u0006\u0010\u0013\u001a\u00020\u0014H\u0002R\u000e\u0010\u0004\u001a\u00020\u0005X\u0082\u0004\u00a2\u0006\u0002\n\u0000R\u000e\u0010\u0006\u001a\u00020\u0005X\u0082\u0004\u00a2\u0006\u0002\n\u0000R\u000e\u0010\u0007\u001a\u00020\u0005X\u0082\u0004\u00a2\u0006\u0002\n\u0000R\u000e\u0010\b\u001a\u00020\u0005X\u0082\u0004\u00a2\u0006\u0002\n\u0000R\u000e\u0010\t\u001a\u00020\u0005X\u0082\u0004\u00a2\u0006\u0002\n\u0000R\u000e\u0010\n\u001a\u00020\u0005X\u0082\u0004\u00a2\u0006\u0002\n\u0000R\u000e\u0010\u000b\u001a\u00020\u0005X\u0082\u0004\u00a2\u0006\u0002\n\u0000R\u000e\u0010\f\u001a\u00020\u0005X\u0082\u0004\u00a2\u0006\u0002\n\u0000\u00a8\u0006\u0015"}, d2={"Lnet/ccbluex/liquidbounce/features/module/modules/player/inv_manager/modules/sort_slot/impl/InvManagerSortSlotModeSword;", "Lnet/ccbluex/liquidbounce/features/module/modules/player/inv_manager/modules/sort_slot/InvManagerSortSlotMode;", "<init>", "()V", "weightMaterialDiamondValue", "Lnet/ccbluex/liquidbounce/value/impl/IntegerValue;", "weightMaterialIronValue", "weightMaterialGoldValue", "weightMaterialStoneValue", "weightMaterialWoodValue", "weightEnchantSharpnessValue", "weightEnchantKnockBackValue", "weightEnchantUnBreakingValue", "searchSlot", "Lnet/ccbluex/liquidbounce/features/module/modules/player/inv_manager/modules/sort_slot/InvManagerSortSlotResult;", "inventory", "Lnet/ccbluex/liquidbounce/features/module/modules/player/inv_manager/modules/sort_slot/InvManagerSortSlotPlayerInventory;", "getSwordWeight", "", "stack", "Lnet/minecraft/item/ItemStack;", "DarkMeow"})
@SourceDebugExtension(value={"SMAP\nInvManagerSortSlotModeSword.kt\nKotlin\n*S Kotlin\n*F\n+ 1 InvManagerSortSlotModeSword.kt\nnet/ccbluex/liquidbounce/features/module/modules/player/inv_manager/modules/sort_slot/impl/InvManagerSortSlotModeSword\n+ 2 _Collections.kt\nkotlin/collections/CollectionsKt___CollectionsKt\n*L\n1#1,62:1\n1869#2,2:63\n*S KotlinDebug\n*F\n+ 1 InvManagerSortSlotModeSword.kt\nnet/ccbluex/liquidbounce/features/module/modules/player/inv_manager/modules/sort_slot/impl/InvManagerSortSlotModeSword\n*L\n49#1:63,2\n*E\n"})
public final class InvManagerSortSlotModeSword
extends InvManagerSortSlotMode {
    ...
    @NotNull
    private final IntegerValue weightEnchantKnockBackValue = new IntegerValue(this.getValuePrefix() + "WeightEnchantKnockBack", 0, new IntRange(0, 10));
    @NotNull
    ...
    public InvManagerSortSlotModeSword() {
        super("Sword", 0, 2, null);
    }
    ...
    public InvManagerSortSlotResult searchSlot(@NotNull InvManagerSortSlotPlayerInventory inventory) {
        ...
        boolean bl2 = false;
        inventory.forEach((arg_0, arg_1) -> InvManagerSortSlotModeSword.searchSlot$lambda$2$lambda$1((arg_0, arg_1) -> InvManagerSortSlotModeSword.searchSlot$lambda$2$lambda$0(it, this, arg_0, arg_1), arg_0, arg_1));
    ...
    private final int getSwordWeight(ItemStack stack) {
        ...
        ItemSword itemSword = object instanceof ItemSword ? (ItemSword)object : null;
        if (itemSword == null) {
            n2 = Integer.MIN_VALUE;
        } else {
            ItemSword item = itemSword;
            int weight = 0;
            object = item.func_150932_j();
            ...
            for (Object element$iv : $this$forEach$iv) {
                ...
                weight += Intrinsics.areEqual(enchantment, Enchantments.field_185302_k) ? ((Number)this.weightEnchantSharpnessValue.get()).intValue() * it2.getLevel() : (Intrinsics.areEqual(enchantment, Enchantments.field_180313_o) ? ((Number)this.weightEnchantKnockBackValue.get()).intValue() * it2.getLevel() : (Intrinsics.areEqual(enchantment, Enchantments.field_185307_s) ? ((Number)this.weightEnchantUnBreakingValue.get()).intValue() * it2.getLevel() : 0));
            }
            n2 = weight;
        }
        return n2;
    ...
    private static final Unit searchSlot$lambda$2$lambda$0(InvManagerSortSlotResult $it, InvManagerSortSlotModeSword this$0, Integer index, ItemStack stack) {
