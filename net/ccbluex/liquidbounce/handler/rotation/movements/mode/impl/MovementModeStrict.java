...
@Metadata(mv={2, 2, 0}, k=1, xi=48, d1={"\u0000*\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\b\u00c6\u0002\u0018\u00002\u00020\u0001B\t\b\u0002\u00a2\u0006\u0004\b\u0002\u0010\u0003J(\u0010\u0004\u001a\u00020\u00052\u0006\u0010\u0006\u001a\u00020\u00072\u0006\u0010\b\u001a\u00020\t2\u0006\u0010\n\u001a\u00020\u000b2\u0006\u0010\f\u001a\u00020\rH\u0016\u00a8\u0006\u000e"}, d2={"Lnet/ccbluex/liquidbounce/handler/rotation/movements/mode/impl/MovementModeStrict;", "Lnet/ccbluex/liquidbounce/handler/rotation/movements/mode/MovementMode;", "<init>", "()V", "apply", "", "base", "Lnet/ccbluex/liquidbounce/handler/rotation/RotationManagerApply;", "task", "Lnet/ccbluex/liquidbounce/handler/rotation/data/RotationTask;", "movementInput", "Lnet/minecraft/util/MovementInput;", "player", "Lnet/minecraft/client/entity/EntityPlayerSP;", "DarkMeow"})
public final class MovementModeStrict
extends MovementMode {
    @NotNull
    public static final MovementModeStrict INSTANCE = new MovementModeStrict();

    private MovementModeStrict() {
        super("Strict");
    }
    ...
    public void apply(@NotNull RotationManagerApply base, @NotNull RotationTask task, @NotNull MovementInput movementInput, @NotNull EntityPlayerSP player) {
        ...
        base.movementYaw = Float.valueOf(task.getRotation().yaw);
    }
}
