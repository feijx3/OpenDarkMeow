...
Matrix3fc {
    ...
    public Matrix3f reflect(float nx, float ny, float nz, Matrix3f dest) {
        ...
        float db2 = ny + ny;
        float dc2 = nz + nz;
        float rm00 = 1.0f - da2 * nx;
        float rm01 = -da2 * ny;
        float rm02 = -da2 * nz;
        float rm10 = -db2 * nx;
        float rm11 = 1.0f - db2 * ny;
        float rm12 = -db2 * nz;
        float rm20 = -dc2 * nx;
        float rm21 = -dc2 * ny;
        float rm22 = 1.0f - dc2 * nz;
        float nm00 = this.m00 * rm00 + this.m10 * rm01 + this.m20 * rm02;
        float nm01 = this.m01 * rm00 + this.m11 * rm01 + this.m21 * rm02;
        float nm02 = this.m02 * rm00 + this.m12 * rm01 + this.m22 * rm02;
        float nm10 = this.m00 * rm10 + this.m10 * rm11 + this.m20 * rm12;
    ...
    public Matrix3f reflection(float nx, float ny, float nz) {
        ...
        float db2 = ny + ny;
        float dc2 = nz + nz;
        this._m00(1.0f - da2 * nx);
        this._m01(-da2 * ny);
        this._m02(-da2 * nz);
        this._m10(-db2 * nx);
        this._m11(1.0f - db2 * ny);
        this._m12(-db2 * nz);
        this._m20(-dc2 * nx);
        this._m21(-dc2 * ny);
        this._m22(1.0f - dc2 * nz);
        return this;
    }
