...
Matrix3dc {
    ...
    public Matrix3d reflect(double nx, double ny, double nz, Matrix3d dest) {
        ...
        double db2 = ny + ny;
        double dc2 = nz + nz;
        double rm00 = 1.0 - da2 * nx;
        double rm01 = -da2 * ny;
        double rm02 = -da2 * nz;
        double rm10 = -db2 * nx;
        double rm11 = 1.0 - db2 * ny;
        double rm12 = -db2 * nz;
        double rm20 = -dc2 * nx;
        double rm21 = -dc2 * ny;
        double rm22 = 1.0 - dc2 * nz;
        double nm00 = this.m00 * rm00 + this.m10 * rm01 + this.m20 * rm02;
        double nm01 = this.m01 * rm00 + this.m11 * rm01 + this.m21 * rm02;
        double nm02 = this.m02 * rm00 + this.m12 * rm01 + this.m22 * rm02;
        double nm10 = this.m00 * rm10 + this.m10 * rm11 + this.m20 * rm12;
    ...
    public Matrix3d reflection(double nx, double ny, double nz) {
        ...
        double db2 = ny + ny;
        double dc2 = nz + nz;
        this._m00(1.0 - da2 * nx);
        this._m01(-da2 * ny);
        this._m02(-da2 * nz);
        this._m10(-db2 * nx);
        this._m11(1.0 - db2 * ny);
        this._m12(-db2 * nz);
        this._m20(-dc2 * nx);
        this._m21(-dc2 * ny);
        this._m22(1.0 - dc2 * nz);
        return this;
    }
