...
Cloneable {
    ...
    public AxisAngle4f(AxisAngle4f a2) {
        ...
        this.y = a2.y;
        this.z = a2.z;
        this.angle = (float)(((double)a2.angle < 0.0 ? java.lang.Math.PI * 2 + (double)a2.angle % (java.lang.Math.PI * 2) : (double)a2.angle) % (java.lang.Math.PI * 2));
    }
    ...
    public AxisAngle4f set(Matrix3fc m2) {
        ...
        float s2 = Math.sqrt((nm12 - nm21) * (nm12 - nm21) + (nm20 - nm02) * (nm20 - nm02) + (nm01 - nm10) * (nm01 - nm10));
    ...
    public AxisAngle4f set(Matrix3dc m2) {
        ...
        double s2 = Math.sqrt((nm12 - nm21) * (nm12 - nm21) + (nm20 - nm02) * (nm20 - nm02) + (nm01 - nm10) * (nm01 - nm10));
