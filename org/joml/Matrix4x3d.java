...
Matrix4x3dc {
    ...
    public double[] get(double[] arr2, int offset) {
        arr2[offset + 0] = this.m00;
        arr2[offset + 1] = this.m01;
        arr2[offset + 2] = this.m02;
        arr2[offset + 3] = this.m10;
        arr2[offset + 4] = this.m11;
        arr2[offset + 5] = this.m12;
        arr2[offset + 6] = this.m20;
        arr2[offset + 7] = this.m21;
        arr2[offset + 8] = this.m22;
        arr2[offset + 9] = this.m30;
        arr2[offset + 10] = this.m31;
        arr2[offset + 11] = this.m32;
        return arr2;
    }

    public double[] get(double[] arr2) {
        return this.get(arr2, 0);
    }

    public float[] get(float[] arr2, int offset) {
        arr2[offset + 0] = (float)this.m00;
        arr2[offset + 1] = (float)this.m01;
        arr2[offset + 2] = (float)this.m02;
        arr2[offset + 3] = (float)this.m10;
        arr2[offset + 4] = (float)this.m11;
        arr2[offset + 5] = (float)this.m12;
        arr2[offset + 6] = (float)this.m20;
        arr2[offset + 7] = (float)this.m21;
        arr2[offset + 8] = (float)this.m22;
        arr2[offset + 9] = (float)this.m30;
        arr2[offset + 10] = (float)this.m31;
        arr2[offset + 11] = (float)this.m32;
        return arr2;
    }
    ...
    public float[] get4x4(float[] arr2, int offset) {
        MemUtil.INSTANCE.copy4x4(this, arr2, offset);
        return arr2;
    }

    public float[] get4x4(float[] arr2) {
        return this.get4x4(arr2, 0);
    }

    public double[] get4x4(double[] arr2, int offset) {
        MemUtil.INSTANCE.copy4x4(this, arr2, offset);
        return arr2;
    }

    public double[] get4x4(double[] arr2) {
        return this.get4x4(arr2, 0);
    }
    ...
    public double[] getTransposed(double[] arr2, int offset) {
        arr2[offset + 0] = this.m00;
        arr2[offset + 1] = this.m10;
        arr2[offset + 2] = this.m20;
        arr2[offset + 3] = this.m30;
        arr2[offset + 4] = this.m01;
        arr2[offset + 5] = this.m11;
        arr2[offset + 6] = this.m21;
        arr2[offset + 7] = this.m31;
        arr2[offset + 8] = this.m02;
        arr2[offset + 9] = this.m12;
        arr2[offset + 10] = this.m22;
        arr2[offset + 11] = this.m32;
        return arr2;
    }

    public double[] getTransposed(double[] arr2) {
        return this.getTransposed(arr2, 0);
    }
    ...
    private Matrix4x3d rotationInternal(double angle, double x2, double y2, double z2) {
        ...
        double xz = x2 * z2;
        double yz = y2 * z2;
        this.m00 = cos + x2 * x2 * C;
        this.m01 = xy * C + z2 * sin;
        this.m02 = xz * C - y2 * sin;
        this.m10 = xy * C - z2 * sin;
        this.m11 = cos + y2 * y2 * C;
        this.m12 = yz * C + x2 * sin;
        this.m20 = xz * C + y2 * sin;
        this.m21 = yz * C - x2 * sin;
        this.m22 = cos + z2 * z2 * C;
        this.m30 = 0.0;
        this.m31 = 0.0;
        this.m32 = 0.0;
        this.properties = 16;
    ...
    public Matrix4x3d translationRotateScale(double tx, double ty, double tz, double qx, double qy, double qz, double qw2, double sx, double sy, double sz) {
        double dqx = qx + qx;
        double dqy = qy + qy;
        double dqz = qz + qz;
        double q00 = dqx * qx;
    ...
    public Matrix4x3d translationRotateScaleMul(double tx, double ty, double tz, double qx, double qy, double qz, double qw2, double sx, double sy, double sz, Matrix4x3dc m2) {
        double dqx = qx + qx;
        double dqy = qy + qy;
        double dqz = qz + qz;
        double q00 = dqx * qx;
    ...
    public Matrix4x3d translationRotate(double tx, double ty, double tz, double qx, double qy, double qz, double qw2) {
        double w2 = qw2 * qw2;
        double x2 = qx * qx;
        double y2 = qy * qy;
        double z2 = qz * qz;
    ...
    public Matrix4x3d translationRotateMul(double tx, double ty, double tz, double qx, double qy, double qz, double qw2, Matrix4x3dc mat) {
        double w2 = qw2 * qw2;
        double x2 = qx * qx;
        double y2 = qy * qy;
        double z2 = qz * qz;
    ...
    public Matrix4x3d translationRotateInvert(double tx, double ty, double tz, double qx, double qy, double qz, double qw2) {
        double nqx = -qx;
        double nqy = -qy;
        double nqz = -qz;
        double dqx = nqx + nqx;
