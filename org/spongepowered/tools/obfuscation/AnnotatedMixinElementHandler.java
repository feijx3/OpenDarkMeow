...
abstract class AnnotatedMixinElementHandler {
    ...
    private void validateMethodVisibility(ExecutableElement method, AnnotationHandle annotation, String type, TypeHandle target, MethodHandle targetMethod) {
        ...
        String visibility2 = "visibility of " + (Object)((Object)visTarget) + " method in " + target;
        if (visTarget.ordinal() > visMethod.ordinal()) {
            this.printMessage(Diagnostic.Kind.WARNING, (Object)((Object)visMethod) + " " + type + " method cannot reduce " + visibility2, method, annotation);
        } else if (visTarget == Visibility.PRIVATE && visMethod.ordinal() > visTarget.ordinal()) {
            this.printMessage(Diagnostic.Kind.WARNING, (Object)((Object)visMethod) + " " + type + " method will upgrade " + visibility2, method, annotation);
        }
    }
    ...
    private void printMessage(Diagnostic.Kind kind2, String msg, Element e2, AnnotationHandle annotation) {
        if (annotation == null) {
            this.ap.printMessage(kind2, msg, e2);
        } else {
            this.ap.printMessage(kind2, msg, e2, annotation.asMirror());
        }
    }
    ...
    static abstract class AnnotatedElement<E extends Element> {
        ...
        public final void printMessage(Messager messager, Diagnostic.Kind kind2, CharSequence msg) {
            messager.printMessage(kind2, msg, (Element)this.element, this.annotation.asMirror());
        }
    }
}
