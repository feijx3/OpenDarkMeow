...
public class TypeHandle {
    ...
    public <T extends Element> List<T> getEnclosedElements(ElementKind ... kind2) {
        return TypeHandle.getEnclosedElements(this.getTargetElement(), kind2);
    }
    ...
    protected static <T extends Element> List<T> getEnclosedElements(TypeElement targetElement, ElementKind ... kind2) {
        if (kind2 == null || kind2.length < 1) {
