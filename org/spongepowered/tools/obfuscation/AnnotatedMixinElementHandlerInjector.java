...
extends AnnotatedMixinElementHandler {
    ...
    private boolean registerInjector(AnnotatedElementInjector elem, String reference, MemberInfo targetMember, TypeHandle target) {
        ...
        if (desc == null) {
            ...
            Diagnostic.Kind kind2 = error = this.mixin.isMultiTarget() ? Diagnostic.Kind.ERROR : Diagnostic.Kind.WARNING;
    ...
    extends AnnotatedMixinElementHandler.AnnotatedElement<ExecutableElement> {
        ...
        public void addMessage(Diagnostic.Kind kind2, CharSequence msg, Element element, AnnotationHandle annotation) {
            this.state.addMessage(kind2, msg, element, annotation);
        }
