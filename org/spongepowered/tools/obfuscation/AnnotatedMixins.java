...
IJavadocProvider {
    ...
    @Override
    public void printMessage(Diagnostic.Kind kind2, CharSequence msg) {
        if (this.env == IMixinAnnotationProcessor.CompilerEnvironment.JAVAC || kind2 != Diagnostic.Kind.NOTE) {
            this.processingEnv.getMessager().printMessage(kind2, msg);
        }
    }

    @Override
    public void printMessage(Diagnostic.Kind kind2, CharSequence msg, Element element) {
        this.processingEnv.getMessager().printMessage(kind2, msg, element);
    }

    @Override
    public void printMessage(Diagnostic.Kind kind2, CharSequence msg, Element element, AnnotationMirror annotation) {
        this.processingEnv.getMessager().printMessage(kind2, msg, element, annotation);
    }

    @Override
    public void printMessage(Diagnostic.Kind kind2, CharSequence msg, Element element, AnnotationMirror annotation, AnnotationValue value) {
        this.processingEnv.getMessager().printMessage(kind2, msg, element, annotation, value);
    }
