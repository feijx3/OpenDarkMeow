...
class AnnotatedMixin {
    ...
    private void printMessage(Diagnostic.Kind kind2, CharSequence msg, AnnotatedMixin mixin) {
        this.messager.printMessage(kind2, msg, this.mixin, this.annotation.asMirror());
    }
