...
public final class Bytecode {
    ...
    public static void setVisibility(MethodNode method, Visibility visibility2) {
        method.access = Bytecode.setVisibility(method.access, visibility2.access);
    }

    public static void setVisibility(FieldNode field, Visibility visibility2) {
        field.access = Bytecode.setVisibility(field.access, visibility2.access);
    }
        ...
        while (ia.hasNext() && ib.hasNext()) {
            ...
            if (!(na instanceof LabelNode)) {
                if (na instanceof MethodInsnNode) {
                    ...
                    MethodInsnNode mb = (MethodInsnNode)nb2;
