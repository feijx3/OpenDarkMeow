...
extends CtMember {
    ...
    private void addParameter2(int where, CtClass type, String desc) throws BadBytecode {
        ...
        if (ca2 != null) {
            ...
            if ((sm = (StackMap)ca2.getAttribute("StackMap")) != null) {
    ...
    private void insertBefore(String src, boolean rebuild) throws CannotCompileException {
        ...
        try {
            ...
            jv.recordParamNames(ca2, nvars);
            jv.recordLocalVariables(ca2, 0);
        ...
        try {
            ...
            while (iterator2.hasNext() && (pos = iterator2.next()) < handlerPos) {
                ...
                if (noReturn) {
                    ...
                    handlerPos = iterator2.append(b2.get());
                    iterator2.append(b2.getExceptionTable(), handlerPos);
    ...
    private int insertAfterAdvice(Bytecode code, Javac jv, String src, ConstPool cp2, CtClass rtype, int varNo) throws CompileError {
    ...
    public int insertAt(int lineNum, boolean modify, String src) throws CannotCompileException {
        ...
        Javac jv = new Javac(cc2);
        try {
            jv.recordLocalVariables(ca2, index);
            jv.recordParams(this.getParameterTypes(), Modifier.isStatic(this.getModifiers()));
            jv.setMaxLocals(ca2.getMaxLocals());
            jv.compileStmnt(src);
            Bytecode b2 = jv.getBytecode();
            int locals = b2.getMaxLocals();
            int stack = b2.getMaxStack();
            ...
            index = iterator2.insertAt(index, b2.get());
            iterator2.insert(b2.getExceptionTable(), index);
            this.methodInfo.rebuildStackMapIf6(cc2.getClassPool(), cc2.getClassFile2());
            return lineNum;
        }
        catch (NotFoundException e2) {
