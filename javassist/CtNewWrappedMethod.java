...
class CtNewWrappedMethod {
    ...
    private static void checkSignature(CtMethod wrappedBody, String descriptor2) throws CannotCompileException {
        if (!descriptor2.equals(wrappedBody.getMethodInfo2().getDescriptor())) {
    ...
    private static String addBodyMethod(CtClassType clazz, ClassFile classfile, CtMethod src) throws BadBytecode, CannotCompileException {
        ...
        if (bodyname == null) {
            ...
            CtMember.Cache cache2 = clazz.hasMemberCache();
            if (cache2 != null) {
                cache2.addMethod(new CtMethod(body, clazz));
            }
        }
        return bodyname;
    }
