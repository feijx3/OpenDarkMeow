...
implements InvocationHandler {
    ...
    public static Object make(ClassLoader cl2, Class<?> clazz, ClassPool cp2, Annotation anon) throws IllegalArgumentException {
        ...
        return Proxy.newProxyInstance(cl2, new Class[]{clazz}, handler);
    }
    ...
    public int hashCode() {
        if (this.cachedHashCode == Integer.MIN_VALUE) {
            ...
            for (int i2 = 0; i2 < methods2.length; ++i2) {
                ...
                try {
                    if (mv != null) {
                        value = mv.getValue(this.classLoader, this.pool, methods2[i2]);
                    }
                    if (value == null) {
                        value = this.getDefault(name, methods2[i2]);
                    }
                }
    ...
    private boolean checkEquals(Object obj) throws Exception {
        ...
        for (int i2 = 0; i2 < methods2.length; ++i2) {
            ...
            try {
                ...
                otherValue = methods2[i2].invoke(obj, new Object[0]);
            }
            catch (RuntimeException e2) {
                throw e2;
            }
