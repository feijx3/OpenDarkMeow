...
public class MethodInfo {
    ...
    MethodInfo(ConstPool cp2, DataInputStream in) throws IOException {
        this(cp2);
        this.read(in);
    }
    ...
    public void setSuperclass(String superclass) throws BadBytecode {
        ...
        if (pos >= 0) {
            ...
            int nt = cp2.getMethodrefNameAndType(mref);
            int sc = cp2.addClassInfo(superclass);
            int mref2 = cp2.addMethodrefInfo(sc, nt);
