...
public class Descriptor {
    ...
    public static String toClassName(String descriptor2) {
        String name;
        int arrayDim = 0;
        int i2 = 0;
        char c2 = descriptor2.charAt(0);
        while (c2 == '[') {
            ++arrayDim;
            c2 = descriptor2.charAt(++i2);
        }
        if (c2 == 'L') {
            int i22 = descriptor2.indexOf(59, i2++);
            name = descriptor2.substring(i2, i22).replace('/', '.');
            i2 = i22;
        } else if (c2 == 'V') {
            name = "void";
        } else if (c2 == 'I') {
            ...
            throw new RuntimeException("bad descriptor: " + descriptor2);
        }
        if (i2 + 1 != descriptor2.length()) {
            throw new RuntimeException("multiple descriptors?: " + descriptor2);
        }
        if (arrayDim == 0) {
            return name;
        }
    ...
    public static String appendParameter(CtClass type, String descriptor2) {
        int i2 = descriptor2.indexOf(41);
        if (i2 < 0) {
            return descriptor2;
        }
        StringBuffer newdesc = new StringBuffer();
        newdesc.append(descriptor2.substring(0, i2));
        Descriptor.toDescriptor(newdesc, type);
        newdesc.append(descriptor2.substring(i2));
        return newdesc.toString();
    }

    public static String insertParameter(CtClass type, String descriptor2) {
        if (descriptor2.charAt(0) != '(') {
            return descriptor2;
        }
        return "(" + Descriptor.of(type) + descriptor2.substring(1);
    }
