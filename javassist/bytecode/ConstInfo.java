...
abstract class ConstInfo {
    ...
    public void renameClass(ConstPool cp2, String oldName, String newName, Map<ConstInfo, ConstInfo> cache2) {
    }

    public void renameClass(ConstPool cp2, Map<String, String> classnames, Map<ConstInfo, ConstInfo> cache2) {
    }
