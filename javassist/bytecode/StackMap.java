...
extends AttributeInfo {
    ...
    StackMap(ConstPool cp2, byte[] newInfo) {
        super(cp2, tag, newInfo);
    }

    StackMap(ConstPool cp2, int name_id, DataInputStream in) throws IOException {
        super(cp2, name_id, in);
    }
    ...
    public static class Writer {
        ...
        public StackMap toStackMap(ConstPool cp2) {
            return new StackMap(cp2, this.output.toByteArray());
        }
