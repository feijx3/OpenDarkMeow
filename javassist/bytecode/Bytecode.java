...
Opcode {
    ...
    public void addGetfield(CtClass c2, String name, String type) {
        this.add(180);
        int ci2 = this.constPool.addClassInfo(c2);
        this.addIndex(this.constPool.addFieldrefInfo(ci2, name, type));
    ...
    private void addPutfield0(CtClass target, String classname, String name, String desc) {
        this.add(181);
        int ci2 = classname == null ? this.constPool.addClassInfo(target) : this.constPool.addClassInfo(classname);
        this.addIndex(this.constPool.addFieldrefInfo(ci2, name, desc));
    ...
    private void addPutstatic0(CtClass target, String classname, String fieldName, String desc) {
        this.add(179);
        int ci2 = classname == null ? this.constPool.addClassInfo(target) : this.constPool.addClassInfo(classname);
        this.addIndex(this.constPool.addFieldrefInfo(ci2, fieldName, desc));
        this.growStack(-Descriptor.dataSize(desc));
    }
