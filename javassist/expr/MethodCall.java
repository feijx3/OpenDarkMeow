...
extends Expr {
    ...
    public String getMethodName() {
        ConstPool cp2 = this.getConstPool();
        int nt = this.getNameAndType(cp2);
        return cp2.getUtf8Info(cp2.getNameAndTypeName(nt));
    }
    ...
    public String getSignature() {
        ConstPool cp2 = this.getConstPool();
        int nt = this.getNameAndType(cp2);
        return cp2.getUtf8Info(cp2.getNameAndTypeDescriptor(nt));
    }
    ...
    public void replace(String statement) throws CannotCompileException {
        ...
        try {
            ...
            jc.recordLocalVariables(ca2, pos);
