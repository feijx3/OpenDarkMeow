...
public abstract class CtClass {
    ...
    public Class<?> toClass(ClassLoader loader, ProtectionDomain domain) throws CannotCompileException {
        ClassPool cp2 = this.getClassPool();
        if (loader == null) {
            loader = cp2.getClassLoader();
        }
        return cp2.toClass(this, null, loader, domain);
    }
    ...
    public void detach() {
        ClassPool cp2 = this.getClassPool();
        CtClass obj = cp2.removeCached(this.getName());
        if (obj != this) {
            cp2.cacheCtClass(this.getName(), obj, false);
        }
    }
