...
RasterOp {
    ...
    public AffineTransformOp(AffineTransform affineTransform, int n2) {
        this.delegate = new java.awt.image.AffineTransformOp(affineTransform, n2);
    }
    ...
    public BufferedImage filter(BufferedImage bufferedImage, BufferedImage bufferedImage2) {
        try {
            ...
            try {
                Object object;
                int n2 = this.delegate.getInterpolationType();
                if (n2 > 0) {
