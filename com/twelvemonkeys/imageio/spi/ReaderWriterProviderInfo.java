...
extends ProviderInfo {
    ...
    protected ReaderWriterProviderInfo(Class<? extends ReaderWriterProviderInfo> clazz, String[] stringArray, String[] stringArray2, String[] stringArray3, String string, String[] stringArray4, String string2, String[] stringArray5, boolean bl2, String string3, String string4, String[] stringArray6, String[] stringArray7, boolean bl3, String string5, String string6, String[] stringArray8, String[] stringArray9) {
        super(Validate.notNull(clazz).getPackage());
        ...
        this.supportsStandardStreamMetadata = bl2;
        ...
        this.supportsStandardImageMetadata = bl3;
