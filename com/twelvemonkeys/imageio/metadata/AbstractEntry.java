...
implements Entry {
    ...
    public String getValueAsString() {
        ...
        if (n2 == 0 && this.value != null && this.value.getClass().isArray() && Array.getLength(this.value) == 0) {
            return "";
        }
        if (n2 > 1) {
            if (n2 < 16) {
            ...
            String string = AbstractEntry.arrayToString(CollectionUtil.subArray(this.value, 0, 4));
            String string2 = AbstractEntry.arrayToString(CollectionUtil.subArray(this.value, n2 - 4, 4));
            return String.format("%s ... %s (%d)", string.substring(0, string.length() - 1), string2.substring(1), n2);
        }
