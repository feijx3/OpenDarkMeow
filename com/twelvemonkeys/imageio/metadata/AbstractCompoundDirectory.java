...
implements CompoundDirectory {
    ...
    @Override
    public Directory getDirectory(int n2) {
        return this.directories.get(n2);
    }
    ...
    public boolean equals(Object object) {
        ...
        for (int i2 = 0; i2 < this.directoryCount(); ++i2) {
            if (this.getDirectory(i2).equals(compoundDirectory.getDirectory(i2))) continue;
            return false;
        }
        return true;
    }
