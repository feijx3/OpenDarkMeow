...
extends AbstractEntry {
    ...
    public TIFFEntry(int n2, Object object) {
        this(n2, TIFFEntry.guessType(object), object);
    }

    public TIFFEntry(int n2, short s2, Object object) {
        super(n2, object);
        if (s2 < 1 || s2 >= TIFF.TYPE_NAMES.length) {
            throw new IllegalArgumentException(String.format("Illegal TIFF type: %s", s2));
        }
        this.type = s2;
    }
    ...
    static short getType(Entry entry) {
        ...
        if (string != null) {
            for (int i2 = 1; i2 < TIFF.TYPE_NAMES.length; ++i2) {
                if (!string.equals(TIFF.TYPE_NAMES[i2])) continue;
                return (short)i2;
            }
        }
    ...
    private static short guessType(Object object) {
        Object object2 = Validate.notNull(object);
        ...
        if (object2 instanceof Short) {
            if (!bl2 && (Short)object2 < 127) {
                return 1;
            }
            return 3;
        }
        if (object2 instanceof Integer) {
            if (!bl2 && (Integer)object2 < Short.MAX_VALUE) {
                return 3;
            }
            return 4;
        }
        if (object2 instanceof Long && !bl2 && (Long)object2 < Integer.MAX_VALUE) {
            return 4;
        }
    ...
    static long getValueLength(int n2, long l2) {
        if (n2 > 0 && n2 < TIFF.TYPE_LENGTHS.length) {
            return (long)TIFF.TYPE_LENGTHS[n2] * l2;
        }
        return -1L;
    }
}
