...
public class Vector3d {
    ...
    public String toString() {
        return Vector3d.jvmdowngrader$concat$toString$1(this.x, this.y, this.z);
    }
    ...
    private static /* synthetic */ String jvmdowngrader$concat$toString$1(double d2, double d3, double d4) {
        return "Vector3d{x=" + d2 + ", y=" + d3 + ", z=" + d4 + "}";
    }
}
