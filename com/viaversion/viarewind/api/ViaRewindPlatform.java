...
public interface ViaRewindPlatform {
    public static final String VERSION = "4.0.9-SNAPSHOT";
    public static final String IMPL_VERSION = "git-ViaRewind-4.0.9-SNAPSHOT:aff88a6";
    ...
    default public String compressHandlerName() {
        return "compress";
    }

    default public String decompressHandlerName() {
        return "decompress";
    }
}
