...
public enum EntityDataIndex1_7_6_10 {
    ...
    public static EntityDataIndex1_7_6_10 searchIndex(EntityType type, int index) {
        ...
        do {
            ...
            if (!(optMeta = EntityDataIndex1_7_6_10.getIndex(currentType, index)).isPresent()) continue;
            return optMeta.get();
    ...
    static {
        ...
        for (EntityDataIndex1_7_6_10 index : EntityDataIndex1_7_6_10.values()) {
            ENTITY_DATA_REWRITES.put(new Pair<EntityTypes1_8.EntityType, Integer>(index.getClazz(), index.getNewIndex()), index);
        }
    }
}
