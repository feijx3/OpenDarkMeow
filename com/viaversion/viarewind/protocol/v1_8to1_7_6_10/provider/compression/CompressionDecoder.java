...
extends MessageToMessageDecoder<ByteBuf> {
    ...
    protected void decode(ChannelHandlerContext ctx, ByteBuf in, List<Object> out) throws Exception {
        ...
        if (outLength < this.threshold) {
            throw new DecoderException(CompressionDecoder.jvmdowngrader$concat$decode$1(outLength, this.threshold));
        }
        if (outLength > 0x200000) {
            throw new DecoderException(CompressionDecoder.jvmdowngrader$concat$decode$1(outLength));
        }
        ByteBuf temp = in;
        if (!in.hasArray()) {
    ...
    private static /* synthetic */ String jvmdowngrader$concat$decode$1(int n2, int n3) {
        return "Badly compressed packet - size of " + n2 + " is below server threshold of " + n3;
    }

    private static /* synthetic */ String jvmdowngrader$concat$decode$1(int n2) {
