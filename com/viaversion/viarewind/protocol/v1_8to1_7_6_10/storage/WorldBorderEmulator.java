...
extends StoredObject {
    ...
    public void init(double x2, double z2, double oldDiameter, double newDiameter, long lerpTime) {
        this.x = x2;
        this.z = z2;
    ...
    @NestHost(value=WorldBorderEmulator.class)
