...
@NestMembers(value={ScoreTeam.class})
...
extends StoredObject {
    ...
    public String sendTeamForScore(String score) {
        ...
        if (this.scoreTeams.containsKey(score)) {
            return this.scoreTeams.get(score).jvmdowngrader$nest$com_viaversion_viarewind_protocol_v1_8to1_7_6_10_storage_ScoreboardTracker$ScoreTeam$get$name();
        }
        int l2 = 16;
        ...
        String suffix = i2 + l2 >= score.length() ? "" : score.substring(i2 + l2);
    ...
    public String removeTeamForScore(String score) {
        ...
        this.scoreTeamNames.remove(scoreTeam.jvmdowngrader$nest$com_viaversion_viarewind_protocol_v1_8to1_7_6_10_storage_ScoreboardTracker$ScoreTeam$get$name());
        PacketWrapper teamPacket = PacketWrapper.create(ClientboundPackets1_7_2_5.SET_PLAYER_TEAM, this.getUser());
        teamPacket.write(Types.STRING, scoreTeam.jvmdowngrader$nest$com_viaversion_viarewind_protocol_v1_8to1_7_6_10_storage_ScoreboardTracker$ScoreTeam$get$name());
        teamPacket.write(Types.BYTE, (byte)1);
        teamPacket.send(Protocol1_8To1_7_6_10.class);
        return scoreTeam.jvmdowngrader$nest$com_viaversion_viarewind_protocol_v1_8to1_7_6_10_storage_ScoreboardTracker$ScoreTeam$get$name();
    }
    ...
    @NestHost(value=ScoreboardTracker.class)
    private static class ScoreTeam {
        ...
        public /* synthetic */ String jvmdowngrader$nest$com_viaversion_viarewind_protocol_v1_8to1_7_6_10_storage_ScoreboardTracker$ScoreTeam$get$name() {
            return this.name;
        }

        public /* synthetic */ void jvmdowngrader$nest$com_viaversion_viarewind_protocol_v1_8to1_7_6_10_storage_ScoreboardTracker$ScoreTeam$set$name(String string) {
            this.name = string;
        }
    }
}
