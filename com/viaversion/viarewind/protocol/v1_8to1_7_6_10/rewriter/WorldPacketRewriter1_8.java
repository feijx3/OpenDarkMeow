    ...
    protected void registerPackets() {
            ...
            public void register() {
                ...
                this.handler(wrapper -> {
                    ...
                    if (particle == Particles1_8.ICON_CRACK || particle == Particles1_8.BLOCK_CRACK || particle == Particles1_8.BLOCK_DUST) {
                        ...
                        int n2 = data = particle == Particles1_8.ICON_CRACK ? wrapper.read(Types.VAR_INT) : id / 4096;
                        ...
                        name = 6.jvmdowngrader$concat$lambda$register$1$1(particle.name, id, data);
                    }
                    wrapper.set(Types.STRING, 0, name);
                });
            }

            private static /* synthetic */ String jvmdowngrader$concat$lambda$register$1$1(String string, int n2, int n3) {
                return string + "_" + n2 + "_" + n3;
            }
        });
        ...
        ((Protocol1_8To1_7_6_10)this.protocol).registerClientbound(ClientboundPackets1_8.MAP_ITEM_DATA, wrapper -> {
            ...
            for (int i2 = 0; i2 < iconCount; ++i2) {
                ...
                icons[i2 * 4 + 1] = wrapper.read(Types.BYTE);
                icons[i2 * 4 + 2] = wrapper.read(Types.BYTE);
            ...
            if (columns > 0) {
                ...
                short x2 = wrapper.read(Types.UNSIGNED_BYTE);
                short z2 = wrapper.read(Types.UNSIGNED_BYTE);
