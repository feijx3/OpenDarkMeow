...
extends StoredObject {
    ...
    public static void updateBrewingStand(UserConnection user, Item blazePowder, short windowId) {
        ...
        TextComponent title = new StringComponent().append((TextComponent)new TranslationComponent("container.brewing", new Object[0])).append((TextComponent)new StringComponent(WindowTracker.jvmdowngrader$concat$updateBrewingStand$1(String.valueOf(TextFormatting.DARK_GRAY)))).append((TextComponent)new StringComponent(WindowTracker.jvmdowngrader$concat$updateBrewingStand$1(amount, String.valueOf(TextFormatting.DARK_RED)))).append((TextComponent)new TranslationComponent("item.blazePowder.name", TextFormatting.DARK_RED));
        ...
        for (int i2 = 0; i2 < items.length; ++i2) {
            ...
            setSlot.write(Types.SHORT, (short)i2);
            setSlot.write(Types.ITEM1_8, items[i2]);
            setSlot.scheduleSend(Protocol1_9To1_8.class);
        }
    }

    private static /* synthetic */ String jvmdowngrader$concat$updateBrewingStand$1(String string) {
        return ": " + string;
    }

    private static /* synthetic */ String jvmdowngrader$concat$updateBrewingStand$1(int n2, String string) {
        return n2 + " " + string;
    }
}
