...
public class EntityDataIndex1_8 {
    ...
    public static EntityDataIndex1_9 searchIndex(EntityType type, int index) {
        ...
        do {
            ...
            if (!(optMeta = EntityDataIndex1_8.getIndex(currentType, index)).isPresent()) continue;
            return optMeta.get();
    ...
    static {
        for (EntityDataIndex1_9 index : EntityDataIndex1_9.values()) {
            ENTITY_DATA_REWRITES.put(new Pair<EntityTypes1_9.EntityType, Integer>(index.getClazz(), index.getNewIndex()), index);
        }
    }
}
