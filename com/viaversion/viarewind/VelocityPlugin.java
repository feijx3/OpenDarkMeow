...
@Plugin(id="viarewind", name="ViaRewind", version="4.0.9-SNAPSHOT", authors={"FlorianMichael/EnZaXD", "Gerrygames", "creeper123123321"}, description="ViaVersion addon to allow 1.8.x and 1.7.x clients on newer server versions.", dependencies={@Dependency(id="viaversion"), @Dependency(id="viabackwards")}, url="https://viaversion.com/rewind")
