...
public class StatisticsRewriter<C extends ClientboundPacketType> {
    ...
    protected @Nullable IdRewriteFunction getRewriter(RegistryType type) {
        ...
        switch (type) {
            ...
            default: {
                throw new IllegalArgumentException(StatisticsRewriter.jvmdowngrader$concat$getRewriter$1(String.valueOf((Object)type)));
            }
        }
    ...
    private static String jvmdowngrader$concat$getRewriter$1(String string) {
        return "Unknown registry type in statistics packet: " + string;
    }
}
