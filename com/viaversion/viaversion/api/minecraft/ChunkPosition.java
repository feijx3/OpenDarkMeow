...
public final class ChunkPosition {
    ...
    public static long chunkKeyForBlock(int x2, int z2) {
        return ChunkPosition.chunkKey(x2 >> 4, z2 >> 4);
    }
    ...
    public String toString() {
        return ChunkPosition.jvmdowngrader$concat$toString$1(this.chunkX, this.chunkZ);
    }

    private static String jvmdowngrader$concat$toString$1(int n2, int n3) {
        return "ChunkPosition{chunkX=" + n2 + ", chunkZ=" + n3 + "}";
    }
}
