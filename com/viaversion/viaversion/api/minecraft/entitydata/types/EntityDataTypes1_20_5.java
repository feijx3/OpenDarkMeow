...
public final class EntityDataTypes1_20_5
extends AbstractEntityDataTypes {
    ...
    public final EntityDataType wolfVariantType = this.add(23, Types.VAR_INT);
    ...
    public final EntityDataType paintingVariantType = this.add(26, Types.VAR_INT);
    ...
    public EntityDataTypes1_20_5(VersionedTypesHolder types) {
        super(31);
