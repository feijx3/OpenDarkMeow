...
implements MappingData {
    ...
    public void load() {
        if (Via.getManager().isDebug()) {
            this.getLogger().info(MappingDataBase.jvmdowngrader$concat$load$1(this.unmappedVersion, this.mappedVersion));
        }
        CompoundTag data = this.readMappingsFile(MappingDataBase.jvmdowngrader$concat$load$2(this.unmappedVersion, this.mappedVersion));
        ...
        CompoundTag unmappedIdentifierData = this.readUnmappedIdentifiersFile(MappingDataBase.jvmdowngrader$concat$load$1(this.unmappedVersion));
        CompoundTag mappedIdentifierData = this.readMappedIdentifiersFile(MappingDataBase.jvmdowngrader$concat$load$1(this.mappedVersion));
    ...
    private static String jvmdowngrader$concat$load$1(String string, String string2) {
        return "Loading " + string + " -> " + string2 + " mappings...";
    }

    private static String jvmdowngrader$concat$load$2(String string, String string2) {
        return "mappings-" + string + "to" + string2 + ".nbt";
    }

    private static String jvmdowngrader$concat$load$1(String string) {
        return "identifiers-" + string + ".nbt";
    }
}
