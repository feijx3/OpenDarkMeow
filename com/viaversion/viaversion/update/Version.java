...
implements Comparable<Version> {
    ...
    public static int compare(Version verA, Version verB) {
        ...
        for (int i2 = 0; i2 < max; ++i2) {
            int partB;
            int partA = i2 < verA.parts.length ? verA.parts[i2] : 0;
            int n2 = partB = i2 < verB.parts.length ? verB.parts[i2] : 0;
            if (partA < partB) {
                return -1;
            }
    ...
    public String toString() {
        ...
        for (int i2 = 0; i2 < this.parts.length; ++i2) {
            split[i2] = String.valueOf(this.parts[i2]);
        }
        return Version.jvmdowngrader$concat$toString$1(Joiner.on((String)".").join(split), !this.tag.isEmpty() ? Version.jvmdowngrader$concat$toString$1(this.tag) : "");
    }
    ...
    public boolean equals(Object that) {
        Version version;
        return that instanceof Version && Version.equals(this, version = (Version)that);
    }
