...
@NestMembers(value={4.class, 3.class, 2.class, 1.class, 1.class})
...
extends AbstractProtocol<ClientboundPackets1_13, ClientboundPackets1_13, ServerboundPackets1_13, ServerboundPackets1_13> {
        ...
        this.registerServerbound(ServerboundPackets1_13.EDIT_BOOK, new PacketHandlers(){
            ...
            public void register() {
                ...
                this.handler(wrapper -> {
                    ...
                    Protocol1_13To1_13_1.this.jvmdowngrader$nest$com_viaversion_viaversion_protocols_v1_13to1_13_1_Protocol1_13To1_13_1$get$itemRewriter().handleItemToServer(wrapper.user(), item);
                });
                this.handler(wrapper -> {
    ...
    public ItemPacketRewriter1_13_1 jvmdowngrader$nest$com_viaversion_viaversion_protocols_v1_13to1_13_1_Protocol1_13To1_13_1$get$itemRewriter() {
        return this.itemRewriter;
    }

    public void jvmdowngrader$nest$com_viaversion_viaversion_protocols_v1_13to1_13_1_Protocol1_13To1_13_1$set$itemRewriter(ItemPacketRewriter1_13_1 itemPacketRewriter1_13_1) {
