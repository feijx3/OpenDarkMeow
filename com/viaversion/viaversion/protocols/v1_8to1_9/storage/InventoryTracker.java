...
implements StorableObject {
    ...
    private final Int2ObjectMap<Map<Short, Integer>> windowItemCache = new Int2ObjectOpenHashMap<Map<Short, Integer>>();
    ...
    public void setItemId(int windowId, short slot, int itemId) {
        if (windowId == -1 && slot == -1) {
            ...
            this.windowItemCache.computeIfAbsent(windowId, k2 -> new HashMap()).put(slot, itemId);
        }
    }
