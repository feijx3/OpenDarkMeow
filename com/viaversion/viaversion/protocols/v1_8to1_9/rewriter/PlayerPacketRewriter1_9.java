...
@NestMembers(value={20.class, 19.class, 18.class, 17.class, 16.class, 15.class, 14.class, 13.class, 12.class, 11.class, 10.class, 9.class, 8.class, 7.class, 6.class, 5.class, 4.class, 3.class, 2.class, 1.class})
                ...
                this.handler(wrapper -> {
                    ...
                    for (int i2 = 0; i2 < count; ++i2) {
                        ...
                        if (action == 0) {
                            ...
                            wrapper.passthrough(Types.VAR_INT);
                            displayName = wrapper.read(Types.OPTIONAL_STRING);
