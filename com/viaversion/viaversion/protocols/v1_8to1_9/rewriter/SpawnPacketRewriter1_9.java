        ...
        protocol.registerClientbound(ClientboundPackets1_8.ADD_ENTITY, new PacketHandlers(){
            ...
            public void register() {
                ...
                this.handler(wrapper -> {
                    ...
                    EntityTracker1_9 tracker = (EntityTracker1_9)wrapper.user().getEntityTracker(Protocol1_8To1_9.class);
                    EntityTypes1_9.EntityType entityType = EntityTypes1_9.ObjectType.getEntityType(typeID, data);
                    if (entityType != null) {
                ...
                this.handler(wrapper -> {
                    ...
                    if (EntityTypes1_8.ObjectType.findById(typeID, data) == EntityTypes1_8.ObjectType.POTION) {
                        PacketWrapper entityDataPacket = wrapper.create(ClientboundPackets1_9.SET_ENTITY_DATA, wrapper1 -> {
                            ...
                            EntityData potion = new EntityData(6, EntityDataTypes1_9.ITEM, item);
        ...
        protocol.registerClientbound(ClientboundPackets1_8.ADD_MOB, new PacketHandlers(){
            ...
            public void register() {
                ...
                this.handler(wrapper -> {
                    ...
                    EntityTracker1_9 tracker = (EntityTracker1_9)wrapper.user().getEntityTracker(Protocol1_8To1_9.class);
                    EntityTypes1_9.EntityType entityType = EntityTypes1_9.EntityType.findById(typeID);
                    if (entityType != null) {
                        tracker.addEntity(entityID, entityType);
                    }
                });
                ...
                this.handler(wrapper -> {
                    ...
                    if (tracker.hasEntity(entityId)) {
                        ...
                        protocol.getLogger().warning(5.jvmdowngrader$concat$lambda$register$2$1(entityId));
            ...
            private static String jvmdowngrader$concat$lambda$register$2$1(int n2) {
                return "Unable to find entity for entity data, entity ID: " + n2;
            }
        });
            ...
            public void register() {
                ...
                this.handler(wrapper -> {
                    ...
                    if (tracker.hasEntity(entityId)) {
                        ...
                        protocol.getLogger().warning(7.jvmdowngrader$concat$lambda$register$2$1(entityId));
                        entityDataList.clear();
                    }
                });
                this.handler(wrapper -> {
