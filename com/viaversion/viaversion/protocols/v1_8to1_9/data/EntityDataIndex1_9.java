...
public enum EntityDataIndex1_9 {
    ...
    public static EntityDataIndex1_9 searchIndex(EntityType type, int index) {
        ...
        do {
            ...
            if (!(optData = EntityDataIndex1_9.getIndex(currentType, index)).isPresent()) continue;
            return optData.get();
    ...
    static {
        ...
        for (EntityDataIndex1_9 index : EntityDataIndex1_9.values()) {
            entityDataRewriters.put(new Pair<EntityTypes1_9.EntityType, Integer>(index.clazz, index.index), index);
        }
    }
}
