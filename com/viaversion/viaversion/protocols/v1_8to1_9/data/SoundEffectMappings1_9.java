...
import com.viaversion.viaversion.protocols.v1_8to1_9.data.SoundCategories1_8;
...
public enum SoundEffectMappings1_9 {
    ...
    static {
        effects = new HashMap<String, SoundEffectMappings1_9>();
        for (SoundEffectMappings1_9 e2 : SoundEffectMappings1_9.values()) {
            effects.put(e2.getName(), e2);
        }
    }
}
