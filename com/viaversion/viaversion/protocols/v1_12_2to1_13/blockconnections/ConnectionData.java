...
@NestMembers(value={NeighbourUpdater.class, ConnectorInitAction.class})
public final class ConnectionData {
    ...
    public static BlockChangeRecord1_8[] jvmdowngrader$nest$com_viaversion_viaversion_protocols_v1_12_2to1_13_blockconnections_ConnectionData$get$EMPTY_RECORDS() {
        return EMPTY_RECORDS;
    }

    public static void jvmdowngrader$nest$com_viaversion_viaversion_protocols_v1_12_2to1_13_blockconnections_ConnectionData$set$EMPTY_RECORDS(BlockChangeRecord1_8[] blockChangeRecord1_8Array) {
        EMPTY_RECORDS = blockChangeRecord1_8Array;
    }

    @FunctionalInterface
    @NestHost(value=ConnectionData.class)
    ...
    public static final class NeighbourUpdater {
        ...
        public void updateChunkSectionNeighbours(int chunkX, int chunkZ, int chunkSectionY) {
            ...
            for (int chunkDeltaX = -1; chunkDeltaX <= 1; ++chunkDeltaX) {
                for (int chunkDeltaZ = -1; chunkDeltaZ <= 1; ++chunkDeltaZ) {
                    ...
                    wrapper.write(Types.BLOCK_CHANGE_ARRAY, (BlockChangeRecord[])updates.toArray(ConnectionData.jvmdowngrader$nest$com_viaversion_viaversion_protocols_v1_12_2to1_13_blockconnections_ConnectionData$get$EMPTY_RECORDS()));
        ...
        private void updateBlock(int x2, int y2, int z2, List<BlockChangeRecord1_8> records) {
            int blockState = this.userBlockData.getBlockData(x2, y2, z2);
            ...
            if (blockState != newBlockState || !blockConnectionProvider.storesBlocks(this.user, null)) {
                records.add(new BlockChangeRecord1_8(x2 & 0xF, y2, z2 & 0xF, newBlockState));
                ConnectionData.updateBlockStorage(this.user, x2, y2, z2, newBlockState);
            }
        }
    }
}
