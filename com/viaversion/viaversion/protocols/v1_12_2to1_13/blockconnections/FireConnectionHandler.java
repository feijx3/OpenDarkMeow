...
implements ConnectionHandler {
    ...
    private static void addWoodTypes(Set<String> set, String suffix) {
        for (String woodType : WOOD_TYPES) {
            set.add(Key.namespaced(FireConnectionHandler.jvmdowngrader$concat$addWoodTypes$1(woodType, suffix)));
        }
    }
    ...
    private static String jvmdowngrader$concat$addWoodTypes$1(String string, String string2) {
