...
public final class BlockData {
    ...
    public static int connectionTypeId(String blockConnection) {
        ...
        Preconditions.checkArgument((connectionTypeId != -1 ? 1 : 0) != 0, (Object)BlockData.jvmdowngrader$concat$connectionTypeId$1(blockConnection));
        return connectionTypeId;
    }

    private static String jvmdowngrader$concat$connectionTypeId$1(String string) {
        return "Unknown connection type: " + string;
    }
}
