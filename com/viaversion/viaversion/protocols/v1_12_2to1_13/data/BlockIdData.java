...
public class BlockIdData {
    ...
    public static void init() {
        ...
        try (InputStreamReader reader = new InputStreamReader(stream);){
            ...
            Protocol1_12_2To1_13.LOGGER.log(Level.SEVERE, "Failed to load block id mappings", e2);
        }
        ...
        try (InputStreamReader blockR = new InputStreamReader(blockS);){
            ...
            Protocol1_12_2To1_13.LOGGER.log(Level.SEVERE, "Failed to load block number to string mappings", e3);
        }
    }
}
