...
extends AbstractProtocol<ClientboundPackets1_18, ClientboundPackets1_19, ServerboundPackets1_17, ServerboundPackets1_19> {
    ...
    private final ParticleRewriter<ClientboundPackets1_18> particleRewriter = new ParticleRewriter<ClientboundPackets1_18>(this);
    private final ComponentRewriter1_19 componentRewriter = new ComponentRewriter1_19(this);
    private final TagRewriter<ClientboundPackets1_18> tagRewriter = new TagRewriter<ClientboundPackets1_18>(this);
    ...
    protected void registerPackets() {
        ...
        this.registerClientbound(ClientboundPackets1_18.SOUND, new PacketHandlers(){
            ...
            public void register() {
                ...
                this.map(Types.FLOAT);
                this.handler(wrapper -> wrapper.write(Types.LONG, Protocol1_18_2To1_19.this.jvmdowngrader$nest$com_viaversion_viaversion_protocols_v1_18_2to1_19_Protocol1_18_2To1_19$randomLong()));
        ...
        PacketHandler singleNullTextComponentMapper = wrapper -> wrapper.write(Types.COMPONENT, this.mapTextComponentIfNull(wrapper.user(), wrapper.read(Types.COMPONENT)));
        ...
        this.registerClientbound(ClientboundPackets1_18.SET_OBJECTIVE, wrapper -> {
            ...
            if (action == 0 || action == 2) {
                wrapper.write(Types.COMPONENT, this.mapTextComponentIfNull(wrapper.user(), wrapper.read(Types.COMPONENT)));
            }
        });
        ...
        this.componentRewriter.registerBossEvent(ClientboundPackets1_18.BOSS_EVENT);
        this.componentRewriter.registerComponentPacket(ClientboundPackets1_18.DISCONNECT);
        this.componentRewriter.registerTabList(ClientboundPackets1_18.TAB_LIST);
        this.componentRewriter.registerOpenScreen1_14(ClientboundPackets1_18.OPEN_SCREEN);
        this.componentRewriter.registerPlayerCombatKill(ClientboundPackets1_18.PLAYER_COMBAT_KILL);
        ...
        this.registerClientbound(ClientboundPackets1_18.COMMANDS, wrapper -> {
            ...
            for (int i2 = 0; i2 < size; ++i2) {
                ...
                if (argumentTypeId == -1) {
                    this.getLogger().warning(Protocol1_18_2To1_19.jvmdowngrader$concat$lambda$registerPackets$4$1(argumentType));
                }
        ...
        this.registerServerbound(ServerboundPackets1_19.CHAT_COMMAND, ServerboundPackets1_17.CHAT, (PacketHandler)new PacketHandlers(){
            ...
            public void register() {
                ...
                this.handler(wrapper -> {
                    ...
                    wrapper.set(Types.STRING, 0, 6.jvmdowngrader$concat$lambda$register$0$1(command));
    ...
    public long jvmdowngrader$nest$com_viaversion_viaversion_protocols_v1_18_2to1_19_Protocol1_18_2To1_19$randomLong() {
        return this.randomLong();
    }

    private static String jvmdowngrader$concat$lambda$registerPackets$4$1(String string) {
        return "Unknown command argument type: " + string;
    }
}
