...
extends EntityRewriter<ClientboundPackets1_14_4, Protocol1_14_4To1_15> {
    ...
    protected void registerPackets() {
        ...
        ((Protocol1_14_4To1_15)this.protocol).registerClientbound(ClientboundPackets1_14_4.ADD_MOB, new PacketHandlers(){
            ...
            public void register() {
                ...
                this.handler(wrapper -> EntityPacketRewriter1_15.this.jvmdowngrader$nest$com_viaversion_viaversion_protocols_v1_14_4to1_15_rewriter_EntityPacketRewriter1_15$sendEntityDataPacket(wrapper, wrapper.get(Types.VAR_INT, 0)));
            }
        });
        ((Protocol1_14_4To1_15)this.protocol).registerClientbound(ClientboundPackets1_14_4.ADD_PLAYER, new PacketHandlers(){
            ...
            public void register() {
                ...
                this.handler(wrapper -> {
                    ...
                    EntityPacketRewriter1_15.this.jvmdowngrader$nest$com_viaversion_viaversion_protocols_v1_14_4to1_15_rewriter_EntityPacketRewriter1_15$sendEntityDataPacket(wrapper, entityId);
                });
            }
        });
        ((Protocol1_14_4To1_15)this.protocol).registerClientbound(ClientboundPackets1_14_4.RESPAWN, new PacketHandlers(){
            ...
            public void register() {
                ...
                this.handler(wrapper -> {
                    int dimensionId;
                    Object clientWorld = wrapper.user().getClientWorld(Protocol1_14_4To1_15.class);
        ...
        ((Protocol1_14_4To1_15)this.protocol).registerClientbound(ClientboundPackets1_14_4.LOGIN, new PacketHandlers(){
            ...
            public void register() {
                ...
                this.handler(wrapper -> {
                    int dimension = wrapper.get(Types.INT, 1);
                    Object clientWorld = wrapper.user().getClientWorld(Protocol1_14_4To1_15.class);
    ...
    public void jvmdowngrader$nest$com_viaversion_viaversion_protocols_v1_14_4to1_15_rewriter_EntityPacketRewriter1_15$sendEntityDataPacket(PacketWrapper packetWrapper, int n2) {
        this.sendEntityDataPacket(packetWrapper, n2);
    }
}
