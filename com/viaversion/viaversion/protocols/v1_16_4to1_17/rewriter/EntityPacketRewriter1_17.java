...
extends EntityRewriter<ClientboundPackets1_16_2, Protocol1_16_4To1_17> {
    ...
    public void registerPackets() {
            ...
            public void register() {
                ...
                this.handler(wrapper -> {
                    ...
                    for (CompoundTag dimension : dimensions) {
                        ...
                        EntityPacketRewriter1_17.jvmdowngrader$nest$com_viaversion_viaversion_protocols_v1_16_4to1_17_rewriter_EntityPacketRewriter1_17$addNewDimensionData(dimensionCompound);
                    }
                    CompoundTag currentDimensionTag = wrapper.get(Types.NAMED_COMPOUND_TAG, 1);
                    EntityPacketRewriter1_17.jvmdowngrader$nest$com_viaversion_viaversion_protocols_v1_16_4to1_17_rewriter_EntityPacketRewriter1_17$addNewDimensionData(currentDimensionTag);
                });
                this.handler(wrapper -> {
                    String world = wrapper.passthrough(Types.STRING);
                    EntityPacketRewriter1_17.this.tracker(wrapper.user()).setCurrentWorld(world);
                });
        ...
        ((Protocol1_16_4To1_17)this.protocol).registerClientbound(ClientboundPackets1_16_2.PLAYER_COMBAT, null, wrapper -> {
            ...
            switch (type) {
                ...
                default: {
                    throw new IllegalArgumentException(EntityPacketRewriter1_17.jvmdowngrader$concat$lambda$registerPackets$3$1(type));
                }
            }
            ...
            if (type == 2) {
                ...
                ((Protocol1_16_4To1_17)this.protocol).getComponentRewriter().processText(wrapper.user(), wrapper.passthrough(Types.COMPONENT));
            }
    ...
    public static void jvmdowngrader$nest$com_viaversion_viaversion_protocols_v1_16_4to1_17_rewriter_EntityPacketRewriter1_17$addNewDimensionData(CompoundTag compoundTag) {
    ...
    private static String jvmdowngrader$concat$lambda$registerPackets$3$1(int n2) {
        return "Invalid combat type received: " + n2;
    }
}
