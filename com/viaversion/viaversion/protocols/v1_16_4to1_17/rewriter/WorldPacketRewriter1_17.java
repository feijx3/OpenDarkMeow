...
public final class WorldPacketRewriter1_17 {
    public static void register(Protocol1_16_4To1_17 protocol) {
        ...
        protocol.registerClientbound(ClientboundPackets1_16_2.SET_BORDER, null, wrapper -> {
            ...
            switch (type) {
                ...
                default: {
                    throw new IllegalArgumentException(WorldPacketRewriter1_17.jvmdowngrader$concat$lambda$register$0$1(type));
                }
            }
            ...
            for (int x2 = 0; x2 < 16; ++x2) {
                for (int y2 = 0; y2 < 16; ++y2) {
                    for (int z2 = 0; z2 < 16; ++z2) {
                        int blockStateId = Protocol1_16_4To1_17.MAPPINGS.getNewBlockStateId(palette.idAt(x2, y2, z2));
    ...
    private static String jvmdowngrader$concat$lambda$register$0$1(int n2) {
        return "Invalid world border type received: " + n2;
    }
}
