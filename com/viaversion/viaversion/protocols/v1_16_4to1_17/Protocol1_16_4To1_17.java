...
extends AbstractProtocol<ClientboundPackets1_16_2, ClientboundPackets1_17, ServerboundPackets1_16_2, ServerboundPackets1_17> {
    ...
    private final ParticleRewriter<ClientboundPackets1_16_2> particleRewriter = new ParticleRewriter<ClientboundPackets1_16_2>(this);
    ...
    protected void registerPackets() {
        ...
        this.componentRewriter.registerComponentPacket(ClientboundPackets1_16_2.CHAT);
        this.componentRewriter.registerBossEvent(ClientboundPackets1_16_2.BOSS_EVENT);
        this.componentRewriter.registerComponentPacket(ClientboundPackets1_16_2.DISCONNECT);
        this.componentRewriter.registerTabList(ClientboundPackets1_16_2.TAB_LIST);
        this.componentRewriter.registerOpenScreen1_14(ClientboundPackets1_16_2.OPEN_SCREEN);
        ...
        this.registerClientbound(ClientboundPackets1_16_2.SET_TITLES, null, (PacketWrapper wrapper) -> {
            ...
            switch (type) {
                ...
                default: {
                    throw new IllegalArgumentException(Protocol1_16_4To1_17.jvmdowngrader$concat$lambda$registerPackets$3$1(type));
                }
            }
            if (type < 3) {
    ...
    private static String jvmdowngrader$concat$lambda$registerPackets$3$1(int n2) {
        return "Invalid title type received: " + n2;
    }
}
