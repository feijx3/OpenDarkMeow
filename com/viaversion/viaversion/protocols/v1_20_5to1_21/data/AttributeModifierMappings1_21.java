...
public final class AttributeModifierMappings1_21 {
    ...
    private static final BiMap<String, String> ATTRIBUTE_MODIFIER_NAMES = HashBiMap.create(AttributeModifierMappings1_21.jvmdg$inlined$of("Random spawn bonus", "random_spawn_bonus", "Random zombie-spawn bonus", "zombie_random_spawn_bonus", "Leader zombie bonus", "leader_zombie_bonus", "Zombie reinforcement callee charge", "reinforcement_callee_charge", "Zombie reinforcement caller charge", "reinforcement_caller_charge"));
    ...
    public static @Nullable String idToName(String id) {
        return (String)ATTRIBUTE_MODIFIER_NAMES.inverse().get((Object)Key.stripMinecraftNamespace(id));
    }
    ...
    private static <K, V> Map<K, V> jvmdg$inlined$of(K k1, V v1, K k2, V v2, K k3, V v3, K k4, V v4, K k5, V v5) {
