...
public final class BlockEntityMappings1_18 {
    ...
    public static int newId(int id) {
        ...
        if (id < 0 || id > IDS.length || (newId = IDS[id]) == -1) {
            Protocol1_17_1To1_18.LOGGER.warning(BlockEntityMappings1_18.jvmdowngrader$concat$newId$1(id));
            return -1;
        }
        return newId;
    }
    ...
    private static String jvmdowngrader$concat$newId$1(int n2) {
        return "Received out of bounds block entity id: " + n2;
    }
}
