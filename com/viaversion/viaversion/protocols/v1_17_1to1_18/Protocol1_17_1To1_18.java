...
extends AbstractProtocol<ClientboundPackets1_17_1, ClientboundPackets1_18, ServerboundPackets1_17, ServerboundPackets1_17> {
    ...
    private final ParticleRewriter<ClientboundPackets1_17_1> particleRewriter = new ParticleRewriter<ClientboundPackets1_17_1>(this);
    private final ComponentRewriter1_18 componentRewriter = new ComponentRewriter1_18(this);
    private final TagRewriter<ClientboundPackets1_17_1> tagRewriter = new TagRewriter<ClientboundPackets1_17_1>(this);
    ...
    protected void registerPackets() {
        ...
        this.componentRewriter.registerComponentPacket(ClientboundPackets1_17_1.CHAT);
        this.componentRewriter.registerComponentPacket(ClientboundPackets1_17_1.SET_ACTION_BAR_TEXT);
        this.componentRewriter.registerComponentPacket(ClientboundPackets1_17_1.SET_TITLE_TEXT);
        this.componentRewriter.registerComponentPacket(ClientboundPackets1_17_1.SET_SUBTITLE_TEXT);
        this.componentRewriter.registerBossEvent(ClientboundPackets1_17_1.BOSS_EVENT);
        this.componentRewriter.registerComponentPacket(ClientboundPackets1_17_1.DISCONNECT);
        this.componentRewriter.registerTabList(ClientboundPackets1_17_1.TAB_LIST);
        this.componentRewriter.registerOpenScreen1_14(ClientboundPackets1_17_1.OPEN_SCREEN);
        this.componentRewriter.registerPlayerCombatKill(ClientboundPackets1_17_1.PLAYER_COMBAT_KILL);
