    ...
    private static void handleBlockEntity(Protocol1_15_2To1_16 protocol, UserConnection connection, CompoundTag compoundTag) {
        ...
        if (id.equals("minecraft:conduit")) {
            ...
            for (int i2 = 1; i2 <= 4; ++i2) {
                StringTag line = compoundTag.getStringTag(WorldPacketRewriter1_16.jvmdowngrader$concat$handleBlockEntity$1(i2));
                if (line == null) continue;
                JsonElement text = protocol.getComponentRewriter().processText(connection, line.getValue());
                compoundTag.putString(WorldPacketRewriter1_16.jvmdowngrader$concat$handleBlockEntity$1(i2), text.toString());
            }
