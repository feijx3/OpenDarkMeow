...
public class AchievementTranslations1_12 {
    ...
    static {
        ...
        AchievementTranslations1_12.add("commands.achievement.usage", "/achievement <give|take> <name|*> [player]");
        AchievementTranslations1_12.add("commands.achievement.give.success.all", "Successfully given all achievements to %s");
        AchievementTranslations1_12.add("commands.achievement.take.success.all", "Successfully taken all achievements from %s");
        AchievementTranslations1_12.add("commands.achievement.unknownAchievement", "Unknown achievement '%s'");
        AchievementTranslations1_12.add("commands.achievement.take.success.one", "Successfully taken the achievement %s from %s");
        AchievementTranslations1_12.add("commands.achievement.dontHave", "Player %s doesn't have achievement %s");
        AchievementTranslations1_12.add("commands.achievement.alreadyHave", "Player %s already has achievement %s");
        AchievementTranslations1_12.add("commands.achievement.give.success.one", "Successfully given %s the achievement %s");
    }
}
