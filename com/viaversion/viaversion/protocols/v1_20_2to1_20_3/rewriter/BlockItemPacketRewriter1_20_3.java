    ...
    public void registerPackets() {
        ...
        ((Protocol1_20_2To1_20_3)this.protocol).registerClientbound(ClientboundPackets1_20_2.LEVEL_PARTICLES, new PacketHandlers(){
            ...
            public void register() {
                ...
                this.handler(((ParticleRewriter)((Protocol1_20_2To1_20_3)BlockItemPacketRewriter1_20_3.this.protocol).getParticleRewriter()).levelParticlesHandler1_13(Types.VAR_INT));
            }
        });
    ...
    private void updatePageTag(StringTag pageTag) {
        block2: {
            try {
                ...
                if (Via.getConfig().isSuppressTextComponentConversionWarnings()) break block2;
                ((Protocol1_20_2To1_20_3)this.protocol).getLogger().log(Level.SEVERE, BlockItemPacketRewriter1_20_3.jvmdowngrader$concat$updatePageTag$1(StringUtil.forLogging(pageTag.getValue())), e2);
            }
        }
    }

    private static String jvmdowngrader$concat$updatePageTag$1(String string) {
        return "Error during book conversion: " + string;
    }
}
