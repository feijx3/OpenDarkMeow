...
extends EntityRewriter<ClientboundPacket1_20_2, Protocol1_20_2To1_20_3> {
    ...
    public void registerPackets() {
        ...
        ((Protocol1_20_2To1_20_3)this.protocol).registerClientbound(ClientboundPackets1_20_2.LOGIN, new PacketHandlers(){
            ...
            public void register() {
                ...
                this.handler(wrapper -> EntityPacketRewriter1_20_3.this.jvmdowngrader$nest$com_viaversion_viaversion_protocols_v1_20_2to1_20_3_rewriter_EntityPacketRewriter1_20_3$sendChunksSentGameEvent(wrapper));
            }
        });
    ...
    public void jvmdowngrader$nest$com_viaversion_viaversion_protocols_v1_20_2to1_20_3_rewriter_EntityPacketRewriter1_20_3$sendChunksSentGameEvent(PacketWrapper packetWrapper) {
        this.sendChunksSentGameEvent(packetWrapper);
    }
}
