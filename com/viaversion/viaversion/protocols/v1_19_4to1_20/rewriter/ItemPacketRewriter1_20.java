...
extends ItemRewriter<ClientboundPackets1_19_4, ServerboundPackets1_19_4, Protocol1_19_4To1_20> {
    ...
    public void registerPackets() {
        ...
        ((Protocol1_19_4To1_20)this.protocol).registerClientbound(ClientboundPackets1_19_4.LEVEL_CHUNK_WITH_LIGHT, new PacketHandlers(){
            ...
            protected void register() {
                this.handler(blockRewriter.chunkHandler1_19(ChunkType1_18::new, (user, blockEntity) -> ItemPacketRewriter1_20.this.jvmdowngrader$nest$com_viaversion_viaversion_protocols_v1_19_4to1_20_rewriter_ItemPacketRewriter1_20$handleBlockEntity((BlockEntity)blockEntity)));
    ...
    private void handleBlockEntity(BlockEntity blockEntity) {
        ...
        for (int i2 = 1; i2 < 5; ++i2) {
            Tag text = tag.remove(ItemPacketRewriter1_20.jvmdowngrader$concat$handleBlockEntity$1(i2));
        ...
        for (int i3 = 1; i3 < 5; ++i3) {
            Tag text = tag.remove(ItemPacketRewriter1_20.jvmdowngrader$concat$handleBlockEntity$2(i3));
            filteredMessages.add(text instanceof StringTag ? (StringTag)text : messages.get(i3 - 1));
        }
    ...
    public void jvmdowngrader$nest$com_viaversion_viaversion_protocols_v1_19_4to1_20_rewriter_ItemPacketRewriter1_20$handleBlockEntity(BlockEntity blockEntity) {
        this.handleBlockEntity(blockEntity);
    }

    private static String jvmdowngrader$concat$handleBlockEntity$1(int n2) {
        return "Text" + n2;
    }

    private static String jvmdowngrader$concat$handleBlockEntity$2(int n2) {
        return "FilteredText" + n2;
    }
}
