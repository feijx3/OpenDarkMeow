...
extends AbstractProtocol<ClientboundPacket1_21_5, ClientboundPacket1_21_6, ServerboundPacket1_21_5, ServerboundPacket1_21_6> {
    ...
    private final ParticleRewriter<ClientboundPacket1_21_5> particleRewriter = new ParticleRewriter<ClientboundPacket1_21_5>(this);
    ...
    protected void registerPackets() {
        ...
        this.componentRewriter.registerOpenScreen1_14(ClientboundPackets1_21_5.OPEN_SCREEN);
        this.componentRewriter.registerComponentPacket(ClientboundPackets1_21_5.SET_ACTION_BAR_TEXT);
        this.componentRewriter.registerComponentPacket(ClientboundPackets1_21_5.SET_TITLE_TEXT);
        this.componentRewriter.registerComponentPacket(ClientboundPackets1_21_5.SET_SUBTITLE_TEXT);
        this.componentRewriter.registerBossEvent(ClientboundPackets1_21_5.BOSS_EVENT);
        this.componentRewriter.registerComponentPacket(ClientboundPackets1_21_5.DISCONNECT);
        this.componentRewriter.registerTabList(ClientboundPackets1_21_5.TAB_LIST);
        this.componentRewriter.registerPlayerCombatKill1_20(ClientboundPackets1_21_5.PLAYER_COMBAT_KILL);
        this.componentRewriter.registerPlayerInfoUpdate1_21_4(ClientboundPackets1_21_5.PLAYER_INFO_UPDATE);
        this.componentRewriter.registerComponentPacket(ClientboundPackets1_21_5.SYSTEM_CHAT);
        this.componentRewriter.registerDisguisedChat(ClientboundPackets1_21_5.DISGUISED_CHAT);
        this.componentRewriter.registerPlayerChat1_21_5(ClientboundPackets1_21_5.PLAYER_CHAT);
        ...
        new AttributeRewriter<ClientboundPacket1_21_5>(this).register1_21(ClientboundPackets1_21_5.UPDATE_ATTRIBUTES);
        new CommandRewriter1_19_4<ClientboundPacket1_21_5>(this).registerDeclareCommands1_19(ClientboundPackets1_21_5.COMMANDS);
        this.registerClientbound(ClientboundPackets1_21_5.CHANGE_DIFFICULTY, wrapper -> {
            short difficulty = wrapper.read(Types.UNSIGNED_BYTE);
            wrapper.write(Types.VAR_INT, Integer.valueOf(difficulty));
        });
        this.registerServerbound(ServerboundPackets1_21_6.CHANGE_DIFFICULTY, wrapper -> {
            int difficulty = wrapper.read(Types.VAR_INT);
            wrapper.write(Types.UNSIGNED_BYTE, (short)difficulty);
        });
        this.registerServerbound(ServerboundPackets1_21_6.CHANGE_GAME_MODE, ServerboundPackets1_21_5.CHAT_COMMAND, (PacketWrapper wrapper) -> {
            int gameMode = wrapper.read(Types.VAR_INT);
            GameMode mode = GameMode.getById(gameMode);
            wrapper.write(Types.STRING, Protocol1_21_5To1_21_6.jvmdowngrader$concat$lambda$registerPackets$2$1(mode.name().toLowerCase(Locale.ROOT)));
        });
    ...
    public void init(UserConnection connection) {
        ...
        this.addItemHasher(connection, new ItemHasherBase(this, connection, SerializerVersion.V1_21_5, SerializerVersion.V1_21_6));
    ...
    protected PacketTypesProvider<ClientboundPacket1_21_5, ClientboundPacket1_21_6, ServerboundPacket1_21_5, ServerboundPacket1_21_6> createPacketTypesProvider() {
        return new SimplePacketTypesProvider<ClientboundPacket1_21_5, ClientboundPacket1_21_6, ServerboundPacket1_21_5, ServerboundPacket1_21_6>(ProtocolUtil.packetTypeMap(this.unmappedClientboundPacketType, ClientboundPackets1_21_5.class, ClientboundConfigurationPackets1_21.class), ProtocolUtil.packetTypeMap(this.mappedClientboundPacketType, ClientboundPackets1_21_6.class, ClientboundConfigurationPackets1_21_6.class), ProtocolUtil.packetTypeMap(this.mappedServerboundPacketType, ServerboundPackets1_21_5.class, ServerboundConfigurationPackets1_20_5.class), ProtocolUtil.packetTypeMap(this.unmappedServerboundPacketType, ServerboundPackets1_21_6.class, ServerboundConfigurationPackets1_21_6.class));
    }
