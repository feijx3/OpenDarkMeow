...
Cloneable {
        ...
        public ObjectIterator<Object2IntMap.Entry<K>> iterator() {
            return new ObjectIterator<Object2IntMap.Entry<K>>(){
                ...
                public int skip(int n2) {
                    ...
                    n2 = Math.min(n2, Object2IntArrayMap.this.size - this.next);
                    this.next += n2;
                    if (n2 != 0) {
    ...
    ObjectIntPair<K> {
        ...
        public int setValue(int v2) {
            ...
            Object2IntArrayMap.this.value[this.index] = v2;
            return oldValue;
        }
        ...
        public boolean equals(Object o2) {
            ...
            Map.Entry e2 = (Map.Entry)o2;
            return Objects.equals(Object2IntArrayMap.this.key[this.index], e2.getKey()) && Object2IntArrayMap.this.value[this.index] == (Integer)e2.getValue();
        }
