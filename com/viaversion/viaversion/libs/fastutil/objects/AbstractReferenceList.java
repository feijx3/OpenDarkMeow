...
Stack<K> {
    ...
    public ObjectListIterator<K> listIterator(int index) {
        ...
        return new ObjectIterators.AbstractIndexBasedListIterator<K>(0, index){
            ...
            protected final K get(int i2) {
                return AbstractReferenceList.this.get(i2);
            }

            @Override
            protected final void add(int i2, K k2) {
                AbstractReferenceList.this.add(i2, k2);
            }

            @Override
            protected final void set(int i2, K k2) {
                AbstractReferenceList.this.set(i2, k2);
            }
    ...
    public int hashCode() {
        ...
        while (s2-- != 0) {
            Object k2 = i2.next();
            h2 = 31 * h2 + System.identityHashCode(k2);
        }
        return h2;
    }
    ...
    implements RandomAccess {
        ...
        public ReferenceRandomAccessSubList(ReferenceList<K> l2, int from, int to) {
            super(l2, from, to);
        }
    ...
    implements Serializable {
        ...
        public ReferenceSubList(ReferenceList<K> l2, int from, int to) {
            this.l = l2;
            this.from = from;
            this.to = to;
        }
        ...
        extends ObjectIterators.AbstractIndexBasedListIterator<K> {
            ...
            @Override
            protected final K get(int i2) {
                return ReferenceSubList.this.l.get(ReferenceSubList.this.from + i2);
            }

            @Override
            protected final void add(int i2, K k2) {
                ReferenceSubList.this.add(i2, k2);
            }

            @Override
            protected final void set(int i2, K k2) {
                ReferenceSubList.this.set(i2, k2);
            }

            @Override
            protected final void remove(int i2) {
                ReferenceSubList.this.remove(i2);
            }
    ...
    extends ObjectSpliterators.LateBindingSizeIndexBasedSpliterator<K> {
        ...
        IndexBasedSpliterator(ReferenceList<K> l2, int pos) {
            super(pos);
            this.l = l2;
        }

        IndexBasedSpliterator(ReferenceList<K> l2, int pos, int maxPos) {
            super(pos, maxPos);
            this.l = l2;
        }
