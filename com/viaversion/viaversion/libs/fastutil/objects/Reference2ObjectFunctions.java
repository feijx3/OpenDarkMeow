 ...
 *  com.viaversion.viaversion.libs.fastutil.objects.Reference2ObjectFunctions$SynchronizedFunction
 *  com.viaversion.viaversion.libs.fastutil.objects.Reference2ObjectFunctions$UnmodifiableFunction
 */
...
public final class Reference2ObjectFunctions {
    ...
    public static <K, V> Reference2ObjectFunction<K, V> synchronize(Reference2ObjectFunction<K, V> f2) {
        return new SynchronizedFunction(f2);
    }

    public static <K, V> Reference2ObjectFunction<K, V> synchronize(Reference2ObjectFunction<K, V> f2, Object sync) {
        return new SynchronizedFunction(f2, sync);
    }

    public static <K, V> Reference2ObjectFunction<K, V> unmodifiable(Reference2ObjectFunction<? extends K, ? extends V> f2) {
    ...
    Cloneable {
        ...
        public V get(Object k2) {
            return (V)(this.key == k2 ? this.value : this.defRetValue);
        }
