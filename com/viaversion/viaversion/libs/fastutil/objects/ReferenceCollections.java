 ...
 *  com.viaversion.viaversion.libs.fastutil.objects.ReferenceCollections$SynchronizedCollection
 *  com.viaversion.viaversion.libs.fastutil.objects.ReferenceCollections$UnmodifiableCollection
 */
...
public final class ReferenceCollections {
    ...
    public static <K> ReferenceCollection<K> synchronize(ReferenceCollection<K> c2) {
        return new SynchronizedCollection(c2);
    }

    public static <K> ReferenceCollection<K> synchronize(ReferenceCollection<K> c2, Object sync) {
        return new SynchronizedCollection(c2, sync);
    }

    public static <K> ReferenceCollection<K> unmodifiable(ReferenceCollection<? extends K> c2) {
