...
implements Object2IntSortedMap<K> {
    ...
    extends AbstractObjectSortedSet<K> {
        ...
        public boolean contains(Object k2) {
            return AbstractObject2IntSortedMap.this.containsKey(k2);
        }
    ...
    extends AbstractIntCollection {
        ...
        public boolean contains(int k2) {
            return AbstractObject2IntSortedMap.this.containsValue(k2);
        }
    ...
    implements IntIterator {
        ...
        public ValuesIterator(ObjectBidirectionalIterator<Object2IntMap.Entry<K>> i2) {
            this.i = i2;
        }
    ...
    implements ObjectBidirectionalIterator<K> {
        ...
        public KeySetIterator(ObjectBidirectionalIterator<Object2IntMap.Entry<K>> i2) {
            this.i = i2;
        }
