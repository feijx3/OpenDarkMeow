...
public final class ObjectCollections {
    ...
    public static <K> ObjectCollection<K> synchronize(ObjectCollection<K> c2) {
        return new SynchronizedCollection(c2);
    }

    public static <K> ObjectCollection<K> synchronize(ObjectCollection<K> c2, Object sync) {
        return new SynchronizedCollection(c2, sync);
    }

    public static <K> ObjectCollection<K> unmodifiable(ObjectCollection<? extends K> c2) {
