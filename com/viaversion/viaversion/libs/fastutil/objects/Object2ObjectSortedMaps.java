...
public final class Object2ObjectSortedMaps {
    ...
    public static <K> Comparator<? super Map.Entry<K, ?>> entryComparator(Comparator<? super K> comparator) {
        return (x2, y2) -> comparator.compare((Object)x2.getKey(), (Object)y2.getKey());
    }
    ...
    public static <K, V> Object2ObjectSortedMap<K, V> synchronize(Object2ObjectSortedMap<K, V> m2) {
        return new SynchronizedSortedMap(m2);
    }

    public static <K, V> Object2ObjectSortedMap<K, V> synchronize(Object2ObjectSortedMap<K, V> m2, Object sync) {
        return new SynchronizedSortedMap(m2, sync);
    }

    public static <K, V> Object2ObjectSortedMap<K, V> unmodifiable(Object2ObjectSortedMap<K, ? extends V> m2) {
