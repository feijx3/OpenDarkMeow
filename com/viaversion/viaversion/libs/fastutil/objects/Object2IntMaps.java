...
public final class Object2IntMaps {
    ...
    public static <K> Object2IntMap<K> synchronize(Object2IntMap<K> m2) {
        return new SynchronizedMap(m2);
    }

    public static <K> Object2IntMap<K> synchronize(Object2IntMap<K> m2, Object sync) {
        return new SynchronizedMap(m2, sync);
    }

    public static <K> Object2IntMap<K> unmodifiable(Object2IntMap<? extends K> m2) {
