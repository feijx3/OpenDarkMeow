 ...
 *  com.viaversion.viaversion.libs.fastutil.objects.ReferenceSets$SynchronizedSet
 *  com.viaversion.viaversion.libs.fastutil.objects.ReferenceSets$UnmodifiableSet
 */
...
public final class ReferenceSets {
    ...
    public static <K> ReferenceSet<K> synchronize(ReferenceSet<K> s2) {
        return new SynchronizedSet(s2);
    }

    public static <K> ReferenceSet<K> synchronize(ReferenceSet<K> s2, Object sync) {
        return new SynchronizedSet(s2, sync);
    }

    public static <K> ReferenceSet<K> unmodifiable(ReferenceSet<? extends K> s2) {
