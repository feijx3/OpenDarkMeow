...
implements Reference2ObjectSortedMap<K, V> {
    ...
    extends AbstractReferenceSortedSet<K> {
        ...
        public boolean contains(Object k2) {
            return AbstractReference2ObjectSortedMap.this.containsKey(k2);
        }
    ...
    extends AbstractObjectCollection<V> {
        ...
        @Override
        public boolean contains(Object k2) {
            return AbstractReference2ObjectSortedMap.this.containsValue(k2);
        }
    ...
    implements ObjectIterator<V> {
        ...
        public ValuesIterator(ObjectBidirectionalIterator<Reference2ObjectMap.Entry<K, V>> i2) {
            this.i = i2;
        }
    ...
    implements ObjectBidirectionalIterator<K> {
        ...
        public KeySetIterator(ObjectBidirectionalIterator<Reference2ObjectMap.Entry<K, V>> i2) {
            this.i = i2;
        }
