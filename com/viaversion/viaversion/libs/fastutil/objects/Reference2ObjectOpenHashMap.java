...
Hash {
    ...
    public Reference2ObjectOpenHashMap(int expected, float f2) {
        if (f2 <= 0.0f || f2 >= 1.0f) {
    ...
    public Reference2ObjectOpenHashMap(Map<? extends K, ? extends V> m2, float f2) {
        this(m2.size(), f2);
        this.putAll(m2);
    }

    public Reference2ObjectOpenHashMap(Map<? extends K, ? extends V> m2) {
        this(m2, 0.75f);
    }

    public Reference2ObjectOpenHashMap(Reference2ObjectMap<K, V> m2, float f2) {
        this(m2.size(), f2);
        this.putAll(m2);
    }

    public Reference2ObjectOpenHashMap(Reference2ObjectMap<K, V> m2) {
        this(m2, 0.75f);
    }

    public Reference2ObjectOpenHashMap(K[] k2, V[] v2, float f2) {
        this(k2.length, f2);
    ...
    public Reference2ObjectOpenHashMap(K[] k2, V[] v2) {
        this(k2, v2, 0.75f);
    }
        ...
        if (this.values == null) {
            this.values = new AbstractObjectCollection<V>(){
                ...
                public boolean contains(Object v2) {
                    return Reference2ObjectOpenHashMap.this.containsValue(v2);
                }
    ...
    public Reference2ObjectOpenHashMap<K, V> clone() {
        Reference2ObjectOpenHashMap c2;
        try {
            c2 = (Reference2ObjectOpenHashMap)super.clone();
        }
    ...
    implements Reference2ObjectMap.FastEntrySet<K, V> {
        ...
        public boolean contains(Object o2) {
            ...
            if (k2 == null) {
                return Reference2ObjectOpenHashMap.this.containsNullKey && Objects.equals(Reference2ObjectOpenHashMap.this.value[Reference2ObjectOpenHashMap.this.n], v2);
            }
            K[] key = Reference2ObjectOpenHashMap.this.key;
            int pos = HashCommon.mix(System.identityHashCode(k2)) & Reference2ObjectOpenHashMap.this.mask;
            Object curr = key[pos];
            if (curr == null) {
                return false;
            }
            if (k2 == curr) {
                return Objects.equals(Reference2ObjectOpenHashMap.this.value[pos], v2);
            }
            do {
        ...
        public boolean remove(Object o2) {
            ...
            Object v2 = e2.getValue();
            if (k2 == null) {
                if (Reference2ObjectOpenHashMap.this.containsNullKey && Objects.equals(Reference2ObjectOpenHashMap.this.value[Reference2ObjectOpenHashMap.this.n], v2)) {
            ...
            if (curr == k2) {
                if (Objects.equals(Reference2ObjectOpenHashMap.this.value[pos], v2)) {
            ...
            do {
                if ((curr = key[pos = pos + 1 & Reference2ObjectOpenHashMap.this.mask]) != null) continue;
                return false;
            } while (curr != k2 || !Objects.equals(Reference2ObjectOpenHashMap.this.value[pos], v2));
            Reference2ObjectOpenHashMap.this.removeEntry(pos);
            return true;
        }
    ...
    extends AbstractReferenceSet<K> {
        ...
        public boolean contains(Object k2) {
            return Reference2ObjectOpenHashMap.this.containsKey(k2);
        }

        @Override
        public boolean remove(Object k2) {
            int oldSize = Reference2ObjectOpenHashMap.this.size;
            Reference2ObjectOpenHashMap.this.remove(k2);
    ...
    private abstract class MapIterator<ConsumerType> {
        ...
        public int nextEntry() {
            ...
            do {
                ...
                int p2 = HashCommon.mix(System.identityHashCode(k2)) & Reference2ObjectOpenHashMap.this.mask;
                while (k2 != key[p2]) {
                    p2 = p2 + 1 & Reference2ObjectOpenHashMap.this.mask;
                }
                return p2;
    ...
    ReferenceObjectPair<K, V> {
        ...
        public V setValue(V v2) {
            ...
            Reference2ObjectOpenHashMap.this.value[this.index] = v2;
            return oldValue;
        }
        ...
        public boolean equals(Object o2) {
            ...
            Map.Entry e2 = (Map.Entry)o2;
            return Reference2ObjectOpenHashMap.this.key[this.index] == e2.getKey() && Objects.equals(Reference2ObjectOpenHashMap.this.value[this.index], e2.getValue());
        }
