...
implements Object2ObjectSortedMap<K, V> {
    ...
    extends AbstractObjectSortedSet<K> {
        ...
        public boolean contains(Object k2) {
            return AbstractObject2ObjectSortedMap.this.containsKey(k2);
        }
    ...
    extends AbstractObjectCollection<V> {
        ...
        @Override
        public boolean contains(Object k2) {
            return AbstractObject2ObjectSortedMap.this.containsValue(k2);
        }
    ...
    implements ObjectIterator<V> {
        ...
        public ValuesIterator(ObjectBidirectionalIterator<Object2ObjectMap.Entry<K, V>> i2) {
            this.i = i2;
        }
    ...
    implements ObjectBidirectionalIterator<K> {
        ...
        public KeySetIterator(ObjectBidirectionalIterator<Object2ObjectMap.Entry<K, V>> i2) {
            this.i = i2;
        }
