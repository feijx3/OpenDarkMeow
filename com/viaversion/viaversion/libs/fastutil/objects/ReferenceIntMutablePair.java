...
import com.viaversion.viaversion.libs.fastutil.objects.ReferenceIntPair;
...
Serializable {
    ...
    public ReferenceIntMutablePair<K> left(K l2) {
        this.left = l2;
        return this;
    }
    ...
    @Override
    public ReferenceIntMutablePair<K> right(int r2) {
        this.right = r2;
        return this;
    }
