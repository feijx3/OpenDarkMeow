...
Cloneable {
        ...
        public ObjectIterator<Object2ObjectMap.Entry<K, V>> iterator() {
            return new ObjectIterator<Object2ObjectMap.Entry<K, V>>(){
                ...
                public int skip(int n2) {
                    ...
                    n2 = Math.min(n2, Object2ObjectArrayMap.this.size - this.next);
                    this.next += n2;
                    if (n2 != 0) {
    ...
    Pair<K, V> {
        ...
        public V setValue(V v2) {
            ...
            Object2ObjectArrayMap.this.value[this.index] = v2;
            return oldValue;
        }
        ...
        public boolean equals(Object o2) {
            ...
            Map.Entry e2 = (Map.Entry)o2;
            return Objects.equals(Object2ObjectArrayMap.this.key[this.index], e2.getKey()) && Objects.equals(Object2ObjectArrayMap.this.value[this.index], e2.getValue());
        }
