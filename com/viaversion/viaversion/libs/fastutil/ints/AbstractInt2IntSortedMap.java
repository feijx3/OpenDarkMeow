...
implements Int2IntSortedMap {
    ...
    extends AbstractIntSortedSet {
        ...
        public boolean contains(int k2) {
            return AbstractInt2IntSortedMap.this.containsKey(k2);
        }
    ...
    extends AbstractIntCollection {
        ...
        @Override
        public boolean contains(int k2) {
            return AbstractInt2IntSortedMap.this.containsValue(k2);
        }
    ...
    implements IntIterator {
        ...
        public ValuesIterator(ObjectBidirectionalIterator<Int2IntMap.Entry> i2) {
            this.i = i2;
        }
    ...
    implements IntBidirectionalIterator {
        ...
        public KeySetIterator(ObjectBidirectionalIterator<Int2IntMap.Entry> i2) {
            this.i = i2;
        }
