...
public final class Int2IntMaps {
    ...
    public static Int2IntMap synchronize(Int2IntMap m2) {
        return new SynchronizedMap(m2);
    }

    public static Int2IntMap synchronize(Int2IntMap m2, Object sync) {
        return new SynchronizedMap(m2, sync);
    }

    public static Int2IntMap unmodifiable(Int2IntMap m2) {
