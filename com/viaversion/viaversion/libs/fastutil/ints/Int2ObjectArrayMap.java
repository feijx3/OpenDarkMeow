...
Cloneable {
        ...
        public ObjectIterator<Int2ObjectMap.Entry<V>> iterator() {
            return new ObjectIterator<Int2ObjectMap.Entry<V>>(){
                ...
                public int skip(int n2) {
                    ...
                    n2 = Math.min(n2, Int2ObjectArrayMap.this.size - this.next);
                    this.next += n2;
                    if (n2 != 0) {
    ...
    IntObjectPair<V> {
        ...
        public V setValue(V v2) {
            ...
            Int2ObjectArrayMap.this.value[this.index] = v2;
            return oldValue;
        }
        ...
        public boolean equals(Object o2) {
            ...
            Map.Entry e2 = (Map.Entry)o2;
            return Int2ObjectArrayMap.this.key[this.index] == (Integer)e2.getKey() && Objects.equals(Int2ObjectArrayMap.this.value[this.index], e2.getValue());
        }
