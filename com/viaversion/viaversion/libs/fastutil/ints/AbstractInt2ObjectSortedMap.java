...
implements Int2ObjectSortedMap<V> {
    ...
    extends AbstractIntSortedSet {
        ...
        public boolean contains(int k2) {
            return AbstractInt2ObjectSortedMap.this.containsKey(k2);
        }
    ...
    extends AbstractObjectCollection<V> {
        ...
        public boolean contains(Object k2) {
            return AbstractInt2ObjectSortedMap.this.containsValue(k2);
        }
    ...
    implements ObjectIterator<V> {
        ...
        public ValuesIterator(ObjectBidirectionalIterator<Int2ObjectMap.Entry<V>> i2) {
            this.i = i2;
        }
    ...
    implements IntBidirectionalIterator {
        ...
        public KeySetIterator(ObjectBidirectionalIterator<Int2ObjectMap.Entry<V>> i2) {
            this.i = i2;
        }
