...
import com.viaversion.viaversion.libs.fastutil.ints.IntReferencePair;
...
Serializable {
    ...
    @Override
    public IntReferenceMutablePair<V> left(int l2) {
        this.left = l2;
        return this;
    }
    ...
    public IntReferenceMutablePair<V> right(V r2) {
        this.right = r2;
        return this;
    }
