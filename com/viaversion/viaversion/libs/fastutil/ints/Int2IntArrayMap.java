...
Cloneable {
        ...
        public ObjectIterator<Int2IntMap.Entry> iterator() {
            return new ObjectIterator<Int2IntMap.Entry>(){
                ...
                public int skip(int n2) {
                    ...
                    n2 = Math.min(n2, Int2IntArrayMap.this.size - this.next);
                    this.next += n2;
                    if (n2 != 0) {
    ...
    IntIntPair {
        ...
        public int setValue(int v2) {
            ...
            Int2IntArrayMap.this.value[this.index] = v2;
            return oldValue;
        }
        ...
        public boolean equals(Object o2) {
            ...
            Map.Entry e2 = (Map.Entry)o2;
            return Int2IntArrayMap.this.key[this.index] == (Integer)e2.getKey() && Int2IntArrayMap.this.value[this.index] == (Integer)e2.getValue();
        }
