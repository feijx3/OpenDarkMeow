...
public final class Int2ObjectSortedMaps {
    ...
    public static Comparator<? super Map.Entry<Integer, ?>> entryComparator(IntComparator comparator) {
        return (x2, y2) -> comparator.compare((int)((Integer)x2.getKey()), (int)((Integer)y2.getKey()));
    }
    ...
    public static <V> Int2ObjectSortedMap<V> synchronize(Int2ObjectSortedMap<V> m2) {
        return new SynchronizedSortedMap(m2);
    }

    public static <V> Int2ObjectSortedMap<V> synchronize(Int2ObjectSortedMap<V> m2, Object sync) {
        return new SynchronizedSortedMap(m2, sync);
    }

    public static <V> Int2ObjectSortedMap<V> unmodifiable(Int2ObjectSortedMap<? extends V> m2) {
