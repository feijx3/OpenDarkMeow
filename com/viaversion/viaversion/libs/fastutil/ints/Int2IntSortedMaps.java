...
public final class Int2IntSortedMaps {
    ...
    public static Int2IntSortedMap synchronize(Int2IntSortedMap m2) {
        return new SynchronizedSortedMap(m2);
    }

    public static Int2IntSortedMap synchronize(Int2IntSortedMap m2, Object sync) {
        return new SynchronizedSortedMap(m2, sync);
    }

    public static Int2IntSortedMap unmodifiable(Int2IntSortedMap m2) {
