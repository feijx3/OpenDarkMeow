...
import com.viaversion.viaversion.libs.snakeyaml.constructor.DuplicateKeyException;
...
extends SafeConstructor {
    ...
    private static String check(String s2) {
        if (s2 == null) {
            throw new NullPointerException("Root type must be provided.");
        }
        if (s2.trim().length() == 0) {
    ...
    implements Construct {
        ...
        public Object construct(Node node) {
            ...
            if (!possibleConstructors.isEmpty()) {
                ...
                index = 0;
                Iterator iterator2 = argumentList.iterator();
        ...
        protected Object constructJavaBean2ndStep(MappingNode node, Object object) {
            ...
            for (NodeTuple tuple : nodeValue) {
                ...
                try {
                    ...
                    boolean bl2 = typeDetected = memberDescription != null && memberDescription.setupPropertyType(key, valueNode);
