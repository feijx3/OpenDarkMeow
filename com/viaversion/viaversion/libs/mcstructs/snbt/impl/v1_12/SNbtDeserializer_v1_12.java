...
implements SNbtDeserializer<CompoundTag> {
    ...
    public CompoundTag deserialize(String s2) throws SNbtDeserializeException {
        StringReader_v1_12 reader = this.makeReader(s2);
    ...
    public Tag deserializeValue(String s2) throws SNbtDeserializeException {
        return this.readValue(this.makeReader(s2));
    }
    ...
    protected Tag readArray(StringReader_v1_12 reader) throws SNbtDeserializeException {
        ...
        if (c2 == 'I') {
            ...
            for (int i4 = 0; i4 < tags.size(); ++i4) {
                array[i4] = tags.get(i4).asInt();
            }
            return new IntArrayTag(array);
        }
        throw new SNbtDeserializeException("Invalid array type '" + c2 + "' found");
    }
    ...
    protected Tag readNumber(String value) {
        try {
