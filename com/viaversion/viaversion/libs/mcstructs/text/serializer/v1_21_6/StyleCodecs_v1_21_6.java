...
import com.viaversion.viaversion.libs.mcstructs.text.serializer.v1_21_6.ExtraCodecs_v1_21_6;
import com.viaversion.viaversion.libs.mcstructs.text.serializer.v1_21_6.TextCodecs_v1_21_6;
import com.viaversion.viaversion.libs.mcstructs.text.serializer.v1_21_6.TextVerifier_v1_21_6;
...
public class StyleCodecs_v1_21_6 {
    public static final MapCodec<Style> MAP_CODEC = MapCodecMerger.mapCodec(TextFormattingCodec.CODEC.mapCodec("color").optional().defaulted(null), Style::getColor, ExtraCodecs_v1_21_6.ARGB_COLOR.mapCodec("shadow_color").optional().defaulted(null), Style::getShadowColor, Codec.BOOLEAN.mapCodec("obfuscated").optional().defaulted(null), Style::getObfuscated, Codec.BOOLEAN.mapCodec("bold").optional().defaulted(null), Style::getBold, Codec.BOOLEAN.mapCodec("strikethrough").optional().defaulted(null), Style::getStrikethrough, Codec.BOOLEAN.mapCodec("underlined").optional().defaulted(null), Style::getUnderlined, Codec.BOOLEAN.mapCodec("italic").optional().defaulted(null), Style::getItalic, ClickEventCodec.CODEC.mapCodec("click_event").optional().defaulted(null), Style::getClickEvent, HoverEventCodec.CODEC.mapCodec("hover_event").optional().defaulted(null), Style::getHoverEvent, Codec.STRING.mapCodec("insertion").optional().defaulted(null), Style::getInsertion, Codec.STRING_IDENTIFIER.mapCodec("font").optional().defaulted(null), Style::getFont, Style::new);
    public static final Codec<Style> CODEC = MAP_CODEC.asCodec();

    public static class HoverEventCodec {
        public static final MapCodec<TextHoverEvent> TEXT = MapCodecMerger.mapCodec(TextCodecs_v1_21_6.TEXT.mapCodec("value").required(), TextHoverEvent::getText, TextHoverEvent::new);
        public static final MapCodec<ItemHoverEvent> ITEM = MapCodecMerger.mapCodec(Codec.STRING_IDENTIFIER.converterVerified(VerifyingConverter.verify(TextVerifier_v1_21_6.class, TextVerifier_v1_21_6::verifyRegistryItem, "Invalid item")).mapCodec("id").required(), hoverEvent -> hoverEvent.asModern().getId(), Codec.rangedInt(1, 99).mapCodec("count").optional().elseGet(() -> 1), hoverEvent -> hoverEvent.asModern().getCount(), NbtConverter_v1_20_3.INSTANCE.toCodec().verified(tag -> {
            if (!(tag instanceof CompoundTag)) {
                return Result.error("Expected a compound tag");
            }
            return null;
        }).map(tag -> tag, tag -> (CompoundTag)tag).converterVerified(VerifyingConverter.verify(TextVerifier_v1_21_6.class, TextVerifier_v1_21_6::verifyDataComponents, "Invalid data components")).mapCodec("components").optional().defaulted(null), hoverEvent -> hoverEvent.asModern().getTag(), ItemHoverEvent::new);
        public static final MapCodec<EntityHoverEvent> ENTITY = MapCodecMerger.mapCodec(Codec.STRING_IDENTIFIER.converterVerified(VerifyingConverter.verify(TextVerifier_v1_21_6.class, TextVerifier_v1_21_6::verifyRegistryEntity, "Invalid entity")).mapCodec("id").required(), hoverEvent -> hoverEvent.asModern().getType(), ExtraCodecs_v1_21_6.LENIENT_UUID.mapCodec("uuid").required(), hoverEvent -> hoverEvent.asModern().getUuid(), TextCodecs_v1_21_6.TEXT.mapCodec("name").optional().defaulted(null), hoverEvent -> hoverEvent.asModern().getName(), EntityHoverEvent::new);
    ...
    public static class ClickEventCodec {
        public static final MapCodec<OpenUrlClickEvent> OPEN_URL = MapCodecMerger.mapCodec(ExtraCodecs_v1_21_6.UNTRUSTED_URI.mapCodec("url").required(), OpenUrlClickEvent::asUri, ClickEvent::openUrl);
        ...
        public static final MapCodec<RunCommandClickEvent> RUN_COMMAND = MapCodecMerger.mapCodec(ExtraCodecs_v1_21_6.CHAT_STRING.mapCodec("command").required(), RunCommandClickEvent::getCommand, ClickEvent::runCommand);
        public static final MapCodec<SuggestCommandClickEvent> SUGGEST_COMMAND = MapCodecMerger.mapCodec(ExtraCodecs_v1_21_6.CHAT_STRING.mapCodec("command").required(), SuggestCommandClickEvent::getCommand, ClickEvent::suggestCommand);
        ...
        public static final MapCodec<ShowDialogClickEvent> SHOW_DIALOG = MapCodecMerger.mapCodec(Codec.RAW.mapCodec("dialog").required(), ShowDialogClickEvent::getDialogData, ClickEvent::showDialog);
        public static final MapCodec<CustomClickEvent> CUSTOM = MapCodecMerger.mapCodec(Codec.STRING_IDENTIFIER.mapCodec("id").required(), CustomClickEvent::getId, NbtConverter_v1_21_5.INSTANCE.toCodec().mapCodec("payload").required(), CustomClickEvent::getPayload, ClickEvent::custom);
