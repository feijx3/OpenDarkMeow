...
public class TextCodecs_v1_21_5 {
    public static final Codec<TextComponent> TEXT = new LazyInitCodec<TextComponent>(() -> Codec.recursive(thiz -> TextCodecs_v1_20_3.createCodec((Codec)thiz, StyleCodecs_v1_21_5.MAP_CODEC, (TextCodecs_v1_20_3.TextComponentType[])ComponentType.values(), ComponentType::forComponent)));
    ...
    public static final MapCodec<SelectorComponent> SELECTOR_COMPONENT = MapCodecMerger.mapCodec(Codec.STRING.converterVerified(VerifyingConverter.verify(TextVerifier_v1_21_5.class, TextVerifier_v1_21_5::verifySelector, "Invalid selector")).mapCodec("selector").required(), SelectorComponent::getSelector, TEXT.mapCodec("separator").optional().defaulted(null), SelectorComponent::getSeparator, SelectorComponent::new);
