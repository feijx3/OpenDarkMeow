...
import com.viaversion.viaversion.libs.mcstructs.text.serializer.v1_20_5.ExtraCodecs_v1_20_5;
import com.viaversion.viaversion.libs.mcstructs.text.serializer.v1_20_5.TextCodecs_v1_20_5;
import com.viaversion.viaversion.libs.mcstructs.text.serializer.v1_20_5.TextVerifier_v1_20_5;
...
public class StyleCodecs_v1_20_5 {
    ...
    public static class HoverEventCodec {
        ...
        private static <T extends HoverEvent> MapCodec<T> createLegacy(BiFunction<DataConverter<?>, TextComponent, Result<T>> constructor) {
            return TextCodecs_v1_20_5.TEXT.converterFlatMap((dataConverter, t2) -> Result.error("Legacy hover events can't be serialized"), constructor).mapCodec("value").required();
        }
        ...
        public static class Entity {
            public static final MapCodec<EntityHoverEvent> MAP_CODEC = MapCodecMerger.codec(Codec.STRING_IDENTIFIER.converterVerified(VerifyingConverter.verify(TextVerifier_v1_20_5.class, TextVerifier_v1_20_5::verifyRegistryEntity, "Invalid entity")).mapCodec("type").required(), EntityHoverEvent.ModernHolder::getType, ExtraCodecs_v1_20_5.LENIENT_UUID.mapCodec("id").required(), EntityHoverEvent.ModernHolder::getUuid, TextCodecs_v1_20_5.TEXT.mapCodec("name").optional().defaulted(null), EntityHoverEvent.ModernHolder::getName, EntityHoverEvent.ModernHolder::new).mapCodec("contents").required().map(EntityHoverEvent::asModern, EntityHoverEvent::new);
            public static final MapCodec<EntityHoverEvent> LEGACY_MAP_CODEC = HoverEventCodec.access$000((converter, component) -> {
                try {
                    ...
                    TextComponent name = rawName == null ? null : (TextComponent)TextCodecs_v1_20_5.TEXT.deserialize(converter.fork(JsonConverter_v1_20_5.INSTANCE), rawName).getOrThrow(JsonParseException::new);
                    Identifier type = Identifier.of(tag.get("type") instanceof StringTag ? ((StringTag)tag.get("type")).getValue() : "");
                    if (!VerifyingConverter.isValid(converter, type, TextVerifier_v1_20_5.class, TextVerifier_v1_20_5::verifyRegistryEntity)) {
        ...
        public static class Item {
            private static final Codec<Identifier> NON_AIR_ITEM_CODEC = Codec.STRING_IDENTIFIER.converterVerified(VerifyingConverter.verify(TextVerifier_v1_20_5.class, TextVerifier_v1_20_5::verifyRegistryItem, "Invalid item")).verified(id -> {
                if (!id.equals("minecraft", "air")) {
                    return null;
                }
                return Result.error("Item must not be minecraft:air");
            });
            private static final Codec<ItemHoverEvent.ModernHolder> ITEM_STACK_CODEC = MapCodecMerger.codec(NON_AIR_ITEM_CODEC.mapCodec("id").required(), ItemHoverEvent.ModernHolder::getId, Codec.minInt(1).mapCodec("count").optional().elseGet(() -> 1), ItemHoverEvent.ModernHolder::getCount, ExtraCodecs_v1_20_5.INLINED_COMPOUND_TAG.converterVerified(VerifyingConverter.verify(TextVerifier_v1_20_5.class, TextVerifier_v1_20_5::verifyDataComponents, "Invalid data components")).mapCodec("components").optional().defaulted(null), ItemHoverEvent.ModernHolder::getTag, ItemHoverEvent.ModernHolder::new);
            private static final Codec<ItemHoverEvent.ModernHolder> SIMPLE_ITEM_CODEC = NON_AIR_ITEM_CODEC.map(ItemHoverEvent.ModernHolder::getId, id -> new ItemHoverEvent.ModernHolder((Identifier)id, 1, null));
