    ...
    public TextComponent deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException {
        ...
        if (rawComponent.has("text")) {
            ...
            if (rawComponent.has("block")) {
                component = new NbtComponent(nbt, interpret, null, new BlockNbtSource(JsonUtils.getString(rawComponent, "block")));
            } else if (rawComponent.has("entity")) {
                component = new NbtComponent(nbt, interpret, null, new EntityNbtSource(JsonUtils.getString(rawComponent, "entity")));
            } else {
                if (!rawComponent.has("storage")) throw new JsonParseException("Don't know how to turn " + json + " into a Component");
                component = new NbtComponent(nbt, interpret, null, new StorageNbtSource(Identifier.of(JsonUtils.getString(rawComponent, "storage"))));
            }
        }
