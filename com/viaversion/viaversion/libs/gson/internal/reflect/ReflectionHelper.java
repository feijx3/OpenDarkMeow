...
public class ReflectionHelper {
    ...
    private static String getInaccessibleTroubleshootingSuffix(Exception e2) {
    ...
    extends RecordHelper {
        ...
        String[] getRecordComponentNames(Class<?> raw) {
            try {
                ...
                for (int i2 = 0; i2 < recordComponents.length; ++i2) {
                    componentNames[i2] = (String)this.getName.invoke(recordComponents[i2], new Object[0]);
                }
        ...
        public <T> Constructor<T> getCanonicalRecordConstructor(Class<T> raw) {
            try {
                ...
                for (int i2 = 0; i2 < recordComponents.length; ++i2) {
                    recordComponentTypes[i2] = (Class)this.getType.invoke(recordComponents[i2], new Object[0]);
                }
