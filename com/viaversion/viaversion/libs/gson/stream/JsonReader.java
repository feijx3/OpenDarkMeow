...
implements Closeable {
    ...
    private int peekKeyword() throws IOException {
        ...
        for (int i2 = 0; i2 < length; ++i2) {
            ...
            boolean bl2 = matched = c2 == keyword.charAt(i2) || allowsUpperCased && c2 == keywordUpper.charAt(i2);
            if (matched) continue;
            return 0;
        }
    ...
    private String nextUnquotedValue() throws IOException {
        ...
        String result = builder == null ? new String(this.buffer, this.pos, i2) : builder.append(this.buffer, this.pos, i2).toString();
        this.pos += i2;
        return result;
    }
    ...
    private String getPath(boolean usePreviousPath) {
        ...
        block5: for (int i2 = 0; i2 < this.stackSize; ++i2) {
            int scope = this.stack[i2];
            switch (scope) {
                case 1: 
                case 2: {
                ...
                case 5: {
                    result.append('.');
                    if (this.pathNames[i2] == null) continue block5;
