...
extends LegacyViaInjector {
    ...
    public ProtocolVersion getServerProtocolVersion() throws ReflectiveOperationException {
        ...
        return ProtocolVersion.getProtocol(HAS_WORLD_VERSION_PROTOCOL_VERSION ? this.cursedProtocolDetection() : this.veryCursedProtocolDetection());
    }
    ...
    private int veryCursedProtocolDetection() throws ReflectiveOperationException {
        ...
        Preconditions.checkNotNull((Object)server, (Object)"Failed to get server instance");
    ...
    protected void blame(ChannelHandler bootstrapAcceptor) throws ReflectiveOperationException {
        ...
        if (classLoader.getClass().getName().equals("org.bukkit.plugin.java.PluginClassLoader")) {
            ...
            throw new RuntimeException(BukkitViaInjector.jvmdowngrader$concat$blame$1(bootstrapAcceptor.getClass().getName(), description.getName()));
        }
        throw new RuntimeException(BukkitViaInjector.jvmdowngrader$concat$blame$1(bootstrapAcceptor.getClass().getName()));
    }
    ...
    public boolean isBinded() {
        ...
        try {
            ...
            Via.getPlatform().getLogger().log(Level.SEVERE, "Failed to check if ViaVersion is binded", e2);
        }
        return false;
    }

    private static String jvmdowngrader$concat$blame$1(String string, String string2) {
        return "Unable to inject, due to " + string + ", try without the plugin " + string2 + "?";
    }

    private static String jvmdowngrader$concat$blame$1(String string) {
        return "Unable to find core component 'childHandler', please check your plugins. issue: " + string;
    }
}
