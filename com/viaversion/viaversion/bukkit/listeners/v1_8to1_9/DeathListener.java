        ...
        Via.getPlatform().runSync(() -> {
            ...
            if (userConnection != null) {
                ...
                try {
                    ...
                    wrapper.write(Types.VAR_INT, p2.getEntityId());
                    wrapper.write(Types.INT, p2.getEntityId());
                    wrapper.write(Types.COMPONENT, ComponentUtil.plainToJson(msg));
                    wrapper.scheduleSend(Protocol1_8To1_9.class);
                }
                catch (Exception e2) {
                    Via.getPlatform().getLogger().log(Level.WARNING, "Failed to send death message", e2);
                }
            }
        });
    }
