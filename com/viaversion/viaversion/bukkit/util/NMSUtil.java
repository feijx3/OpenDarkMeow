...
public final class NMSUtil {
    ...
    public static Class<?> nms(String className) throws ClassNotFoundException {
        return Class.forName(NMSUtil.jvmdowngrader$concat$nms$1(NMS, className));
    }
    ...
    public static Class<?> obc(String className) throws ClassNotFoundException {
        return Class.forName(NMSUtil.jvmdowngrader$concat$nms$1(BASE, className));
    }
    ...
    private static String jvmdowngrader$concat$nms$1(String string, String string2) {
