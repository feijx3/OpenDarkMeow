...
public class ProtocolLogger {
    ...
    private String formatMessage(String msg) {
        return ProtocolLogger.jvmdowngrader$concat$formatMessage$1(this.name, msg);
    }

    private static String jvmdowngrader$concat$formatMessage$1(String string, String string2) {
