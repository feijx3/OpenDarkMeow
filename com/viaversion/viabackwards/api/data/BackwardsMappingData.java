...
extends MappingDataBase {
    ...
    public @Nullable String mappedEntityName(String entityName) {
        if (this.entityNames == null) {
            this.getLogger().log(Level.SEVERE, BackwardsMappingData.jvmdowngrader$concat$mappedEntityName$1(entityName), new RuntimeException());
            return null;
        }
    ...
    public @Nullable String mappedEnchantmentName(int enchantmentId) {
        if (this.enchantmentNames == null) {
            ViaBackwards.getPlatform().getLogger().log(Level.SEVERE, BackwardsMappingData.jvmdowngrader$concat$mappedEnchantmentName$1(enchantmentId), new RuntimeException());
            return null;
        }
    ...
    private static String jvmdowngrader$concat$mappedEntityName$1(String string) {
        return "No entity mappings found when requesting them for " + string;
    }

    private static String jvmdowngrader$concat$mappedEnchantmentName$1(int n2) {
        return "No enchantment name mappings found when requesting " + n2;
    }
}
