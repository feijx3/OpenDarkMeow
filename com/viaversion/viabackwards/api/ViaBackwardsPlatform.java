...
public interface ViaBackwardsPlatform {
    public static final String MINIMUM_VV_VERSION = "5.4.0";
    ...
    default public void init(File configFile) {
        ...
        protocolManager.registerProtocol((Protocol)new Protocol1_21_2To1_21(), ProtocolVersion.v1_21, ProtocolVersion.v1_21_2);
        protocolManager.registerProtocol((Protocol)new Protocol1_21_4To1_21_2(), ProtocolVersion.v1_21_2, ProtocolVersion.v1_21_4);
        protocolManager.registerProtocol((Protocol)new Protocol1_21_5To1_21_4(), ProtocolVersion.v1_21_4, ProtocolVersion.v1_21_5);
        protocolManager.registerProtocol((Protocol)new Protocol1_21_6To1_21_5(), ProtocolVersion.v1_21_5, ProtocolVersion.v1_21_6);
        protocolManager.registerProtocol((Protocol)new Protocol1_21_7To1_21_6(), ProtocolVersion.v1_21_6, ProtocolVersion.v1_21_7);
    }
    ...
    default public boolean isOutdated() {
        ...
        if (vvVersion != null && new Version(vvVersion).compareTo(new Version("5.4.0--")) < 0) {
            this.getLogger().severe("================================");
            this.getLogger().severe(ViaBackwardsPlatform.jvmdowngrader$concat$isOutdated$1(vvVersion));
            this.getLogger().severe("PLEASE USE VIAVERSION 5.4.0 OR NEWER");
    ...
    private static String jvmdowngrader$concat$isOutdated$1(String string) {
        return "YOUR VIAVERSION IS OUTDATED (you are running " + string + ")";
    }
}
