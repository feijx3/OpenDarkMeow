...
public class PlayerPacketRewriter1_11 {
    ...
    public static void register(Protocol1_11To1_10 protocol) {
        ...
        protocol.registerServerbound(ServerboundPackets1_9_3.USE_ITEM_ON, new PacketHandlers(){
            ...
            public void register() {
                ...
                this.map(Types.VAR_INT);
                this.map(Types.VAR_INT);
                this.map(Types.UNSIGNED_BYTE, PlayerPacketRewriter1_11.jvmdowngrader$nest$com_viaversion_viabackwards_protocol_v1_11to1_10_rewriter_PlayerPacketRewriter1_11$get$TO_NEW_FLOAT());
                this.map(Types.UNSIGNED_BYTE, PlayerPacketRewriter1_11.jvmdowngrader$nest$com_viaversion_viabackwards_protocol_v1_11to1_10_rewriter_PlayerPacketRewriter1_11$get$TO_NEW_FLOAT());
                this.map(Types.UNSIGNED_BYTE, PlayerPacketRewriter1_11.jvmdowngrader$nest$com_viaversion_viabackwards_protocol_v1_11to1_10_rewriter_PlayerPacketRewriter1_11$get$TO_NEW_FLOAT());
            }
        });
    ...
    public static ValueTransformer jvmdowngrader$nest$com_viaversion_viabackwards_protocol_v1_11to1_10_rewriter_PlayerPacketRewriter1_11$get$TO_NEW_FLOAT() {
        return TO_NEW_FLOAT;
    }

    public static void jvmdowngrader$nest$com_viaversion_viabackwards_protocol_v1_11to1_10_rewriter_PlayerPacketRewriter1_11$set$TO_NEW_FLOAT(ValueTransformer valueTransformer) {
        TO_NEW_FLOAT = valueTransformer;
    }
}
