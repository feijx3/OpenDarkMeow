...
import ViaBackwards.xyz.wagyourtail.jvmdg.j11.stub.java_base.J_U_Optional;
...
extends LegacyBlockItemRewriter<ClientboundPackets1_9_3, ServerboundPackets1_9_3, Protocol1_11To1_10> {
        ...
        ((Protocol1_11To1_10)this.protocol).registerClientbound(ClientboundPackets1_9_3.CONTAINER_SET_SLOT, new PacketHandlers(){
            ...
            public void register() {
                ...
                this.handler(wrapper -> {
                    if (BlockItemPacketRewriter1_11.this.jvmdowngrader$nest$com_viaversion_viabackwards_protocol_v1_11to1_10_rewriter_BlockItemPacketRewriter1_11$isLlama(wrapper.user())) {
                        Optional horse = BlockItemPacketRewriter1_11.this.jvmdowngrader$nest$com_viaversion_viabackwards_protocol_v1_11to1_10_rewriter_BlockItemPacketRewriter1_11$getChestedHorse(wrapper.user());
                        if (J_U_Optional.isEmpty(horse)) {
                            return;
                        }
                        ChestedHorseStorage storage = (ChestedHorseStorage)horse.get();
                        int currentSlot = wrapper.get(Types.SHORT, 0).shortValue();
                        currentSlot = BlockItemPacketRewriter1_11.this.jvmdowngrader$nest$com_viaversion_viabackwards_protocol_v1_11to1_10_rewriter_BlockItemPacketRewriter1_11$getNewSlotId(storage, currentSlot);
                        wrapper.set(Types.SHORT, 0, Integer.valueOf(currentSlot).shortValue());
                        wrapper.set(Types.ITEM1_8, 0, BlockItemPacketRewriter1_11.this.jvmdowngrader$nest$com_viaversion_viabackwards_protocol_v1_11to1_10_rewriter_BlockItemPacketRewriter1_11$getNewItem(storage, currentSlot, wrapper.get(Types.ITEM1_8, 0)));
                    }
                });
            }
        });
            ...
            public void register() {
                ...
                this.handler(wrapper -> {
                    ...
                    for (int i2 = 0; i2 < stacks.length; ++i2) {
                        stacks[i2] = BlockItemPacketRewriter1_11.this.handleItemToClient(wrapper.user(), stacks[i2]);
                    }
                    if (BlockItemPacketRewriter1_11.this.jvmdowngrader$nest$com_viaversion_viabackwards_protocol_v1_11to1_10_rewriter_BlockItemPacketRewriter1_11$isLlama(wrapper.user())) {
                        Optional horse = BlockItemPacketRewriter1_11.this.jvmdowngrader$nest$com_viaversion_viabackwards_protocol_v1_11to1_10_rewriter_BlockItemPacketRewriter1_11$getChestedHorse(wrapper.user());
                        if (J_U_Optional.isEmpty(horse)) {
                        ...
                        for (int i3 = stacks.length - 1; i3 >= 0; --i3) {
                            stacks[BlockItemPacketRewriter1_11.this.jvmdowngrader$nest$com_viaversion_viabackwards_protocol_v1_11to1_10_rewriter_BlockItemPacketRewriter1_11$getNewSlotId((ChestedHorseStorage)storage, (int)i3)] = stacks[i3];
                            stacks[i3] = BlockItemPacketRewriter1_11.this.jvmdowngrader$nest$com_viaversion_viabackwards_protocol_v1_11to1_10_rewriter_BlockItemPacketRewriter1_11$getNewItem(storage, i3, stacks[i3]);
                        }
            ...
            public void register() {
                ...
                this.handler(wrapper -> {
                    if (BlockItemPacketRewriter1_11.this.jvmdowngrader$nest$com_viaversion_viabackwards_protocol_v1_11to1_10_rewriter_BlockItemPacketRewriter1_11$isLlama(wrapper.user())) {
                        ...
                        int correctSlot = BlockItemPacketRewriter1_11.this.jvmdowngrader$nest$com_viaversion_viabackwards_protocol_v1_11to1_10_rewriter_BlockItemPacketRewriter1_11$getOldSlotId(storage, clickSlot);
        ...
        ((Protocol1_11To1_10)this.protocol).registerClientbound(ClientboundPackets1_9_3.OPEN_SCREEN, new PacketHandlers(){
            ...
            public void register() {
                ...
                this.handler(wrapper -> {
                    ...
                    ((ComponentRewriterBase)((Object)((Protocol1_11To1_10)BlockItemPacketRewriter1_11.this.protocol).getComponentRewriter())).processText(wrapper.user(), wrapper.get(Types.COMPONENT, 0));
    ...
    protected void registerRewrites() {
        MappedLegacyBlockItem data = this.itemReplacements.computeIfAbsent(IdAndData.toRawData(52), s2 -> new MappedLegacyBlockItem(52));
        data.setBlockEntityHandler((b2, tag) -> EntityMappings1_11.toClientSpawner(tag, true));
    ...
    public Optional jvmdowngrader$nest$com_viaversion_viabackwards_protocol_v1_11to1_10_rewriter_BlockItemPacketRewriter1_11$getChestedHorse(UserConnection userConnection) {
        return this.getChestedHorse(userConnection);
    }

    public boolean jvmdowngrader$nest$com_viaversion_viabackwards_protocol_v1_11to1_10_rewriter_BlockItemPacketRewriter1_11$isLlama(UserConnection userConnection) {
        return this.isLlama(userConnection);
    }

    public Item jvmdowngrader$nest$com_viaversion_viabackwards_protocol_v1_11to1_10_rewriter_BlockItemPacketRewriter1_11$getNewItem(ChestedHorseStorage chestedHorseStorage, int n2, Item item) {
        return this.getNewItem(chestedHorseStorage, n2, item);
    }

    public int jvmdowngrader$nest$com_viaversion_viabackwards_protocol_v1_11to1_10_rewriter_BlockItemPacketRewriter1_11$getOldSlotId(ChestedHorseStorage chestedHorseStorage, int n2) {
        return this.getOldSlotId(chestedHorseStorage, n2);
    }

    public int jvmdowngrader$nest$com_viaversion_viabackwards_protocol_v1_11to1_10_rewriter_BlockItemPacketRewriter1_11$getNewSlotId(ChestedHorseStorage chestedHorseStorage, int n2) {
        return this.getNewSlotId(chestedHorseStorage, n2);
    }
}
