...
extends EntityRewriter<ClientboundPackets1_17, Protocol1_17To1_16_4> {
    ...
    protected void registerPackets() {
            ...
            public void register() {
                ...
                this.handler(wrapper -> {
                    ...
                    for (CompoundTag dimension : dimensions) {
                        ...
                        EntityPacketRewriter1_17.this.jvmdowngrader$nest$com_viaversion_viabackwards_protocol_v1_17to1_16_4_rewriter_EntityPacketRewriter1_17$reduceExtendedHeight(dimensionCompound, false);
                    }
                    EntityPacketRewriter1_17.this.jvmdowngrader$nest$com_viaversion_viabackwards_protocol_v1_17to1_16_4_rewriter_EntityPacketRewriter1_17$reduceExtendedHeight(wrapper.get(Types.NAMED_COMPOUND_TAG, 1), true);
                });
            }
        });
        ((Protocol1_17To1_16_4)this.protocol).registerClientbound(ClientboundPackets1_17.RESPAWN, new PacketHandlers(){
            ...
            public void register() {
                ...
                this.handler(wrapper -> EntityPacketRewriter1_17.this.jvmdowngrader$nest$com_viaversion_viabackwards_protocol_v1_17to1_16_4_rewriter_EntityPacketRewriter1_17$reduceExtendedHeight(wrapper.get(Types.NAMED_COMPOUND_TAG, 0), true));
            }
        });
        ...
        ((Protocol1_17To1_16_4)this.protocol).registerClientbound(ClientboundPackets1_17.PLAYER_COMBAT_KILL, ClientboundPackets1_16_2.PLAYER_COMBAT, wrapper -> {
            ...
            ((ComponentRewriterBase)((Object)((Protocol1_17To1_16_4)this.protocol).getComponentRewriter())).processText(wrapper.user(), wrapper.passthrough(Types.COMPONENT));
        });
    }
    ...
    protected void registerRewrites() {
        this.filter().handler((event, data) -> {
            ...
            if (type == Types1_16.ENTITY_DATA_TYPES.particleType) {
                ...
                ((ParticleRewriter)((Protocol1_17To1_16_4)this.protocol).getParticleRewriter()).rewriteParticle(event.user(), particle);
    ...
    public void jvmdowngrader$nest$com_viaversion_viabackwards_protocol_v1_17to1_16_4_rewriter_EntityPacketRewriter1_17$reduceExtendedHeight(CompoundTag compoundTag, boolean bl2) {
        this.reduceExtendedHeight(compoundTag, bl2);
    }
}
