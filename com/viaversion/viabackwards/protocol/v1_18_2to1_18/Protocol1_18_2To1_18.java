...
extends BackwardsProtocol<ClientboundPackets1_18, ClientboundPackets1_18, ServerboundPackets1_17, ServerboundPackets1_17> {
        ...
        final PacketHandler entityEffectIdHandler = wrapper -> {
            ...
            if ((byte)id != id) {
                if (!Via.getConfig().isSuppressConversionWarnings()) {
                    this.getLogger().warning(Protocol1_18_2To1_18.jvmdowngrader$concat$lambda$registerPackets$0$1(id));
                }
                wrapper.cancel();
                return;
            }
            ...
            public void register() {
                ...
                this.handler(wrapper -> {
                    ...
                    for (CompoundTag dimension : dimensions) {
                        Protocol1_18_2To1_18.this.jvmdowngrader$nest$com_viaversion_viabackwards_protocol_v1_18_2to1_18_Protocol1_18_2To1_18$removeTagPrefix(dimension.getCompoundTag("element"));
                    }
                    Protocol1_18_2To1_18.this.jvmdowngrader$nest$com_viaversion_viabackwards_protocol_v1_18_2to1_18_Protocol1_18_2To1_18$removeTagPrefix(wrapper.get(Types.NAMED_COMPOUND_TAG, 1));
                });
            }
        });
    ...
    public void jvmdowngrader$nest$com_viaversion_viabackwards_protocol_v1_18_2to1_18_Protocol1_18_2To1_18$removeTagPrefix(CompoundTag compoundTag) {
        this.removeTagPrefix(compoundTag);
    }

    private static String jvmdowngrader$concat$lambda$registerPackets$0$1(int n2) {
        return "Cannot send entity effect id " + n2 + " to old client";
    }
}
