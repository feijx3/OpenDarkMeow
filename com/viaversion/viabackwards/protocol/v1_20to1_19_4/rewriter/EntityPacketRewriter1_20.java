...
extends EntityRewriter<ClientboundPackets1_19_4, Protocol1_20To1_19_4> {
            ...
            public void register() {
                ...
                this.handler(wrapper -> {
                    ...
                    for (CompoundTag entry : values) {
                        ...
                        if (!EntityPacketRewriter1_20.this.jvmdowngrader$nest$com_viaversion_viabackwards_protocol_v1_20to1_19_4_rewriter_EntityPacketRewriter1_20$get$newTrimPatterns().contains(Key.stripMinecraftNamespace(templateItem.getValue()))) continue;
    ...
    protected void registerRewrites() {
        this.filter().mapDataType(Types1_19_4.ENTITY_DATA_TYPES::byId);
    ...
    public Set jvmdowngrader$nest$com_viaversion_viabackwards_protocol_v1_20to1_19_4_rewriter_EntityPacketRewriter1_20$get$newTrimPatterns() {
        return this.newTrimPatterns;
    }

    public void jvmdowngrader$nest$com_viaversion_viabackwards_protocol_v1_20to1_19_4_rewriter_EntityPacketRewriter1_20$set$newTrimPatterns(Set set) {
        this.newTrimPatterns = set;
    }
}
