...
extends RewriterBase<Protocol1_14To1_13_2> {
    ...
    protected void registerPackets() {
        ...
        ((Protocol1_14To1_13_2)this.protocol).registerClientbound(ClientboundPackets1_14.SOUND_ENTITY, null, wrapper -> {
            ...
            if (storedEntity == null || (entityStorage = storedEntity.get(EntityPositionStorage1_14.class)) == null) {
                ((Protocol1_14To1_13_2)this.protocol).getLogger().warning(SoundPacketRewriter1_14.jvmdowngrader$concat$lambda$registerPackets$0$1(entityId));
                return;
            }
            float volume = wrapper.read(Types.FLOAT).floatValue();
            float pitch = wrapper.read(Types.FLOAT).floatValue();
            int x2 = (int)(entityStorage.x() * 8.0);
            int y2 = (int)(entityStorage.y() * 8.0);
            int z2 = (int)(entityStorage.z() * 8.0);
            ...
            soundPacket.write(Types.INT, x2);
            soundPacket.write(Types.INT, y2);
            soundPacket.write(Types.INT, z2);
    ...
    private static String jvmdowngrader$concat$lambda$registerPackets$0$1(int n2) {
        return "Untracked entity with id " + n2;
    }
}
