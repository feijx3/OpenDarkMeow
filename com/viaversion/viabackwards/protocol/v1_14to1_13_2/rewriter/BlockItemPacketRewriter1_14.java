...
extends BackwardsItemRewriter<ClientboundPackets1_14, ServerboundPackets1_13, Protocol1_14To1_13_2> {
    ...
    protected void registerPackets() {
        ...
        ((Protocol1_14To1_13_2)this.protocol).registerClientbound(ClientboundPackets1_14.OPEN_SCREEN, wrapper -> {
            ...
            if (stringType == null) {
                ((Protocol1_14To1_13_2)this.protocol).getLogger().warning(BlockItemPacketRewriter1_14.jvmdowngrader$concat$lambda$registerPackets$1$1(type));
                wrapper.cancel();
                return;
            }
        ...
        ((Protocol1_14To1_13_2)this.protocol).registerClientbound(ClientboundPackets1_14.LEVEL_CHUNK, wrapper -> {
            ...
            for (int i2 = 0; i2 < chunk.getSections().length; ++i2) {
                ...
                for (int j2 = 0; j2 < palette.size(); ++j2) {
                    int mappedBlockStateId = ((Protocol1_14To1_13_2)this.protocol).getMappingData().getNewBlockStateId(palette.idByIndex(j2));
    ...
    public Item handleItemToClient(UserConnection connection, Item item) {
        ...
        if (display != null && item instanceof DataItemWithExtras && (fullItem = (DataItemWithExtras)item).lore() != null) {
            List<JsonElement> lore = fullItem.lore();
            ListTag<StringTag> loreTag = fullItem.rawLore();
            ...
            try {
                for (int i2 = 0; i2 < lore.size(); ++i2) {
                    ...
                    TextUtils.setTranslator(component, s2 -> Protocol1_12_2To1_13.MAPPINGS.getMojangTranslation().getOrDefault(s2, TranslatableMappings.getTranslatableMappings("1.14").get(s2)));
                    loreTag.get(i2).setValue(component.asLegacyFormatString());
                }
            }
    ...
    private static String jvmdowngrader$concat$lambda$registerPackets$1$1(int n2) {
        return "Can't open inventory for player! Type: " + n2;
    }
}
