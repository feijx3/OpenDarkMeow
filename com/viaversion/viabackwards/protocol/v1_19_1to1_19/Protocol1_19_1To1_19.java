...
extends BackwardsProtocol<ClientboundPackets1_19_1, ClientboundPackets1_19, ServerboundPackets1_19_1, ServerboundPackets1_19> {
    ...
    private final JsonNBTComponentRewriter<ClientboundPackets1_19_1> translatableRewriter = new JsonNBTComponentRewriter<ClientboundPackets1_19_1>(this, ComponentRewriterBase.ReadType.JSON);
    ...
    protected void registerPackets() {
        ...
        this.translatableRewriter.registerOpenScreen1_14(ClientboundPackets1_19_1.OPEN_SCREEN);
        ...
        this.registerClientbound(ClientboundPackets1_19_1.LOGIN, new PacketHandlers(){
            ...
            public void register() {
                ...
                this.handler(Protocol1_19_1To1_19.this.jvmdowngrader$nest$com_viaversion_viabackwards_protocol_v1_19_1to1_19_Protocol1_19_1To1_19$get$entityRewriter().worldTrackerHandlerByKey());
            }
        });
            ...
            public void register() {
                ...
                this.handler(wrapper -> {
                    ...
                    if (chatSession != null) {
                        ...
                        wrapper.write(Types.BYTE_ARRAY_PRIMITIVE, Protocol1_19_1To1_19.jvmdowngrader$nest$com_viaversion_viabackwards_protocol_v1_19_1to1_19_Protocol1_19_1To1_19$get$EMPTY_BYTES());
        ...
        this.registerClientbound(State.LOGIN, ClientboundLoginPackets.CUSTOM_QUERY, (PacketHandler)new PacketHandlers(){
                ...
                this.handler(wrapper -> {
                    ...
                    if (identifier.equals("velocity:player_info")) {
                        ...
                        if (data.length == 1 && data[0] > 1) {
                            ...
                            Protocol1_19_1To1_19.this.getLogger().warning(8.jvmdowngrader$concat$lambda$register$0$1(data.length));
                        }
                    }
                });
            }
            ...
            private static String jvmdowngrader$concat$lambda$register$0$1(int n2) {
                return "Received unexpected data in velocity:player_info (length=" + n2 + ")";
            }
        });
    ...
    public static @Nullable JsonElement decorateChatMessage(Protocol protocol, ChatRegistryStorage chatRegistryStorage, int chatTypeId, JsonElement senderName, @Nullable JsonElement targetName, JsonElement message) {
        ...
        if (chatType == null) {
            protocol.getLogger().warning(Protocol1_19_1To1_19.jvmdowngrader$concat$decorateChatMessage$1(chatTypeId, String.valueOf(message)));
            return null;
        }
    ...
    public static byte[] jvmdowngrader$nest$com_viaversion_viabackwards_protocol_v1_19_1to1_19_Protocol1_19_1To1_19$get$EMPTY_BYTES() {
        return EMPTY_BYTES;
    }

    public static void jvmdowngrader$nest$com_viaversion_viabackwards_protocol_v1_19_1to1_19_Protocol1_19_1To1_19$set$EMPTY_BYTES(byte[] byArray) {
        EMPTY_BYTES = byArray;
    }

    public EntityPacketRewriter1_19_1 jvmdowngrader$nest$com_viaversion_viabackwards_protocol_v1_19_1to1_19_Protocol1_19_1To1_19$get$entityRewriter() {
        return this.entityRewriter;
    }

    public void jvmdowngrader$nest$com_viaversion_viabackwards_protocol_v1_19_1to1_19_Protocol1_19_1To1_19$set$entityRewriter(EntityPacketRewriter1_19_1 entityPacketRewriter1_19_1) {
        this.entityRewriter = entityPacketRewriter1_19_1;
    }

    private static String jvmdowngrader$concat$decorateChatMessage$1(int n2, String string) {
        return "Chat message has unknown chat type id " + n2 + ". Message: " + string;
    }
}
