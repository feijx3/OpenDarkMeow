...
extends EntityRewriter<ClientboundPackets1_16, Protocol1_16To1_15_2> {
    ...
    protected void registerPackets() {
        ...
        ((Protocol1_16To1_15_2)this.protocol).registerClientbound(ClientboundPackets1_16.RESPAWN, new PacketHandlers(){
            ...
            @Override
            public void register() {
                this.map(EntityPacketRewriter1_16.this.jvmdowngrader$nest$com_viaversion_viabackwards_protocol_v1_16to1_15_2_rewriter_EntityPacketRewriter1_16$get$dimensionTransformer());
                this.handler(wrapper -> {
        ...
        ((Protocol1_16To1_15_2)this.protocol).registerClientbound(ClientboundPackets1_16.UPDATE_ATTRIBUTES, wrapper -> {
            ...
            for (int i2 = 0; i2 < size; ++i2) {
                ...
                for (int j2 = 0; j2 < count; ++j2) {
                    ...
                    modifiers[j2] = new PlayerAttributesStorage.AttributeModifier(uuid, amount, operation);
                }
    ...
    protected void registerRewrites() {
        this.filter().handler((event, data) -> {
            ...
            if (type == Types1_14.ENTITY_DATA_TYPES.itemType) {
                ...
                ((ParticleRewriter)((Protocol1_16To1_15_2)this.protocol).getParticleRewriter()).rewriteParticle(event.user(), (Particle)data.getValue());
    ...
    public ValueTransformer jvmdowngrader$nest$com_viaversion_viabackwards_protocol_v1_16to1_15_2_rewriter_EntityPacketRewriter1_16$get$dimensionTransformer() {
        return this.dimensionTransformer;
    }

    public void jvmdowngrader$nest$com_viaversion_viabackwards_protocol_v1_16to1_15_2_rewriter_EntityPacketRewriter1_16$set$dimensionTransformer(ValueTransformer valueTransformer) {
