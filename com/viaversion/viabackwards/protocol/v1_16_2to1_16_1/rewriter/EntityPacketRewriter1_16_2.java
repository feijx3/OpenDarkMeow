...
extends EntityRewriter<ClientboundPackets1_16_2, Protocol1_16_2To1_16_1> {
        ...
        ((Protocol1_16_2To1_16_1)this.protocol).registerClientbound(ClientboundPackets1_16_2.LOGIN, new PacketHandlers(){
            ...
            public void register() {
                ...
                this.handler(wrapper -> {
                    ...
                    wrapper.write(Types.STRING, EntityPacketRewriter1_16_2.this.jvmdowngrader$nest$com_viaversion_viabackwards_protocol_v1_16_2to1_16_1_rewriter_EntityPacketRewriter1_16_2$getDimensionFromData(dimensionData));
                });
    ...
    public String jvmdowngrader$nest$com_viaversion_viabackwards_protocol_v1_16_2to1_16_1_rewriter_EntityPacketRewriter1_16_2$getDimensionFromData(CompoundTag compoundTag) {
        return this.getDimensionFromData(compoundTag);
    }

    public boolean jvmdowngrader$nest$com_viaversion_viabackwards_protocol_v1_16_2to1_16_1_rewriter_EntityPacketRewriter1_16_2$get$warned() {
        return this.warned;
    }

    public void jvmdowngrader$nest$com_viaversion_viabackwards_protocol_v1_16_2to1_16_1_rewriter_EntityPacketRewriter1_16_2$set$warned(boolean bl2) {
        this.warned = bl2;
    }
}
