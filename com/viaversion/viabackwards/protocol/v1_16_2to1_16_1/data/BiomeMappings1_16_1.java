...
public final class BiomeMappings1_16_1 {
    ...
    public static int toLegacyBiome(String biome) {
        ...
        if (legacyBiome == -1) {
            if (!Via.getConfig().isSuppressConversionWarnings()) {
                Protocol1_16_2To1_16_1.LOGGER.warning(BiomeMappings1_16_1.jvmdowngrader$concat$toLegacyBiome$1(biome));
            }
            return 1;
        }
        return legacyBiome;
    ...
    static {
        ...
        for (Map.Entry<String, JsonElement> entry : mappings.entrySet()) {
            ...
            if (legacyBiome == -1) {
                Protocol1_16_2To1_16_1.LOGGER.warning(BiomeMappings1_16_1.jvmdowngrader$concat$$clinit$$1(entry.getValue().getAsString()));
                continue;
            }
    ...
    private static String jvmdowngrader$concat$toLegacyBiome$1(String string) {
        return "Biome with id " + string + " has no legacy biome mapping (custom datapack?)";
    }

    private static String jvmdowngrader$concat$$clinit$$1(String string) {
        return "Unknown legacy biome: " + string;
    }
}
