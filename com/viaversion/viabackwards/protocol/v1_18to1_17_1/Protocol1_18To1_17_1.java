...
extends BackwardsProtocol<ClientboundPackets1_18, ClientboundPackets1_17_1, ServerboundPackets1_17, ServerboundPackets1_17> {
    ...
    private final JsonNBTComponentRewriter<ClientboundPackets1_18> translatableRewriter = new JsonNBTComponentRewriter<ClientboundPackets1_18>(this, ComponentRewriterBase.ReadType.JSON);
    ...
    protected void registerPackets() {
        ...
        this.translatableRewriter.registerOpenScreen1_14(ClientboundPackets1_18.OPEN_SCREEN);
        ...
        this.registerClientbound(ClientboundPackets1_18.SET_OBJECTIVE, new PacketHandlers(){
            ...
            public void register() {
                this.map(Types.STRING);
                this.handler(Protocol1_18To1_17_1.this.jvmdowngrader$nest$com_viaversion_viabackwards_protocol_v1_18to1_17_1_Protocol1_18To1_17_1$cutName(0, 16));
            }
        });
        ...
        this.registerClientbound(ClientboundPackets1_18.SET_SCORE, new PacketHandlers(){
            ...
            public void register() {
                ...
                this.map(Types.VAR_INT);
                this.map(Types.STRING);
                this.handler(Protocol1_18To1_17_1.this.jvmdowngrader$nest$com_viaversion_viabackwards_protocol_v1_18to1_17_1_Protocol1_18To1_17_1$cutName(0, 40));
                this.handler(Protocol1_18To1_17_1.this.jvmdowngrader$nest$com_viaversion_viabackwards_protocol_v1_18to1_17_1_Protocol1_18To1_17_1$cutName(1, 16));
            }
        });
    }
    ...
    private PacketHandler cutName(int index, int maxLength) {
        return wrapper -> {
            String s2 = wrapper.get(Types.STRING, index);
            if (s2.length() > maxLength) {
                wrapper.set(Types.STRING, index, s2.substring(0, maxLength));
            }
        };
    }
    ...
    public PacketHandler jvmdowngrader$nest$com_viaversion_viabackwards_protocol_v1_18to1_17_1_Protocol1_18To1_17_1$cutName(int n2, int n3) {
        return this.cutName(n2, n3);
    }
}
