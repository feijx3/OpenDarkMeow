...
@NestMembers(value={12.class, 11.class, 10.class, 9.class, 8.class, 7.class, 6.class, 5.class, 4.class, 3.class, 2.class, 1.class})
...
extends BackwardsItemRewriter<ClientboundPackets1_13, ServerboundPackets1_12_1, Protocol1_13To1_12_2> {
    ...
    protected void registerPackets() {
        ...
        ((Protocol1_13To1_12_2)this.protocol).registerClientbound(ClientboundPackets1_13.BLOCK_UPDATE, new PacketHandlers(){
            ...
            public void register() {
                ...
                this.handler(wrapper -> {
                    ...
                    BlockItemPacketRewriter1_13.jvmdowngrader$nest$com_viaversion_viabackwards_protocol_v1_13to1_12_2_rewriter_BlockItemPacketRewriter1_13$flowerPotSpecialTreatment(wrapper.user(), blockState, position);
                });
            }
        });
            ...
            public void register() {
                ...
                this.handler(wrapper -> {
                    ...
                    for (BlockChangeRecord record : wrapper.get(Types.BLOCK_CHANGE_ARRAY, 0)) {
                        ...
                        BlockItemPacketRewriter1_13.jvmdowngrader$nest$com_viaversion_viabackwards_protocol_v1_13to1_12_2_rewriter_BlockItemPacketRewriter1_13$flowerPotSpecialTreatment(wrapper.user(), block, position);
        ...
        ((Protocol1_13To1_12_2)this.protocol).registerClientbound(ClientboundPackets1_13.LEVEL_CHUNK, wrapper -> {
            ...
            for (CompoundTag tag : chunk.getBlockEntities()) {
                ...
                short y2 = tag.getNumberTag("y").asShort();
                int z2 = tag.getNumberTag("z").asInt();
                BlockPosition position = new BlockPosition(x2, y2, z2);
                int block = section.palette(PaletteType.BLOCKS).idAt(x2 & 0xF, y2 & 0xF, z2 & 0xF);
                storage.checkAndStore(position, block);
            ...
            for (i2 = 0; i2 < chunk.getSections().length; ++i2) {
                ...
                for (int y3 = 0; y3 < 16; ++y3) {
                    for (int z3 = 0; z3 < 16; ++z3) {
                        for (int x3 = 0; x3 < 16; ++x3) {
                            int block = palette.idAt(x3, y3, z3);
                            if (!FlowerPotHandler.isFlowah(block)) continue;
                            BlockPosition pos = new BlockPosition(x3 + (chunk.getX() << 4), (short)(y3 + (i2 << 4)), z3 + (chunk.getZ() << 4));
                ...
                for (int j2 = 0; j2 < palette.size(); ++j2) {
                    int mappedBlockStateId = ((Protocol1_13To1_12_2)this.protocol).getMappingData().getNewBlockStateId(palette.idByIndex(j2));
            ...
            public void register() {
                ...
                this.handler(wrapper -> {
                    ...
                    for (int i2 = 0; i2 < iconCount; ++i2) {
                        ...
                        byte x2 = wrapper.read(Types.BYTE);
                        byte z2 = wrapper.read(Types.BYTE);
                        ...
                        wrapper.write(Types.BYTE, x2);
                        wrapper.write(Types.BYTE, z2);
                    }
                });
            }
        });
    ...
    public Item handleItemToClient(UserConnection connection, Item item) {
            ...
            if (item.identifier() == -1) {
                if (originalId == 362) {
                    ...
                    if (!Via.getConfig().isSuppressConversionWarnings()) {
                        ((Protocol1_13To1_12_2)this.protocol).getLogger().warning(BlockItemPacketRewriter1_13.jvmdowngrader$concat$handleItemToClient$1(originalId));
                    }
                    rawId = 65536;
                }
            } else {
        ...
        if (tag != null) {
            ...
            if (display != null && (name = display.getStringTag("Name")) != null) {
                display.putString(BlockItemPacketRewriter1_13.jvmdowngrader$concat$handleItemToClient$1(this.extraNbtTag), name.getValue());
    ...
    private void rewriteCanPlaceToClient(CompoundTag tag, String tagName) {
        ...
        tag.put(BlockItemPacketRewriter1_13.jvmdowngrader$concat$rewriteCanPlaceToClient$1(this.extraNbtTag, tagName), blockTag.copy());
    ...
    private void rewriteEnchantmentsToClient(CompoundTag tag, boolean storedEnch) {
        ...
        while (iterator2.hasNext()) {
            ...
            if (mappedEnchantmentId != null) {
                lore.add(new StringTag(BlockItemPacketRewriter1_13.jvmdowngrader$concat$rewriteEnchantmentsToClient$1(mappedEnchantmentId, EnchantmentRewriter.getRomanNumber(level))));
            ...
            if (oldId == null) {
                if (!newId.startsWith("viaversion:legacy/")) {
                    ...
                    if (ViaBackwards.getConfig().addCustomEnchantsToLore()) {
                        ...
                        name = BlockItemPacketRewriter1_13.jvmdowngrader$concat$rewriteEnchantmentsToClient$1(Character.toUpperCase(name.charAt(0)), name.substring(1).toLowerCase(Locale.ENGLISH));
                        lore.add(new StringTag(BlockItemPacketRewriter1_13.jvmdowngrader$concat$rewriteEnchantmentsToClient$1(name, EnchantmentRewriter.getRomanNumber(level))));
                    }
                    if (!Via.getManager().isDebug()) continue;
                    ((Protocol1_13To1_12_2)this.protocol).getLogger().warning(BlockItemPacketRewriter1_13.jvmdowngrader$concat$rewriteEnchantmentsToClient$1(newId));
                    continue;
                }
        ...
        if (!storedEnch && !hasValidEnchants) {
            ...
            if (hideFlags == null) {
                ...
                tag.put(BlockItemPacketRewriter1_13.jvmdowngrader$concat$rewriteEnchantmentsToClient$2(this.extraNbtTag), new ByteTag(false));
            } else {
                tag.putInt(BlockItemPacketRewriter1_13.jvmdowngrader$concat$rewriteEnchantmentsToClient$3(this.extraNbtTag), hideFlags.asByte());
            }
        ...
        if (!noMapped.isEmpty()) {
            tag.put(BlockItemPacketRewriter1_13.jvmdowngrader$concat$rewriteCanPlaceToClient$1(this.extraNbtTag, key), noMapped);
            if (!lore.isEmpty()) {
                ...
                if ((loreTag = display.getListTag("Lore", StringTag.class)) == null) {
                    ...
                    tag.put(BlockItemPacketRewriter1_13.jvmdowngrader$concat$rewriteEnchantmentsToClient$4(this.extraNbtTag), new ByteTag(false));
                    ...
                    tag.put(BlockItemPacketRewriter1_13.jvmdowngrader$concat$rewriteEnchantmentsToClient$5(this.extraNbtTag), oldLore);
    ...
    public Item handleItemToServer(UserConnection connection, Item item) {
        ...
        if (tag != null) {
            ...
            CompoundTag display = tag.getCompoundTag("display");
            if (display != null && (name = display.getStringTag("Name")) != null) {
                Tag via = display.remove(BlockItemPacketRewriter1_13.jvmdowngrader$concat$handleItemToClient$1(this.extraNbtTag));
        ...
        if (((Protocol1_13To1_12_2)this.protocol).getMappingData().getItemMappings().inverse().getNewId(rawId) == -1) {
            ...
            if (item.identifier() == 229) {
                ...
                if (!Via.getConfig().isSuppressConversionWarnings()) {
                    ((Protocol1_13To1_12_2)this.protocol).getLogger().warning(BlockItemPacketRewriter1_13.jvmdowngrader$concat$handleItemToServer$1(item.identifier()));
                }
                rawId = 16;
            }
        }
    ...
    private void rewriteCanPlaceToServer(CompoundTag tag, String tagName) {
        ...
        ListTag<?> blockTag = tag.getListTag(BlockItemPacketRewriter1_13.jvmdowngrader$concat$rewriteCanPlaceToClient$1(this.extraNbtTag, tagName));
        if (blockTag != null) {
            tag.remove(BlockItemPacketRewriter1_13.jvmdowngrader$concat$rewriteCanPlaceToClient$1(this.extraNbtTag, tagName));
    ...
    private void rewriteEnchantmentsToServer(CompoundTag tag, boolean storedEnch) {
        ...
        if (!storedEnch) {
            Tag hideFlags = tag.remove(BlockItemPacketRewriter1_13.jvmdowngrader$concat$rewriteEnchantmentsToClient$3(this.extraNbtTag));
            if (hideFlags instanceof IntTag) {
                tag.putInt("HideFlags", ((NumberTag)hideFlags).asByte());
                dummyEnchant = true;
            } else if (tag.remove(BlockItemPacketRewriter1_13.jvmdowngrader$concat$rewriteEnchantmentsToClient$2(this.extraNbtTag)) != null) {
        ...
        for (CompoundTag compoundTag2 : enchantments) {
            ...
            if (newId == null) {
                newId = BlockItemPacketRewriter1_13.jvmdowngrader$concat$rewriteEnchantmentsToServer$1(oldId);
            }
            enchantmentEntry.putString("id", newId);
            enchantmentEntry.putShort("lvl", level);
            newEnchantments.add(enchantmentEntry);
        }
        ListTag<CompoundTag> noMapped = tag.getListTag(BlockItemPacketRewriter1_13.jvmdowngrader$concat$rewriteEnchantmentsToServer$1(this.extraNbtTag), CompoundTag.class);
        if (noMapped != null) {
            for (CompoundTag value : noMapped) {
                newEnchantments.add(value);
            }
            tag.remove(BlockItemPacketRewriter1_13.jvmdowngrader$concat$rewriteEnchantmentsToServer$1(this.extraNbtTag));
        }
        if ((compoundTag = tag.getCompoundTag("display")) == null) {
            CompoundTag compoundTag3 = new CompoundTag();
            tag.put("display", compoundTag3);
        }
        if ((oldLore = tag.getListTag(BlockItemPacketRewriter1_13.jvmdowngrader$concat$rewriteEnchantmentsToClient$5(this.extraNbtTag), StringTag.class)) != null) {
            ListTag<StringTag> lore = var8_13.getListTag("Lore", StringTag.class);
            if (lore == null) {
                lore = new ListTag<StringTag>(StringTag.class);
                tag.put("Lore", lore);
            }
            lore.setValue((List<StringTag>)oldLore.getValue());
            tag.remove(BlockItemPacketRewriter1_13.jvmdowngrader$concat$rewriteEnchantmentsToClient$5(this.extraNbtTag));
        } else if (tag.remove(BlockItemPacketRewriter1_13.jvmdowngrader$concat$rewriteEnchantmentsToClient$4(this.extraNbtTag)) != null) {
            var8_13.remove("Lore");
            if (var8_13.isEmpty()) {
                tag.remove("display");
            }
    ...
    public static void jvmdowngrader$nest$com_viaversion_viabackwards_protocol_v1_13to1_12_2_rewriter_BlockItemPacketRewriter1_13$flowerPotSpecialTreatment(UserConnection userConnection, int n2, BlockPosition blockPosition) {
        BlockItemPacketRewriter1_13.flowerPotSpecialTreatment(userConnection, n2, blockPosition);
    }

    private static String jvmdowngrader$concat$handleItemToClient$1(int n2) {
        return "Failed to get new item for " + n2;
    }

    private static String jvmdowngrader$concat$handleItemToClient$1(String string) {
        return string + "|Name";
    }

    private static String jvmdowngrader$concat$rewriteCanPlaceToClient$1(String string, String string2) {
    ...
    private static String jvmdowngrader$concat$rewriteEnchantmentsToClient$1(char c2, String string) {
        return "\u00a77" + c2 + string;
    }

    private static String jvmdowngrader$concat$rewriteEnchantmentsToClient$1(String string) {
        return "Found unknown enchant: " + string;
    }
    ...
    private static String jvmdowngrader$concat$rewriteEnchantmentsToClient$3(String string) {
        return string + "|OldHideFlags";
    }

    private static String jvmdowngrader$concat$rewriteEnchantmentsToClient$4(String string) {
        return string + "|DummyLore";
    }

    private static String jvmdowngrader$concat$rewriteEnchantmentsToClient$5(String string) {
        return string + "|OldLore";
    }

    private static String jvmdowngrader$concat$handleItemToServer$1(int n2) {
        return "Failed to get old item for " + n2;
    }

    private static String jvmdowngrader$concat$rewriteEnchantmentsToServer$1(short s2) {
        return "viaversion:legacy/" + s2;
    }

    private static String jvmdowngrader$concat$rewriteEnchantmentsToServer$1(String string) {
