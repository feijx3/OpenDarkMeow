...
extends LegacyEntityRewriter<ClientboundPackets1_13, Protocol1_13To1_12_2> {
    ...
    protected void registerPackets() {
        ((Protocol1_13To1_12_2)this.protocol).registerClientbound(ClientboundPackets1_13.PLAYER_POSITION, new PacketHandlers(){
            ...
            public void register() {
                ...
                this.handler(wrapper -> {
                    ...
                    playerStorage.setX(EntityPacketRewriter1_13.jvmdowngrader$nest$com_viaversion_viabackwards_protocol_v1_13to1_12_2_rewriter_EntityPacketRewriter1_13$toSet(bitField, 0, playerStorage.x(), wrapper.get(Types.DOUBLE, 0)));
                    playerStorage.setY(EntityPacketRewriter1_13.jvmdowngrader$nest$com_viaversion_viabackwards_protocol_v1_13to1_12_2_rewriter_EntityPacketRewriter1_13$toSet(bitField, 1, playerStorage.y(), wrapper.get(Types.DOUBLE, 1)));
                    playerStorage.setZ(EntityPacketRewriter1_13.jvmdowngrader$nest$com_viaversion_viabackwards_protocol_v1_13to1_12_2_rewriter_EntityPacketRewriter1_13$toSet(bitField, 2, playerStorage.z(), wrapper.get(Types.DOUBLE, 2)));
                });
            }
        });
        ((Protocol1_13To1_12_2)this.protocol).registerClientbound(ClientboundPackets1_13.ADD_ENTITY, new PacketHandlers(){
            ...
            public void register() {
                ...
                this.handler(wrapper -> {
                    ...
                    EntityTypes1_13.ObjectType type = EntityTypes1_13.ObjectType.findById(id, data = wrapper.get(Types.INT, 0).intValue());
        ...
        ((Protocol1_13To1_12_2)this.protocol).registerClientbound(ClientboundPackets1_13.ADD_MOB, new PacketHandlers(){
            ...
            public void register() {
                ...
                this.handler(wrapper -> {
                    ...
                    EntityTypes1_13.EntityType entityType = EntityTypes1_13.EntityType.findById(type);
                    if (entityType == null) {
                        return;
                    }
                    ...
                    if (oldId == -1) {
                        if (!EntityPacketRewriter1_13.this.hasData(entityType)) {
                            ((Protocol1_13To1_12_2)EntityPacketRewriter1_13.this.protocol).getLogger().warning(3.jvmdowngrader$concat$lambda$register$0$1(type, String.valueOf(entityType)));
                        }
                    } else {
        ...
        ((Protocol1_13To1_12_2)this.protocol).registerClientbound(ClientboundPackets1_13.ADD_PLAYER, new PacketHandlers(){
            ...
            public void register() {
                ...
                this.map(Types.BYTE);
                this.map(Types1_13.ENTITY_DATA_LIST, Types.ENTITY_DATA_LIST1_12);
                this.handler(EntityPacketRewriter1_13.this.getTrackerAndDataHandler(Types.ENTITY_DATA_LIST1_12, EntityTypes1_13.EntityType.PLAYER));
            }
        });
        ...
        this.registerSetEntityData(ClientboundPackets1_13.SET_ENTITY_DATA, Types1_13.ENTITY_DATA_LIST, Types.ENTITY_DATA_LIST1_12);
        ((Protocol1_13To1_12_2)this.protocol).registerClientbound(ClientboundPackets1_13.PLAYER_LOOK_AT, null, wrapper -> {
            ...
            double x2 = wrapper.read(Types.DOUBLE);
            double y2 = wrapper.read(Types.DOUBLE);
            double z2 = wrapper.read(Types.DOUBLE);
            ...
            positionAndLook.write(Types.DOUBLE, 0.0);
            positionAndLook.write(Types.DOUBLE, 0.0);
            EntityPositionHandler.writeFacingDegrees(positionAndLook, positionStorage.x(), anchor == 1 ? positionStorage.y() + 1.62 : positionStorage.y(), positionStorage.z(), x2, y2, z2);
        ...
        PacketHandler movementRemapper = wrapper -> {
            ...
            wrapper.user().get(PlayerPositionStorage1_13.class).setPosition(x2, y2, z2);
        };
    ...
    public static double jvmdowngrader$nest$com_viaversion_viabackwards_protocol_v1_13to1_12_2_rewriter_EntityPacketRewriter1_13$toSet(int n2, int n3, double d2, double d3) {
        return EntityPacketRewriter1_13.toSet(n2, n3, d2, d3);
    }
}
