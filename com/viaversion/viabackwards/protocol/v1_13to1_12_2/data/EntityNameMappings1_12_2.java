...
public class EntityNameMappings1_12_2 {
    ...
    public static String rewrite(String entName) {
        ...
        return EntityNameMappings1_12_2.jvmdg$inlined$requireNonNullElse(entityName, entName);
    }
    ...
    private static <T> T jvmdg$inlined$requireNonNullElse(T obj, T defaultObj) {
