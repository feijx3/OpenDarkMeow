...
extends BackwardsProtocol<ClientboundPackets1_19_3, ClientboundPackets1_19_1, ServerboundPackets1_19_3, ServerboundPackets1_19_1> {
    ...
    private final ParticleRewriter<ClientboundPackets1_19_3> particleRewriter = new ParticleRewriter<ClientboundPackets1_19_3>(this);
    ...
    private final TagRewriter<ClientboundPackets1_19_3> tagRewriter = new TagRewriter<ClientboundPackets1_19_3>(this);
    ...
    protected void registerPackets() {
        ...
        this.registerClientbound(ClientboundPackets1_19_3.COMMANDS, wrapper -> {
            ...
            for (int i2 = 0; i2 < size; ++i2) {
                ...
                Preconditions.checkArgument((mappedArgumentTypeId != -1 ? 1 : 0) != 0, (Object)Protocol1_19_3To1_19_1.jvmdowngrader$concat$lambda$registerPackets$2$1(argumentTypeId));
            ...
            public void register() {
                ...
                this.handler(wrapper -> {
                    ...
                    for (int i2 = 0; i2 < lastSeen; ++i2) {
                        int index = wrapper.read(Types.VAR_INT);
                        if (index != 0) continue;
                    ...
                    Protocol1_19_3To1_19_1.this.jvmdowngrader$nest$com_viaversion_viabackwards_protocol_v1_19_3to1_19_1_Protocol1_19_3To1_19_1$get$translatableRewriter().processText(wrapper.user(), content);
    ...
    public JsonNBTComponentRewriter jvmdowngrader$nest$com_viaversion_viabackwards_protocol_v1_19_3to1_19_1_Protocol1_19_3To1_19_1$get$translatableRewriter() {
        return this.translatableRewriter;
    }

    public void jvmdowngrader$nest$com_viaversion_viabackwards_protocol_v1_19_3to1_19_1_Protocol1_19_3To1_19_1$set$translatableRewriter(JsonNBTComponentRewriter jsonNBTComponentRewriter) {
        this.translatableRewriter = jsonNBTComponentRewriter;
    }

    private static String jvmdowngrader$concat$lambda$registerPackets$2$1(int n2) {
