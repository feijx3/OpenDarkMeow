...
@NestMembers(value={5.class, 4.class, 3.class, 2.class, 1.class, 1.class})
...
extends BackwardsProtocol<ClientboundPackets1_13, ClientboundPackets1_13, ServerboundPackets1_13, ServerboundPackets1_13> {
    ...
    private final JsonNBTComponentRewriter<ClientboundPackets1_13> translatableRewriter = new JsonNBTComponentRewriter<ClientboundPackets1_13>(this, ComponentRewriterBase.ReadType.JSON);
            ...
            public void register() {
                ...
                this.map(Types.STRING, new ValueTransformer<String, String>(Types.STRING){
                    ...
                    public String transform(PacketWrapper wrapper, String inputValue) {
                        return !inputValue.startsWith("/") ? 1.jvmdowngrader$concat$transform$1(inputValue) : inputValue;
                    }
        ...
        this.registerServerbound(ServerboundPackets1_13.EDIT_BOOK, new PacketHandlers(){
            ...
            public void register() {
                ...
                this.handler(wrapper -> {
                    Protocol1_13_1To1_13.this.jvmdowngrader$nest$com_viaversion_viabackwards_protocol_v1_13_1to1_13_Protocol1_13_1To1_13$get$itemRewriter().handleItemToServer(wrapper.user(), wrapper.get(Types.ITEM1_13, 0));
        ...
        this.registerClientbound(ClientboundPackets1_13.OPEN_SCREEN, new PacketHandlers(){
            ...
            public void register() {
                ...
                this.handler(wrapper -> {
                    ...
                    Protocol1_13_1To1_13.this.jvmdowngrader$nest$com_viaversion_viabackwards_protocol_v1_13_1to1_13_Protocol1_13_1To1_13$get$translatableRewriter().processText(wrapper.user(), title);
            ...
            public void register() {
                ...
                this.handler(wrapper -> {
                    ...
                    if (action == 0 || action == 3) {
                        Protocol1_13_1To1_13.this.jvmdowngrader$nest$com_viaversion_viabackwards_protocol_v1_13_1to1_13_Protocol1_13_1To1_13$get$translatableRewriter().processText(wrapper.user(), wrapper.passthrough(Types.COMPONENT));
                        if (action == 0) {
    ...
    public ItemPacketRewriter1_13_1 jvmdowngrader$nest$com_viaversion_viabackwards_protocol_v1_13_1to1_13_Protocol1_13_1To1_13$get$itemRewriter() {
        return this.itemRewriter;
    }

    public void jvmdowngrader$nest$com_viaversion_viabackwards_protocol_v1_13_1to1_13_Protocol1_13_1To1_13$set$itemRewriter(ItemPacketRewriter1_13_1 itemPacketRewriter1_13_1) {
        this.itemRewriter = itemPacketRewriter1_13_1;
    }

    public JsonNBTComponentRewriter jvmdowngrader$nest$com_viaversion_viabackwards_protocol_v1_13_1to1_13_Protocol1_13_1To1_13$get$translatableRewriter() {
        return this.translatableRewriter;
    }

    public void jvmdowngrader$nest$com_viaversion_viabackwards_protocol_v1_13_1to1_13_Protocol1_13_1To1_13$set$translatableRewriter(JsonNBTComponentRewriter jsonNBTComponentRewriter) {
