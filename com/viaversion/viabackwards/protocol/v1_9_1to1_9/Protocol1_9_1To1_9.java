...
extends BackwardsProtocol<ClientboundPackets1_9, ClientboundPackets1_9, ServerboundPackets1_9, ServerboundPackets1_9> {
    ...
    protected void registerPackets() {
        ...
        JsonNBTComponentRewriter<ClientboundPackets1_9> componentRewriter = new JsonNBTComponentRewriter<ClientboundPackets1_9>(this, ComponentRewriterBase.ReadType.JSON);
