...
implements StorableObject {
    ...
    public void setEnchantments(KeyMappings enchantment, Tag[] enchantmentDescriptions, int[] enchantmentMaxLevels) {
    ...
    public int enchantmentMaxLevel(int id) {
        return id > 0 && id < this.enchantmentMaxLevels.length ? this.enchantmentMaxLevels[id] : -1;
    }
}
