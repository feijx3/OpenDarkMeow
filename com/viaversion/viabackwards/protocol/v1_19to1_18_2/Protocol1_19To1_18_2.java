...
extends BackwardsProtocol<ClientboundPackets1_19, ClientboundPackets1_18, ServerboundPackets1_19, ServerboundPackets1_17> {
    ...
    private final ParticleRewriter<ClientboundPackets1_19> particleRewriter = new ParticleRewriter<ClientboundPackets1_19>(this);
    ...
    private final TagRewriter<ClientboundPackets1_19> tagRewriter = new TagRewriter<ClientboundPackets1_19>(this);
    ...
    protected void registerPackets() {
        ...
        this.translatableRewriter.registerOpenScreen1_14(ClientboundPackets1_19.OPEN_SCREEN);
        ...
        this.registerClientbound(ClientboundPackets1_19.COMMANDS, wrapper -> {
            ...
            for (int i2 = 0; i2 < size; ++i2) {
                ...
                if (argumentType == null) {
                    this.getLogger().warning(Protocol1_19To1_18_2.jvmdowngrader$concat$lambda$registerPackets$0$1(argumentTypeId));
        ...
        this.registerClientbound(ClientboundPackets1_19.PLAYER_CHAT, ClientboundPackets1_18.CHAT, (PacketHandler)new PacketHandlers(){
            ...
            public void register() {
                this.handler(wrapper -> {
                    ...
                    Protocol1_19To1_18_2.this.jvmdowngrader$nest$com_viaversion_viabackwards_protocol_v1_19to1_18_2_Protocol1_19To1_18_2$get$translatableRewriter().processText(wrapper.user(), decorationResult.content());
        ...
        this.registerClientbound(ClientboundPackets1_19.SYSTEM_CHAT, ClientboundPackets1_18.CHAT, (PacketHandler)new PacketHandlers(){
            ...
            public void register() {
                this.handler(wrapper -> {
                    ...
                    Protocol1_19To1_18_2.this.jvmdowngrader$nest$com_viaversion_viabackwards_protocol_v1_19to1_18_2_Protocol1_19To1_18_2$get$translatableRewriter().processText(wrapper.user(), content);
                    int typeId = wrapper.read(Types.VAR_INT);
                    wrapper.write(Types.BYTE, typeId == 2 ? (byte)2 : (byte)0);
                });
                this.create(Types.UUID, Protocol1_19To1_18_2.jvmdowngrader$nest$com_viaversion_viabackwards_protocol_v1_19to1_18_2_Protocol1_19To1_18_2$get$ZERO_UUID());
            }
        });
            ...
            public void register() {
                ...
                this.handler(wrapper -> {
                    ...
                    if (!message.isEmpty() && message.charAt(0) == '/') {
                        ...
                        wrapper.write(Types.BYTE_ARRAY_PRIMITIVE, Protocol1_19To1_18_2.jvmdowngrader$nest$com_viaversion_viabackwards_protocol_v1_19to1_18_2_Protocol1_19To1_18_2$get$EMPTY_BYTES());
                    }
                    wrapper.write(Types.BOOLEAN, false);
                });
            }
        });
        this.registerClientbound(State.LOGIN, ClientboundLoginPackets.LOGIN_FINISHED, (PacketHandler)new PacketHandlers(){
    ...
    public void init(UserConnection user) {
        ...
        this.addEntityTracker(user, new EntityTracker1_19(user));
    }
    ...
    public JsonNBTComponentRewriter jvmdowngrader$nest$com_viaversion_viabackwards_protocol_v1_19to1_18_2_Protocol1_19To1_18_2$get$translatableRewriter() {
        return this.translatableRewriter;
    }

    public void jvmdowngrader$nest$com_viaversion_viabackwards_protocol_v1_19to1_18_2_Protocol1_19To1_18_2$set$translatableRewriter(JsonNBTComponentRewriter jsonNBTComponentRewriter) {
        this.translatableRewriter = jsonNBTComponentRewriter;
    }

    public static byte[] jvmdowngrader$nest$com_viaversion_viabackwards_protocol_v1_19to1_18_2_Protocol1_19To1_18_2$get$EMPTY_BYTES() {
        return EMPTY_BYTES;
    }

    public static void jvmdowngrader$nest$com_viaversion_viabackwards_protocol_v1_19to1_18_2_Protocol1_19To1_18_2$set$EMPTY_BYTES(byte[] byArray) {
        EMPTY_BYTES = byArray;
    }

    public static UUID jvmdowngrader$nest$com_viaversion_viabackwards_protocol_v1_19to1_18_2_Protocol1_19To1_18_2$get$ZERO_UUID() {
        return ZERO_UUID;
    }

    public static void jvmdowngrader$nest$com_viaversion_viabackwards_protocol_v1_19to1_18_2_Protocol1_19To1_18_2$set$ZERO_UUID(UUID uUID) {
        ZERO_UUID = uUID;
    }

    private static String jvmdowngrader$concat$lambda$registerPackets$0$1(int n2) {
        return "Unknown command argument type id: " + n2;
    }
}
