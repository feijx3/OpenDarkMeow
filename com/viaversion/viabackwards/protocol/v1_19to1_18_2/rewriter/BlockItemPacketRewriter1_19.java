    ...
    protected void registerPackets() {
        ...
        ((Protocol1_19To1_18_2)this.protocol).registerClientbound(ClientboundPackets1_19.LEVEL_PARTICLES, new PacketHandlers(){
            ...
            public void register() {
                ...
                this.handler(((ParticleRewriter)((Protocol1_19To1_18_2)BlockItemPacketRewriter1_19.this.protocol).getParticleRewriter()).levelParticlesHandler1_13(Types.INT));
            }
        });
        ((Protocol1_19To1_18_2)this.protocol).registerClientbound(ClientboundPackets1_19.LEVEL_CHUNK_WITH_LIGHT, wrapper -> {
            ...
            for (ChunkSection section : chunk.getSections()) {
                ...
                for (int i2 = 0; i2 < blockPalette.size(); ++i2) {
                    ...
                    blockPalette.setIdByIndex(i2, ((Protocol1_19To1_18_2)this.protocol).getMappingData().getNewBlockStateId(id));
                }
            }
        });
