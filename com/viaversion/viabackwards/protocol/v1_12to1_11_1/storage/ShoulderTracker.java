...
extends StoredObject {
    ...
    private String getName(String current) {
        ...
        StringBuilder builder = new StringBuilder();
        for (String s2 : array) {
            builder.append(s2.substring(0, 1).toUpperCase(Locale.ROOT)).append(s2.substring(1)).append(" ");
        }
        return builder.toString();
    }
    ...
    public String toString() {
        return ShoulderTracker.jvmdowngrader$concat$toString$1(this.entityId, this.leftShoulder, this.rightShoulder);
    }

    private static String jvmdowngrader$concat$toString$1(int n2, String string, String string2) {
        return "ShoulderTracker{entityId=" + n2 + ", leftShoulder='" + string + "', rightShoulder='" + string2 + "'}";
    }
}
