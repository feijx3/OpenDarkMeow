...
extends LegacyBlockItemRewriter<ClientboundPackets1_12, ServerboundPackets1_9_3, Protocol1_12To1_11_1> {
            ...
            public void register() {
                ...
                this.handler(wrapper -> {
                    ...
                    if (type == 9) {
                        ...
                        BlockItemPacketRewriter1_12.this.jvmdowngrader$nest$com_viaversion_viabackwards_protocol_v1_12to1_11_1_rewriter_BlockItemPacketRewriter1_12$handleSignText(tag);
                    } else if (type == 11) {
                        wrapper.cancel();
                    }
                });
    ...
    private void handleSignText(CompoundTag tag) {
        for (int i2 = 0; i2 < 4; ++i2) {
            StringTag lineTag = tag.getStringTag(BlockItemPacketRewriter1_12.jvmdowngrader$concat$handleSignText$1(i2 + 1));
    ...
    public void jvmdowngrader$nest$com_viaversion_viabackwards_protocol_v1_12to1_11_1_rewriter_BlockItemPacketRewriter1_12$handleSignText(CompoundTag compoundTag) {
        this.handleSignText(compoundTag);
    }

    private static String jvmdowngrader$concat$handleSignText$1(int n2) {
        return "Text" + n2;
    }
}
