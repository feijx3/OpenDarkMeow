...
extends BackwardsStructuredItemRewriter<ClientboundPacket1_20_5, ServerboundPacket1_20_3, Protocol1_20_5To1_20_3> {
    ...
    public void registerPackets() {
        ...
        ((Protocol1_20_5To1_20_3)this.protocol).registerClientbound(ClientboundPackets1_20_5.LEVEL_PARTICLES, wrapper -> {
            ...
            Particle particle = wrapper.read(VersionedTypes.V1_20_5.particle());
            ((ParticleRewriter)((Protocol1_20_5To1_20_3)this.protocol).getParticleRewriter()).rewriteParticle(wrapper.user(), particle);
        ...
        ((Protocol1_20_5To1_20_3)this.protocol).registerClientbound(ClientboundPackets1_20_5.EXPLODE, wrapper -> {
            ...
            wrapper.passthrough(Types.FLOAT);
            wrapper.passthrough(Types.VAR_INT);
            Particle smallExplosionParticle = wrapper.passthroughAndMap(VersionedTypes.V1_20_5.particle(), Types1_20_3.PARTICLE);
            Particle largeExplosionParticle = wrapper.passthroughAndMap(VersionedTypes.V1_20_5.particle(), Types1_20_3.PARTICLE);
            ((ParticleRewriter)((Protocol1_20_5To1_20_3)this.protocol).getParticleRewriter()).rewriteParticle(wrapper.user(), smallExplosionParticle);
            ((ParticleRewriter)((Protocol1_20_5To1_20_3)this.protocol).getParticleRewriter()).rewriteParticle(wrapper.user(), largeExplosionParticle);
        ...
        ((Protocol1_20_5To1_20_3)this.protocol).registerClientbound(ClientboundPackets1_20_5.MERCHANT_OFFERS, wrapper -> {
            ...
            for (int i2 = 0; i2 < size; ++i2) {
                Item input = this.handleItemToClient(wrapper.user(), wrapper.read(VersionedTypes.V1_20_5.itemCost()));
                this.cleanInput(input);
                wrapper.write(Types.ITEM1_20_2, input);
                Item result = this.handleItemToClient(wrapper.user(), wrapper.read(VersionedTypes.V1_20_5.item()));
    ...
    public @Nullable Item handleItemToClient(UserConnection connection, Item item) {
        ...
        if (lore != null) {
            for (Tag tag : lore) {
                ((ComponentRewriterBase)((Object)((Protocol1_20_5To1_20_3)this.protocol).getComponentRewriter())).processTag(connection, tag);
            }
        }
