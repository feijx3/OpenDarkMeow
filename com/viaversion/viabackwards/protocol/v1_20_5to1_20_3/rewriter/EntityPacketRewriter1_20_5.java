...
extends EntityRewriter<ClientboundPacket1_20_5, Protocol1_20_5To1_20_3> {
    ...
    public void registerPackets() {
        ...
        this.registerSetEntityData(ClientboundPackets1_20_5.SET_ENTITY_DATA, VersionedTypes.V1_20_5.entityDataList(), Types1_20_3.ENTITY_DATA_LIST);
        ...
        ((Protocol1_20_5To1_20_3)this.protocol).registerClientbound(ClientboundPackets1_20_5.SET_EQUIPMENT, wrapper -> {
            ...
            do {
                ...
                Item item = ((Protocol1_20_5To1_20_3)this.protocol).getItemRewriter().handleItemToClient(wrapper.user(), wrapper.read(VersionedTypes.V1_20_5.item()));
        ...
        ((Protocol1_20_5To1_20_3)this.protocol).registerClientbound(ClientboundConfigurationPackets1_20_5.REGISTRY_DATA, wrapper -> {
            ...
            if (registryKey.equals("worldgen/biome")) {
                ...
                for (i2 = 0; i2 < entries.length; ++i2) {
                    entry2 = entries[i2];
                    Preconditions.checkNotNull((Object)entry2.tag(), (Object)EntityPacketRewriter1_20_5.jvmdowngrader$concat$lambda$registerPackets$2$1(entry2.key()));
                    ...
                    dimensionDataMap.put(dimensionKey, new DimensionDataImpl(i2, tag));
                    keys[i2] = dimensionKey;
                }
            ...
            for (i2 = 0; i2 < entries.length; ++i2) {
                entry2 = entries[i2];
                Preconditions.checkNotNull((Object)entry2.tag(), (Object)EntityPacketRewriter1_20_5.jvmdowngrader$concat$lambda$registerPackets$2$2(entry2.key()));
                if (isTrimPattern) {
        ...
        ((Protocol1_20_5To1_20_3)this.protocol).registerClientbound(ClientboundPackets1_20_5.UPDATE_MOB_EFFECT, wrapper -> {
            ...
            int effectId = wrapper.passthrough(Types.VAR_INT);
    ...
    private int encodeARGB(float a2, float r2, float g2, float b2) {
        int encodedAlpha = this.encodeColorPart(a2);
        int encodedRed = this.encodeColorPart(r2);
        int encodedGreen = this.encodeColorPart(g2);
        int encodedBlue = this.encodeColorPart(b2);
    ...
    private static String jvmdowngrader$concat$lambda$registerPackets$2$1(String string) {
        return "Server unexpectedly sent null dimension data for " + string;
    }

    private static String jvmdowngrader$concat$lambda$registerPackets$2$2(String string) {
        return "Server unexpectedly sent null registry data entry for " + string;
    }
}
