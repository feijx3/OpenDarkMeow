...
@Plugin(id="viabackwards", name="ViaBackwards", version="5.4.2", authors={"Matsv", "kennytv", "Gerrygames", "creeper123123321", "ForceUpdate1", "EnZaXD"}, description="Allows the connection of older clients to newer server versions for Minecraft servers.", dependencies={@Dependency(id="viaversion")})
